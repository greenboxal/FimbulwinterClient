...
//     <id value="$Id: CgProgram.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.CgPrograms
{
    ...
    public class CgProgram : HighLevelGpuProgram
    {
        ...
        protected override void CreateLowLevelImpl()
        {
            ...
            if (selectedCgProfile != Cg.CG_PROFILE_UNKNOWN && !compileError)
            {
                                ...
                                || selectedCgProfile == Cg.CG_PROFILE_PS_4_0) */)
                {
                    ...
                    HighLevelGpuProgram vp = HighLevelGpuProgramManager.Instance.CreateProgram(_name, _group, "hlsl",
                                                                                               type);
                ...
                else
                {
                    ...
                    assemblerProgram = GpuProgramManager.Instance.CreateProgramFromString(_name, _group,
                                                                                          this.programString, type,
                                                                                          this.selectedProfile);
                }
            ...
            while (parameter != IntPtr.Zero)
            {
                    ...
                    Cg.cgIsParameterReferenced(parameter) != 0)
                {
                    ...
                    switch (paramType)
                    {
                        ...
                        default:
                            // Normal path (leaf)
                            string paramName = Cg.cgGetParameterName(parameter).ToLower();
                            ...
                            GpuProgramParameters.GpuConstantDefinition def =
                                new GpuProgramParameters.GpuConstantDefinition();
                            ...
                            {
                                LogManager.Instance.Write("Problem parsing the following Cg Uniform: '" + paramName +
                                                          "' in file " + _name);
                                // next uniform
        ...
        protected void CompileMicrocode()
        {
            ...
            {
                LogManager.Instance.Write("Attempted to load Cg program '" + _name +
                                          "', but no suported profile was found. ");
                return;
            }
            ...
            IntPtr cgProgram = Cg.cgCreateProgram(this.cgContext, Cg.CG_SOURCE, sourceToUse, this.selectedCgProfile,
                                                  this.entry, this.cgArguments);
        ...
        protected override void BuildConstantDefinitions()
        {
            ...
            foreach (KeyValuePair<string, GpuProgramParameters.GpuConstantDefinition> iter in this.parametersMap)
            {
        ...
        private string ResolveCgIncludes(string inSource, Resource resourceBeingLoaded, string fileName)
        {
            ...
            while (i != -1)
            {
                ...
                // open included file
                Stream resource = ResourceGroupManager.Instance.OpenResource(filename, resourceBeingLoaded.Group, true,
                                                                             resourceBeingLoaded);
