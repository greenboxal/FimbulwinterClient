...
//     <id value="$Id: D3D9Driver.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.RenderSystems.DirectX9
{
    ...
    public class D3D9Driver : DisposableObject
    {
        ...
        {
            get { return this._adapterIdentifier.Driver; }
        }
        ...
        {
            get { return string.Format("Monitor-{0}-{1}", this._adapterNumber + 1, this._adapterIdentifier.Description); }
        }
        ...
        {
            get { return this._adapterNumber; }
        }
        ...
        {
            get { return this._adapterIdentifier; }
        }
        ...
        {
            get { return this._desktopDisplayMode; }
        }
        ...
        {
            get { return this._d3D9DeviceCaps; }
        }
