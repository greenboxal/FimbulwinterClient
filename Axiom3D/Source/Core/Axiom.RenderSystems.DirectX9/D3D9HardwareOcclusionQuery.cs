...
//     <id value="$Id: D3D9HardwareOcclusionQuery.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.RenderSystems.DirectX9
{
    ...
    public class D3D9HardwareOcclusionQuery : HardwareOcclusionQuery, ID3D9Resource
    {
        ...
        private readonly Dictionary<D3D9.Device, D3D9.Query> _mapDeviceToQuery =
            new Dictionary<D3D9.Device, D3D9.Query>();
        ...
        protected override void dispose(bool disposeManagedResources)
        {
            if (!IsDisposed)
            {
                ...
                {
                    foreach (KeyValuePair<D3D9.Device, D3D9.Query> it in this._mapDeviceToQuery)
                    {
                        it.SafeDispose();
                    }
        ...
        public override void End()
        {
            ...
            D3D9.Query pOccQuery = this._mapDeviceToQuery[pCurDevice];
        ...
        public override bool IsStillOutstanding()
        {
            ...
            try
            {
                int pixels = pOccQuery.GetData<int>(false);
                LastFragmentCount = pixels;
                isQueryResultStillOutstanding = false;
