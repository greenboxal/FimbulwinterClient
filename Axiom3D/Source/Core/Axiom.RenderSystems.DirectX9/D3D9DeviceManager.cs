...
//     <id value="$Id: D3D9DeviceManager.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.RenderSystems.DirectX9
{
    ...
    public sealed class D3D9DeviceManager : DisposableObject, IEnumerable<D3D9Device>
    {
        ...
        {
            [OgreVersion(1, 7, 2790)]
            get { return this._activeRenderWindowDevice; }
        ...
        {
            get { return this._renderDevices.Count; }
        }
        ...
        public D3D9Device this[int index]
        {
            ...
            get { return this._renderDevices[index]; }
        }
        ...
        public void LinkRenderWindow(D3D9RenderWindow renderWindow)
        {
            ...
            D3D9RenderWindowList renderWindowsGroup = new D3D9RenderWindowList();
        ...
        private D3D9Device _selectDevice(D3D9RenderWindow renderWindow, D3D9RenderWindowList renderWindowsGroup)
        {
            ...
            if (nvAdapterFound == false)
            {
                ...
                if (renderWindow.IsFullScreen)
                {
                    ...
                    OperatingSystem osVersionInfo = System.Environment.OSVersion;
                ...
                if (bTryUsingMultiheadDevice)
                {
                    ...
                    Capabilities masterAdapterCaps = new Capabilities();
                    ...
                    if (masterAdapterCaps.NumberOfAdaptersInGroup > 1)
                    {
                        ...
                        foreach (RenderWindow currRenderWindow in renderSystem.RenderWindows)
                        {
                            ...
                            renderWindowsGroup[currDeviceCaps.AdapterOrdinalInGroup] =
                                (D3D9RenderWindow) currRenderWindow;
                            break;
                        }
            ...
            if (renderDevice == null)
            {
                renderDevice = new D3D9Device(this, nAdapterOrdinal, direct3D9.GetAdapterMonitor(nAdapterOrdinal),
                                              devType,
                                              extraFlags);
