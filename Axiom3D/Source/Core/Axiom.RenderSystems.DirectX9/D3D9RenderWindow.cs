...
//     <id value="$Id: D3D9RenderWindow.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.RenderSystems.DirectX9
{
    ...
    public sealed class D3D9RenderWindow : RenderWindow
    {
        ...
        private struct RECT
        {
            ...
            {
                return string.Format("RECT: Left:{0} Top:{1} Right:{2} Bottom:{3}", this.Left, this.Top, this.Right,
                                     this.Bottom);
            }
        };
        ...
        public override object this[string attribute]
        {
            get
            {
                switch (attribute.ToUpper())
                {
                    ...
                    case "DDBACKBUFFER":
                        {
                            D3D9.Surface[] ret = new D3D9.Surface[8];
        ...
        {
            [OgreVersion(1, 7, 2)]
            get { return this._device.D3DDevice; }
        }
        ...
        {
            [OgreVersion(1, 7, 2)]
            get { return this._device.GetBackBuffer(this); }
        }
        ...
        {
            [OgreVersion(1, 7, 2)]
            get { return this._switchingFullScreen; }
        }
        ...
        {
            get { return isDepthBuffered; }
        }

        [OgreVersion(1, 7, 2)]
        public bool IsNvPerfHUDEnable
        {
            get { return this._useNVPerfHUD; }
        }
        ...
        {
            get { return this._windowHandle.Handle; }
        }
        ...
        public override void Create(string name, int width, int height, bool fullScreen, NamedParameterList miscParams)
        {
            ...
            if (externalHWnd == null)
            {
                ...
                WindowsExtendedStyle dwStyleEx = (WindowsExtendedStyle) 0;
                ...
                if (monitorIndex != -1)
                {
                    D3D9.Direct3D direct3D9 = D3D9RenderSystem.Direct3D9;
                ...
                if (monitorHandle == IntPtr.Zero)
                {
                    ...
                    Point windowAnchorPoint = new Point(left, top);
                ...
                SWF.Screen monitorInfo = ScreenHelper.FromHandle(monitorHandle);
                ...
                DefaultForm wnd = new DefaultForm(classStyle, dwStyleEx, title, dwStyle, this.left, this.top, winWidth,
                                                  winHeight,
                                                  parentHWnd);
            ...
            Rectangle rc2 = new System.Drawing.Rectangle(this._windowHandle.Location, this._windowHandle.Size);
            ...
            LogManager.Instance.Write("D3D9 : Created D3D9 Rendering Window '{0}' : {1}x{2}, {3}bpp", this.name,
                                      this.width,
        ...
        public override void SetFullScreen(bool fullScreen, int width, int height)
        {
            if (fullScreen != isFullScreen || width != this.width || height != this.height)
            {
                ...
                if (fullScreen)
                {
                    ...
                    // Get the target monitor info
                    SWF.Screen monitorInfo = SWF.Screen.FromPoint(windowAnchorPoint);
        ...
        [OgreVersion(1, 7, 2)]
        public void AdjustWindow(int clientWidth, int clientHeight, WindowStyles style, out int winWidth,
                                 out int winHeight)
        {
            // NB only call this for non full screen
            RECT rc = new RECT(0, 0, clientWidth, clientHeight);
            ...
            // Get monitor info	
            SWF.Screen monitorInfo = ScreenHelper.FromHandle(handle);
        ...
        internal void FinishSwitchingFullscreen()
        {
            if (isFullScreen)
            {
                ...
                (this._windowHandle).Region = new Region(new System.Drawing.Rectangle(0, 0, width, height));
            }
            else
            {
        ...
        public void BuildPresentParameters(ref D3D9.PresentParameters presentParams)
        {
            ...
            D3D9.DeviceType devType = D3D9.DeviceType.Hardware;
...
#warning Do we need to zero anything here or does everything get inited?
            ...
            if (this._vSync)
            {
                ...
                if (isFullScreen)
                {
                    ...
                    D3D9.Capabilities caps = pD3D.GetDeviceCaps(this._device.AdapterNumber, devType);
            ...
            rsys.DetermineFSAASettings(this._device.D3DDevice, fsaa, fsaaHint, presentParams.BackBufferFormat,
                                       isFullScreen,
        ...
        private void _updateWindowRect()
        {
            ...
            if (width != this.width || height != this.height)
            {
                ...
                // Notify viewports of resize
                foreach (KeyValuePair<int, Viewport> it in ViewportList)
                {
