...
namespace Axiom.RenderSystems.DirectX9
{
    ...
    public sealed class D3D9VertexDeclaration : VertexDeclaration, ID3D9Resource
    {
        ...
        public D3D9.VertexDeclaration D3DVertexDecl
        {
            get
            {
                D3D9.Device pCurDevice = D3D9RenderSystem.ActiveD3D9Device;
                ...
                {
                    D3D9.VertexElement[] d3dElements = new D3D9.VertexElement[elements.Count + 1];
        ...
        /// <see
        ///   cref="Axiom.Graphics.VertexDeclaration.InsertElement(int, short, int, VertexElementType, VertexElementSemantic, int)" />
        [OgreVersion(1, 7, 2)]
        ...
        /// <see
        ///   cref="Axiom.Graphics.VertexDeclaration.ModifyElement(int, short, int, VertexElementType, VertexElementSemantic, int)" />
        [OgreVersion(1, 7, 2)]
        ...
        private void _releaseDeclaration()
        {
            ...
            foreach (D3D9.VertexDeclaration it in this._mapDeviceToDeclaration.Values)
            {
                it.SafeDispose();
            }
