...
namespace Axiom.RenderSystems.DirectX9.HLSL
{
    ...
    public class D3D9HLSLProgram : HighLevelGpuProgram
    {
        ...
        protected override void LoadFromSource()
        {
            ...
            D3D9.ShaderFlags compileFlags = UseColumnMajorMatrices
            ...
            D3D9.ShaderFlags parseFlags = compileFlags;
            compileFlags ^= UseColumnMajorMatrices
                                ? D3D9.ShaderFlags.PackMatrixColumnMajor
                                : D3D9.ShaderFlags.PackMatrixRowMajor;

            // include handler
            HLSLIncludeHandler includeHandler = new HLSLIncludeHandler(this);

            // Compile & assemble into microcode
            D3D9.EffectCompiler effectCompiler = new D3D9.EffectCompiler(Source, defines.ToArray(), includeHandler,
                                                                         parseFlags);
            D3D9.EffectHandle effectHandle = new D3D9.EffectHandle(EntryPoint);
        ...
        protected override void BuildConstantDefinitions()
        {
            ...
            D3D9.ConstantTableDescription desc = this.constTable.Description;
        ...
        {
            D3D9.EffectHandle constant = this.constTable.GetConstant(parent, index);

            // Since D3D HLSL doesn't deal with naming of array and struct parameters
            // automatically, we have to do it by hand
            D3D9.ConstantDescription desc = this.constTable.GetConstantDescription(constant);
                        ...
                        case D3D9.ParameterClass.MatrixRows:
                            {
                                ...
                                int secondDim = d3DDesc.Class == D3D9.ParameterClass.MatrixRows
                                                    ? d3DDesc.Columns
                                                    : d3DDesc.Rows;
        ...
        public class MicrocodeCommand : IPropertyCommand
        {
            ...
            public string Get(object target)
            {
                D3D9.ShaderBytecode buffer = ((D3D9HLSLProgram) target).MicroCode;
                if (buffer != null)
                {
                    //TODO
