...
namespace Axiom.RenderSystems.DirectX9
{
    ...
    // D3D doesn't like discard or no_overwrite on non-dynamic buffers
        ...
        {
            return System.Drawing.Color.FromArgb((int) (color.a < 1.0f ? color.a*255.0f : color.a),
                                                 (int) (color.r*255.0f),
        ...
        {
            if (matrix.M11 == 1.0f && matrix.M12 == 0.0f && matrix.M13 == 0.0f && matrix.M14 == 0.0f &&
                matrix.M21 == 0.0f &&
                matrix.M22 == 1.0f && matrix.M23 == 0.0f && matrix.M24 == 0.0f && matrix.M31 == 0.0f &&
                matrix.M32 == 0.0f &&
                matrix.M33 == 1.0f && matrix.M34 == 0.0f && matrix.M41 == 0.0f && matrix.M42 == 0.0f &&
                matrix.M43 == 0.0f &&
                matrix.M44 == 1.0f)
            {
                return true;
