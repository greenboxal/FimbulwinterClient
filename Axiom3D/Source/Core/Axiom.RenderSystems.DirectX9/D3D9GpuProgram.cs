...
//     <id value="$Id: D3D9GpuProgram.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.RenderSystems.DirectX9
{
    ...
    public abstract class D3D9GpuProgram : GpuProgram, ID3D9Resource
    {
        ...
        {
            get { return this.externalMicrocode; }
            set { this.externalMicrocode = value; }
        }
        ...
        protected override void load()
        {
            ...
            foreach (D3D9.Device dev in D3D9RenderSystem.ResourceCreationDevices)
            {
                LoadImpl(dev);
            }
        ...
        public class ExternalMicrocodeCommand : IPropertyCommand
        {
            ...
            public void Set(object target, string val)
            {
                D3D9GpuProgram program = (D3D9GpuProgram) target;
    ...
    public sealed class D3D9GpuVertexProgram : D3D9GpuProgram
    {
        ...
        [OgreVersion(1, 7, 2)]
        internal D3D9GpuVertexProgram(ResourceManager parent, string name, ResourceHandle handle, string group,
                                      bool isManual,
                                      IManualResourceLoader loader)
            : base(parent, name, handle, group, isManual, loader)
        {
        ...
        protected override void unload()
        {
            ...
            foreach (KeyValuePair<D3D9.Device, D3D9.VertexShader> it in this._mapDeviceToVertexShader)
            {
                it.SafeDispose();
            }
    ...
    public sealed class D3D9GpuFragmentProgram : D3D9GpuProgram
    {
        ...
        protected override void unload()
        {
            ...
            foreach (KeyValuePair<D3D9.Device, D3D9.PixelShader> it in this._mapDeviceToPixelShader)
            {
                it.SafeDispose();
            }
