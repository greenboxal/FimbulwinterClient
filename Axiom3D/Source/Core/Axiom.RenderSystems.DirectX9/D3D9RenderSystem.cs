...
namespace Axiom.RenderSystems.DirectX9
{
    ...
    public partial class D3D9RenderSystem : RenderSystem
    {
        ...
        {
            get { return VertexElementType.Color_ARGB; }
        }
        ...
        public override ColorEx AmbientLight
        {
            ...
            [OgreVersion(1, 7, 2790)]
            set { _setRenderState(D3D9.RenderState.Ambient, D3D9Helper.ToColor(this._ambientLight = value)); }
        }
        ...
        {
            get { return this._shadingType; }

            [OgreVersion(1, 7, 2790)]
            set { _setRenderState(D3D9.RenderState.ShadeMode, (int) D3D9Helper.ConvertEnum(this._shadingType = value)); }
        }
        ...
        {
            set { _setRenderState(D3D9.RenderState.PointSpriteEnable, value); }
        }
        ...
        {
            set { _setRenderState(D3D9.RenderState.ZWriteEnable, value); }
        }

        [OgreVersion(1, 7, 2790)]
        public override CompareFunction DepthBufferFunction
        {
            set { _setRenderState(D3D9.RenderState.ZFunc, (int) D3D9Helper.ConvertEnum(value)); }
        }
        ...
        {
            get { return this._stencilCheckEnabled; }
        ...
        public override RenderTarget RenderTarget
        {
            set
            {
                ...
                {
                    D3D9RenderWindow window = (D3D9RenderWindow) value;
                ...
                D3D9.Surface[] pBack = (D3D9.Surface[]) value["DDBACKBUFFER"];
                if (pBack[0] == null)
                {
                    return;
                }
                ...
                if (pDepth == null)
                {
                    ...
                    D3D9.SurfaceDescription srfDesc = pBack[0].Description;
                    pDepth = GetDepthStencilFor(srfDesc.Format, srfDesc.MultiSampleType, srfDesc.MultiSampleQuality,
                                                srfDesc.Width,
                                                srfDesc.Height);
                }
                ...
                {
                    DX.Result hr = ActiveD3D9Device.SetRenderTarget(x, pBack[x]);
                    if (hr.Failure)
                    {
        ...
        public override Viewport Viewport
        {
            set
            {
                ...
                if (activeViewport != value || value.IsUpdated)
                {
                    ...
                    D3D9.Viewport d3Dvp = new D3D9.Viewport();
        ...
        public override VertexDeclaration VertexDeclaration
        {
            set
            {
                D3D9VertexDeclaration d3ddecl = (D3D9VertexDeclaration) value;
                try
                {
        ...
        public override VertexBufferBinding VertexBufferBinding
        {
            set
            {
                ...
                foreach (KeyValuePair<short, HardwareVertexBuffer> bindPair in binds)
                {
                    // Unbind gap sources
                    ...
                    D3D9HardwareVertexBuffer d3d9buf = (D3D9HardwareVertexBuffer) bindPair.Value;
                    try
                    {
        ...
        public static D3D9.Direct3D Direct3D9
        {
            get
            {
                D3D9.Direct3D pDirect3D9 = _D3D9RenderSystem._pD3D;
            ...
            get
            {
                ...
                switch (creationPolicy)
                {
                    ...
                    case D3D9ResourceManager.ResourceCreationPolicy.CreateOnAllDevices:
                        foreach (D3D9.Device dev in _D3D9RenderSystem._deviceManager.Select(x => x.D3DDevice))
                        {
                            yield return dev;
                        }
                        break;
        ...
        public static D3D9.Device ActiveD3D9Device
        {
            get
            {
                ...
                D3D9.Device d3D9Device = activeDevice.D3DDevice;
        ...
        {
            get { return _D3D9RenderSystem._resourceManager; }
        }

        [OgreVersion(1, 7, 2790)]
        public static D3D9DeviceManager DeviceManager
        {
            get { return _D3D9RenderSystem._deviceManager; }
        }

        [OgreVersion(1, 7, 2790)]
        public override int DisplayMonitorCount
        {
            get { return this._pD3D.AdapterCount; }
        }

        [OgreVersion(1, 7, 2)]
        internal D3D9DriverList Direct3DDrivers
        {
            get { return this._driverList ?? (this._driverList = new D3D9DriverList()); }
        }

        [AxiomHelper(0, 9)]
        protected internal RenderWindowList RenderWindows
        {
            get { return this._renderWindows; }
        }
        ...
        /// </summary>
        [OgreVersion(1, 7, 2790)]
        private bool _checkMultiSampleQuality(D3D9.MultisampleType type, out int outQuality, D3D9.Format format,
                                              int adaptNum,
        ...
        {
            ConfigOption optDevice = new ConfigOption("Rendering Device", string.Empty, false);
            ...
            ConfigOption optResourceCeationPolicy = new ConfigOption("Resource Creation Policy", string.Empty, false);
            ...
            ConfigOption optVSyncInterval = new ConfigOption("VSync Interval", "1", false);
            ...
            ConfigOption optAa = new ConfigOption("FSAA", "None", false);
            ...
            ConfigOption optSRGB = new ConfigOption("sRGB Gamma Conversion", "No", false);
            optSRGB.PossibleValues.Add(0, "Yes");
            optSRGB.PossibleValues.Add(1, "No");

            ConfigOption optMultiDeviceMemHint = new ConfigOption("Multi device memory hint",
                                                                  "Use minimum system memory", false);
...
#warning Is this correct? Ogre adds the string "0" here
            ...
            if (driver != null)
            {
                ...
                if (videoMode != null)
                {
                    for (D3D9.MultisampleType n = D3D9.MultisampleType.TwoSamples;
                         n <= D3D9.MultisampleType.SixteenSamples;
                         n++)
                    {
                        int numLevels;
                        if (
                            !_checkMultiSampleQuality(n, out numLevels, videoMode.Format, driver.AdapterNumber,
                                                        ...
                                                        NamedParameterList miscParams)
        {
            ...
            if (renderTargets.ContainsKey(name))
            {
                throw new AxiomException(
                    "A render target of the same name '{0}' already exists." +
                    "You cannot create a new window with this name.", name);
            }

            D3D9RenderWindow window = new D3D9RenderWindow();
                                                 ...
                                                 RenderWindowList createdWindows)
        {
            ...
            for (int i = 0; i < renderWindowDescriptions.Count; ++i)
            {
                ...
                RenderWindow curWindow = CreateRenderWindow(curRenderWindowDescription.Name,
                                                            (int) curRenderWindowDescription.Width,
                                                            (int) curRenderWindowDescription.Height,
        ...
        {
            // Gets D3D format
            D3D9.Format d3Dpf = D3D9Helper.ConvertEnum(format);
            ...
            foreach (D3D9Device currDevice in this._deviceManager)
            {
                ...
                D3D9.Surface pSurface = currDevicePrimaryWindow.RenderSurface;

                // Get surface desc
                D3D9.SurfaceDescription srfDesc = pSurface.Description;

                // Calculate usage
                D3D9.Usage d3Dusage = D3D9.Usage.QueryFilter;
                ...
                bool hr = this._pD3D.CheckDeviceFormat(currDevice.AdapterNumber, currDevice.DeviceType, srfDesc.Format,
                                                       d3Dusage,
                                                       rtype,
                                                       d3Dpf);
        ...
        {
            D3D9MultiRenderTarget retval = new D3D9MultiRenderTarget(name);
        ...
        {
            D3D9.Device activeDevice = ActiveD3D9Device;
            int i = 0;
        ...
        private void _setD3D9Light(int index, Light light)
        {
            ...
            {
                D3D9.Light d3dLight = new D3D9.Light();
        ...
        {
            D3D9.Material mat = new D3D9.Material();
        ...
        {
            D3D9Texture dxTexture = (D3D9Texture) texture;
            ...
            if (enabled && dxTexture != null)
            {
                ...
                D3D9.BaseTexture ptex = dxTexture.DXTexture;
        ...
        public override void SetVertexTexture(int stage, Texture texture)
        {
            if (texture == null)
            {
                ...
                {
                    DX.Result result = ActiveD3D9Device.SetTexture(((int) D3D9.VertexTextureSampler.Sampler0) + stage,
                                                                   null);
                    if (result.Failure)
                    {
            ...
            {
                D3D9Texture dt = (D3D9Texture) texture;
                // note used
                dt.Touch();

                D3D9.BaseTexture ptex = dt.DXTexture;
        ...
        {
            D3D9.Capabilities caps = this._deviceManager.ActiveDevice.D3D9DeviceCaps;
        ...
        public override void SetTextureBlendMode(int stage, LayerBlendModeEx bm)
        {
            ...
            _setTextureStageState(stage, tss,
                                  (int)
                                  D3D9Helper.ConvertEnum(bm.operation, this._deviceManager.ActiveDevice.D3D9DeviceCaps));
            ...
            if (bm.operation != LayerBlendOperationEx.BlendDiffuseColor ||
                (this._deviceManager.ActiveDevice.D3D9DeviceCaps.TextureOperationCaps & D3D9.TextureOperationCaps.Lerp) ==
                0)
            {
                return;
            }
        ...
        {
            D3D9.RasterCaps rCaps = this._deviceManager.ActiveDevice.D3D9DeviceCaps.RasterCaps;
        ...
        public override void SetTextureUnitFiltering(int stage, FilterType type, FilterOptions filter)
        {
            ...
            D3D9.TextureFilter texFilter = D3D9Helper.ConvertEnum(type, filter,
                                                                  this._deviceManager.ActiveDevice.D3D9DeviceCaps,
                                                                  texType);
        ...
        {
            int oldVal = ActiveD3D9Device.GetRenderState<int>(state);
            if (oldVal != val)
            {
        ...
        {
            bool oldVal = ActiveD3D9Device.GetRenderState<bool>(state);
            if (oldVal != val)
            {
                ActiveD3D9Device.SetRenderState(state, val);
            }
        ...
        {
            Color oldVal = System.Drawing.Color.FromArgb(ActiveD3D9Device.GetRenderState<int>(state));
            if (oldVal != val)
            {
        ...
        {
            DX.Color4 oldVal = new DX.Color4(ActiveD3D9Device.GetRenderState<int>(state));
            if (oldVal != val)
            {
                ActiveD3D9Device.SetRenderState(state, val.ToArgb());
            }
        ...
        {
            float oldVal = ActiveD3D9Device.GetRenderState<float>(state);
            if (oldVal != val)
            {
                ActiveD3D9Device.SetRenderState(state, val);
            }
        ...
        {
            // Retrieve render surfaces (up to OGRE_MAX_MULTIPLE_RENDER_TARGETS)
            D3D9.Surface[] pBack = (D3D9.Surface[]) rt["DDBACKBUFFER"];
            Contract.RequiresNotNull(pBack, "Cannot get ZBuffer identifier");

            // Request a depth stencil that is compatible with the format, multisample type and
            // dimensions of the render target.
            D3D9.SurfaceDescription srfDesc = pBack[0].Description;
            D3D9.Format dsfmt = GetDepthStencilFormatFor(srfDesc.Format);
            Contract.Requires(dsfmt != D3D9.Format.Unknown);

            // Build identifier and return
            ZBufferIdentifier zBufferIdentifier = new ZBufferIdentifier();
    ...
    //Check that queue handling works as expected
        ...
        public override void ResumeFrame(RenderSystemContext context)
        {
            ...
            D3D9RenderContext d3dContext = (D3D9RenderContext) context;
        ...
        public override void Render(RenderOperation op)
        {
            ...
            D3D9.PrimitiveType primType = D3D9.PrimitiveType.TriangleList;
            int primCount = 0;
            ...
            if (op.useIndices)
            {
                D3D9HardwareIndexBuffer d3DIdxBuf = (D3D9HardwareIndexBuffer) op.indexData.indexBuffer;
                                                      ...
                                                      GpuProgramParameters.GpuParamVariability variability)
        {
            ...
            switch (gptype)
            {
                case GpuProgramType.Vertex:
                    ...
                    {
                        foreach (KeyValuePair<int, GpuProgramParameters.GpuLogicalIndexUse> i in floatLogical.Map)
                        {
                            if ((i.Value.Variability & variability) != 0)
                            {
                                ...
                                Contract.Requires(i.Value.CurrentSize%4 == 0,
                                                  "Should not have any elements less than 4 wide for D3D9");
                                ActiveD3D9Device.SetVertexShaderConstant(logicalIndex, pFloat, i.Value.PhysicalIndex,
                                                                         slotCount);
                            }
                        }
                    }
                    ...
                    {
                        foreach (KeyValuePair<int, GpuProgramParameters.GpuLogicalIndexUse> i in intLogical.Map)
                        {
                            if ((i.Value.Variability & variability) != 0)
                            {
                                int logicalIndex = i.Key;
                                ...
                                Contract.Requires(i.Value.CurrentSize%4 == 0,
                                                  "Should not have any elements less than 4 wide for D3D9");
                                ActiveD3D9Device.SetVertexShaderConstant(logicalIndex, pInt, i.Value.PhysicalIndex,
                                                                         slotCount);
                            }
                        }
                    }
                    ...
                    lock (floatLogical.Mutex)
                    {
                        foreach (KeyValuePair<int, GpuProgramParameters.GpuLogicalIndexUse> i in floatLogical.Map)
                        {
                            if ((i.Value.Variability & variability) != 0)
                            {
                                ...
                                Contract.Requires(i.Value.CurrentSize%4 == 0,
                                                  "Should not have any elements less than 4 wide for D3D9");
                                ActiveD3D9Device.SetPixelShaderConstant(logicalIndex, pFloat, i.Value.PhysicalIndex,
                                                                        slotCount);
                            }
                        }
                    }
                    ...
                    lock (intLogical.Mutex)
                    {
                        foreach (KeyValuePair<int, GpuProgramParameters.GpuLogicalIndexUse> i in intLogical.Map)
                        {
                            if ((i.Value.Variability & variability) != 0)
                            {
                                ...
                                Contract.Requires(i.Value.CurrentSize%4 == 0,
                                                  "Should not have any elements less than 4 wide for D3D9");
                                ActiveD3D9Device.SetPixelShaderConstant(logicalIndex, pInt, i.Value.PhysicalIndex,
                                                                        slotCount);
                            }
                        }
                    }
            ...
            switch (gptype)
            {
                case GpuProgramType.Vertex:
                    if (activeVertexGpuProgramParameters.HasPassIterationNumber)
                    {
                        ...
                        logicalIndex =
                            activeVertexGpuProgramParameters.GetFloatLogicalIndexForPhysicalIndex(physicalIndex);
                ...
                case GpuProgramType.Fragment:
                    if (activeFragmentGpuProgramParameters.HasPassIterationNumber)
                    {
                        ...
                        logicalIndex =
                            activeFragmentGpuProgramParameters.GetFloatLogicalIndexForPhysicalIndex(physicalIndex);
        ...
        protected override void SetClipPlanesImpl(Math.Collections.PlaneList planes)
        {
            for (int i = 0; i < planes.Count; ++i)
            {
                ...
                DX.Plane dx9ClipPlane = new DX.Plane(plane.Normal.x, plane.Normal.y, plane.Normal.z, plane.D);

                if (vertexProgramBound)
                {
                    // programmable clips in clip space (ugh)
                    // must transform worldspace planes by view/proj
                    DX.Matrix xform = DX.Matrix.Multiply(D3D9Helper.MakeD3DMatrix(this._viewMatrix),
        ...
        {
            D3D9.ClearFlags flags = D3D9.ClearFlags.None;
        ...
        {
            int prev = ActiveD3D9Device.GetRenderState<int>(D3D9.RenderState.ClipPlaneEnable);
        ...
        {
            D3D9HardwareOcclusionQuery query = new D3D9HardwareOcclusionQuery();
        ...
        public D3D9.Format GetDepthStencilFormatFor(D3D9.Format fmt)
        {
            ...
            D3D9.Surface surface = activeDevice.PrimaryWindow.RenderSurface;
            D3D9.SurfaceDescription srfDesc = surface.Description;

            // Probe all depth stencil formats
            // Break on first one that matches
            foreach (D3D9.Format df in DepthStencilFormats)
            {
                ...
                if (
                    !this._pD3D.CheckDepthStencilMatch(activeDevice.AdapterNumber, activeDevice.DeviceType,
                                                       srfDesc.Format, fmt, df))
                {
                    continue;
                }
        ...
        [OgreVersion(1, 7, 2)]
        public D3D9.Surface GetDepthStencilFor(D3D9.Format fmt, D3D9.MultisampleType multisample,
                                               int multisample_quality,
                                               int width, int height)
        {
            D3D9.Format dsfmt = GetDepthStencilFormatFor(fmt);
            ...
            {
                // If not, destroy current buffer
                surface = D3D9.Surface.CreateDepthStencil(ActiveD3D9Device, width, height, dsfmt, multisample,
                                                          multisample_quality,
                                                          true);

                //and cache it
                ZBufferRef zb = new ZBufferRef();
                zb.Surface = surface;
                zb.Width = width;
                zb.Height = height;
        ...
        {
            foreach (KeyValuePair<ZBufferIdentifier, Deque<ZBufferRef>> i in this._zbufferHash)
            {
                ...
                {
                    D3D9.Surface surface = i.Value.PeekHead().Surface;
                    surface.SafeDispose();
        ...
        [OgreVersion(1, 7, 2790)]
        internal void DetermineFSAASettings(D3D9.Device d3D9Device, int fsaa, string fsaaHint,
                                            D3D9.Format d3DPixelFormat,
                                            ...
                                            out int outMultisampleQuality)
        {
            ...
            while (!ok)
            {
                ...
                int outQuality;
                bool hr = this._pD3D.CheckDeviceMultisampleType(deviceDriver.AdapterNumber, D3D9.DeviceType.Hardware,
                                                                d3DPixelFormat,
                ...
                case "Resource Creation Policy":
                    switch (value)
                    {
                        case "Create on active device":
                            this._resourceManager.CreationPolicy =
                                D3D9ResourceManager.ResourceCreationPolicy.CreateOnActiveDevice;
                            break;

                        case "Create on all devices":
                            this._resourceManager.CreationPolicy =
                                D3D9ResourceManager.ResourceCreationPolicy.CreateOnAllDevices;
                            break;
                    }
                    break;
