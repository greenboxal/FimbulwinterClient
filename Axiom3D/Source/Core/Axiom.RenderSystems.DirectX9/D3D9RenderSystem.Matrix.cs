...
//     <id value="$Id: D3D9RenderSystem.Matrix.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.RenderSystems.DirectX9
{
    ...
    public partial class D3D9RenderSystem
    {
        ...
        {
            get { return D3D9Helper.ConvertD3DMatrix(ref this._dxWorldMat); }
            set
            {
                // save latest matrix
        ...
        public override Matrix4 ViewMatrix
        {
            ...
            set
            {
                ...
                DX.Matrix dxView = D3D9Helper.MakeD3DMatrix(this._viewMatrix);
        ...
        {
            get { return D3D9Helper.ConvertD3DMatrix(ref this._dxProjMat); }
            set
            {
                // save latest matrix
        ...
        public override void SetTextureMatrix(int stage, Matrix4 xform)
        {
            ...
            TexCoordCalcMethod autoTexCoordType = this._texStageDesc[stage].AutoTexCoordType;
            ...
            DX.Matrix d3dMat = D3D9Helper.MakeD3DMatrix(newMat);
            ...
            if (!D3D9Helper.IsIdentity(ref d3dMat))
            {
                ...
                TextureTransform texCoordDim = TextureTransform.Count2;
                ...
                D3D9.TransformState d3DTransType = (D3D9.TransformState) ((int) (D3D9.TransformState.Texture0) + stage);
