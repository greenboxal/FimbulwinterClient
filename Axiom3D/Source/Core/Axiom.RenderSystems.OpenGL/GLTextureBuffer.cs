...
//     <id value="$Id: GLTextureBuffer.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
    ...
    internal class GLTextureBuffer : GLHardwarePixelBuffer
    {
        ...
        public override void BindToFramebuffer(int attachment, int zOffset)
        {
            ...
            switch (this._target)
            {
                case Gl.GL_TEXTURE_1D:
                    Gl.glFramebufferTexture1DEXT(Gl.GL_FRAMEBUFFER_EXT, attachment, this._faceTarget, this._textureId,
                                                 this._level);
                    break;
                case Gl.GL_TEXTURE_2D:
                case Gl.GL_TEXTURE_CUBE_MAP:
                    Gl.glFramebufferTexture2DEXT(Gl.GL_FRAMEBUFFER_EXT, attachment, this._faceTarget, this._textureId,
                                                 this._level);
                    break;
                case Gl.GL_TEXTURE_3D:
                    Gl.glFramebufferTexture3DEXT(Gl.GL_FRAMEBUFFER_EXT, attachment, this._faceTarget, this._textureId,
                                                 this._level,
                                                 zOffset);
                    break;
            }
        ...
        protected override void upload(PixelBox box)
        {
            ...
            if (PixelUtil.IsCompressed(box.Format))
            {
                ...
                {
                    case Gl.GL_TEXTURE_1D:
                        Gl.glCompressedTexSubImage1DARB(Gl.GL_TEXTURE_1D, this._level, box.Left, box.Width, format,
                                                        box.ConsecutiveSize,
                                                        box.Data.Pin());
                        box.Data.UnPin();
                        break;
                    case Gl.GL_TEXTURE_2D:
                    case Gl.GL_TEXTURE_CUBE_MAP:
                        Gl.glCompressedTexSubImage2DARB(this._faceTarget, this._level, box.Left, box.Top, box.Width,
                                                        box.Height, format,
                                                        box.ConsecutiveSize, box.Data.Pin());
                        box.Data.UnPin();
                        break;
                    case Gl.GL_TEXTURE_3D:
                        Gl.glCompressedTexSubImage3DARB(Gl.GL_TEXTURE_3D, this._level, box.Left, box.Top, box.Front,
                                                        box.Width,
                                                        box.Height,
            ...
            else if (this._softwareMipmap)
            {
                ...
                {
                    case Gl.GL_TEXTURE_1D:
                        Glu.gluBuild1DMipmaps(Gl.GL_TEXTURE_1D, internalFormat, box.Width,
                    ...
                    case Gl.GL_TEXTURE_CUBE_MAP:
                        Glu.gluBuild2DMipmaps(this._faceTarget, internalFormat, box.Width, box.Height,
                                              GLPixelUtil.GetGLOriginFormat(box.Format),
                                              GLPixelUtil.GetGLOriginDataType(box.Format),
                                              box.Data.Pin());
                        box.Data.UnPin();
                        break;
                    case Gl.GL_TEXTURE_3D:
            ...
            else
            {
                ...
                switch (this._target)
                {
                    ...
                    case Gl.GL_TEXTURE_CUBE_MAP:
                        ...
                        break;
                    case Gl.GL_TEXTURE_3D:
                        Gl.glTexSubImage3D(Gl.GL_TEXTURE_3D, this._level, box.Left, box.Top, box.Front, box.Width,
