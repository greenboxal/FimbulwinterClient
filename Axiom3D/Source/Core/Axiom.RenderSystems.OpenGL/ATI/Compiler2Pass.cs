...
//     <id value="$Id: Compiler2Pass.cs 3304 2012-05-31 14:28:26Z borrillis $"/>
// </file>
...
namespace Axiom.RenderSystems.OpenGL.ATI
{
    ...
    public abstract class Compiler2Pass
    {
        ...
        /// <returns> True if token was found. False if token symbol text does not match the source text. If token is non-terminal, then ProcessRulePath is called. </returns>
        ...
        /// <returns> True if Pass 1 and Pass 2 are successful. False if any errors occur in Pass 1 or Pass 2 </returns>
