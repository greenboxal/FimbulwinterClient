...
//     <id value="$Id: PixelShader.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.RenderSystems.OpenGL.ATI
{
    ...
    public class PixelShader : Compiler2Pass
    {
        ...
        private static readonly SymbolDef[] PS_1_4_SymbolTypeLib =
            {
                new SymbolDef(Symbol.PS_1_4, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.PS_1_1, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE,
                              ContextKeyPattern.PS_1_1),
                new SymbolDef(Symbol.PS_1_2, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE,
                              (uint) ContextKeyPattern.PS_1_2 +
                              (uint) ContextKeyPattern.PS_1_1),
                new SymbolDef(Symbol.PS_1_3, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE,
                              (uint) ContextKeyPattern.PS_1_3 +
                              (uint) ContextKeyPattern.PS_1_2 +
                              (uint) ContextKeyPattern.PS_1_1),
                new SymbolDef(Symbol.C0, Gl.GL_CON_0_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.C1, Gl.GL_CON_1_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.C2, Gl.GL_CON_2_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.C3, Gl.GL_CON_3_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.C4, Gl.GL_CON_4_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.C5, Gl.GL_CON_5_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.C6, Gl.GL_CON_6_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.C7, Gl.GL_CON_7_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.V0, Gl.GL_PRIMARY_COLOR_ARB,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.V1, Gl.GL_SECONDARY_INTERPOLATOR_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.ADD, Gl.GL_ADD_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.SUB, Gl.GL_SUB_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.MUL, Gl.GL_MUL_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.MAD, Gl.GL_MAD_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.LRP, Gl.GL_LERP_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.MOV, Gl.GL_MOV_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.CMP, Gl.GL_CND0_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.CND, Gl.GL_CND_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.DP3, Gl.GL_DOT3_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.DP4, Gl.GL_DOT4_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.DEF, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.R, Gl.GL_RED_BIT_ATI,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.RA, Gl.GL_RED_BIT_ATI | ALPHA_BIT,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.G, Gl.GL_GREEN_BIT_ATI,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.GA, Gl.GL_GREEN_BIT_ATI | ALPHA_BIT,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.B, Gl.GL_BLUE_BIT_ATI,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.BA, Gl.GL_BLUE_BIT_ATI | ALPHA_BIT,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.A, ALPHA_BIT,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.RGBA, RGB_BITS | ALPHA_BIT,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.RGB, RGB_BITS,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.RG,
                              Gl.GL_RED_BIT_ATI | Gl.GL_GREEN_BIT_ATI,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.RGA,
                              Gl.GL_RED_BIT_ATI | Gl.GL_GREEN_BIT_ATI |
                              ALPHA_BIT, ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.RB,
                              Gl.GL_RED_BIT_ATI | Gl.GL_BLUE_BIT_ATI,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.RBA,
                              Gl.GL_RED_BIT_ATI | Gl.GL_BLUE_BIT_ATI |
                              ALPHA_BIT, ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.GB,
                              Gl.GL_GREEN_BIT_ATI | Gl.GL_BLUE_BIT_ATI,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.GBA,
                              Gl.GL_GREEN_BIT_ATI | Gl.GL_BLUE_BIT_ATI |
                              ALPHA_BIT, ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.RRRR, Gl.GL_RED,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.GGGG, Gl.GL_GREEN,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.BBBB, Gl.GL_BLUE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.AAAA, Gl.GL_ALPHA,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.X2, Gl.GL_2X_BIT_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.X4, Gl.GL_4X_BIT_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.D2, Gl.GL_HALF_BIT_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.SAT, Gl.GL_SATURATE_BIT_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.BIAS, Gl.GL_BIAS_BIT_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.INVERT, Gl.GL_COMP_BIT_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.NEGATE, Gl.GL_NEGATE_BIT_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.BX2,
                              Gl.GL_2X_BIT_ATI | Gl.GL_BIAS_BIT_ATI,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.COMMA, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.VALUE, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.R0, Gl.GL_REG_0_ATI,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.R1, Gl.GL_REG_1_ATI,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.R2, Gl.GL_REG_2_ATI,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.R3, Gl.GL_REG_3_ATI,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.R4, Gl.GL_REG_4_ATI,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.R5, Gl.GL_REG_5_ATI,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.T0, Gl.GL_TEXTURE0_ARB,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.T1, Gl.GL_TEXTURE1_ARB,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.T2, Gl.GL_TEXTURE2_ARB,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.T3, Gl.GL_TEXTURE3_ARB,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.T4, Gl.GL_TEXTURE4_ARB,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.T5, Gl.GL_TEXTURE5_ARB,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.DP2ADD, Gl.GL_DOT2_ADD_ATI,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.X8, Gl.GL_8X_BIT_ATI,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.D8, Gl.GL_EIGHTH_BIT_ATI,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.D4, Gl.GL_QUARTER_BIT_ATI,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.TEXCRD, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.TEXLD, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.STR,
                              Gl.GL_SWIZZLE_STR_ATI -
                              Gl.GL_SWIZZLE_STR_ATI,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.STQ,
                              Gl.GL_SWIZZLE_STQ_ATI -
                              Gl.GL_SWIZZLE_STR_ATI,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.STRDR,
                              Gl.GL_SWIZZLE_STR_DR_ATI -
                              Gl.GL_SWIZZLE_STR_ATI,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.STQDQ,
                              Gl.GL_SWIZZLE_STQ_DQ_ATI -
                              Gl.GL_SWIZZLE_STR_ATI,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.BEM, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.PHASE, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.R0_1, Gl.GL_REG_4_ATI,
                              ContextKeyPattern.PS_1_1),
                new SymbolDef(Symbol.R1_1, Gl.GL_REG_5_ATI,
                              ContextKeyPattern.PS_1_1),
                new SymbolDef(Symbol.T0_1, Gl.GL_REG_0_ATI,
                              ContextKeyPattern.PS_1_1),
                new SymbolDef(Symbol.T1_1, Gl.GL_REG_1_ATI,
                              ContextKeyPattern.PS_1_1),
                new SymbolDef(Symbol.T2_1, Gl.GL_REG_2_ATI,
                              ContextKeyPattern.PS_1_1),
                new SymbolDef(Symbol.T3_1, Gl.GL_REG_3_ATI,
                              ContextKeyPattern.PS_1_1),
                new SymbolDef(Symbol.TEX, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_1),
                new SymbolDef(Symbol.TEXCOORD, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_1),
                new SymbolDef(Symbol.TEXM3X2PAD, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_1),
                new SymbolDef(Symbol.TEXM3X2TEX, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_1),
                new SymbolDef(Symbol.TEXM3X3PAD, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_1),
                new SymbolDef(Symbol.TEXM3X3TEX, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_1),
                new SymbolDef(Symbol.TEXM3X3SPEC, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_1),
                new SymbolDef(Symbol.TEXM3X3VSPEC, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_1),
                new SymbolDef(Symbol.TEXREG2AR, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_2),
                new SymbolDef(Symbol.TEXREG2GB, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_2),
                new SymbolDef(Symbol.TEXREG2RGB, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_2),
                new SymbolDef(Symbol.TEXDP3, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_2),
                new SymbolDef(Symbol.TEXDP3TEX, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_2),
                new SymbolDef(Symbol.SKIP, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.PLUS, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.PROGRAM, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.PROGRAMTYPE, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.DECLCONSTS, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.DEFCONST, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.CONSTANT, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.COLOR, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.TEXSWIZZLE, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.UNARYOP, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.NUMVAL, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.SEPERATOR, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.ALUOPS, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.TEXMASK, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.TEXOP_PS1_1_3, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_1),
                new SymbolDef(Symbol.TEXOP_PS1_4, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.ALU_STATEMENT, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.DSTMODSAT, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.UNARYOP_ARGS, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.REG_PS1_4, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.TEX_PS1_4, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.REG_PS1_1_3, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_1),
                new SymbolDef(Symbol.TEX_PS1_1_3, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_1),
                new SymbolDef(Symbol.DSTINFO, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.SRCINFO, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.BINARYOP_ARGS, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.TERNARYOP_ARGS, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.TEMPREG, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.DSTMASK, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.PRESRCMOD, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.SRCNAME, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.SRCREP, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.POSTSRCMOD, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.DSTMOD, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.DSTSAT, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.BINARYOP, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.TERNARYOP, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.TEXOPS_PHASE1, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.COISSUE, Gl.GL_NONE,
                              ContextKeyPattern.PS_BASE),
                new SymbolDef(Symbol.PHASEMARKER, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.TEXOPS_PHASE2, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.TEXREG_PS1_4, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.TEXOPS_PS1_4, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_4),
                new SymbolDef(Symbol.TEXOPS_PS1_1_3, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_1),
                new SymbolDef(Symbol.TEXCISCOP_PS1_1_3, Gl.GL_NONE,
                              ContextKeyPattern.PS_1_1)
            };
        ...
        private static readonly TokenRule[] PS_1_x_RulePath =
            {
                ...
                new TokenRule(OperationType.Rule, Symbol.PROGRAMTYPE,
                              "<ProgramType>"),
                ...
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.PHASEMARKER,
                              "<PhaseMarker>"),
                new TokenRule(OperationType.And, Symbol.PHASE, "phase"),
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.DECLCONSTS,
                              "<DeclareConstants>"),
                new TokenRule(OperationType.Repeat, Symbol.DEFCONST),
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.TEXOPS_PHASE1,
                              "<TexOps_Phase1>"),
                new TokenRule(OperationType.And, Symbol.TEXOPS_PS1_1_3),
                new TokenRule(OperationType.Or, Symbol.TEXOPS_PS1_4),
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.TEXOPS_PHASE2,
                              "<TexOps_Phase2>"),
                ...
                , new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.TEXOPS_PS1_1_3,
                              "<TexOps_PS1_1_3>"),
                new TokenRule(OperationType.Repeat, Symbol.TEXOP_PS1_1_3),
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.TEXOPS_PS1_4,
                              "<TexOps_PS1_4>"),
                new TokenRule(OperationType.Repeat, Symbol.TEXOP_PS1_4),
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.TEXOP_PS1_1_3,
                              "<TexOp_PS1_1_3>"),
                ...
                new TokenRule(OperationType.And, Symbol.TEX_PS1_1_3),
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.TEXOP_PS1_4,
                              "<TexOp_PS1_4>"),
                ...
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.ALU_STATEMENT,
                              "<ALUStatement>"),
                ...
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.TEXREG_PS1_4,
                              "<TexReg_PS1_4>"),
                ...
                new TokenRule(OperationType.Optional, Symbol.TEXSWIZZLE),
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.UNARYOP_ARGS,
                              "<UnaryOpArgs>"),
                new TokenRule(OperationType.And, Symbol.DSTINFO),
                new TokenRule(OperationType.And, Symbol.SRCINFO),
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.BINARYOP_ARGS,
                              "<BinaryOpArgs>"),
                new TokenRule(OperationType.And, Symbol.DSTINFO),
                new TokenRule(OperationType.And, Symbol.SRCINFO),
                new TokenRule(OperationType.And, Symbol.SRCINFO),
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.TERNARYOP_ARGS,
                              "<TernaryOpArgs>"),
                new TokenRule(OperationType.And, Symbol.DSTINFO),
                new TokenRule(OperationType.And, Symbol.SRCINFO),
                new TokenRule(OperationType.And, Symbol.SRCINFO),
                ...
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.DEFCONST,
                              "<DefineConstant>"),
                ...
                new TokenRule(OperationType.And, Symbol.NUMVAL),
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.CONSTANT,
                              "<Constant>"),
                ...
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.TEXCISCOP_PS1_1_3,
                              "<TexCISCOp_PS1_1_3>"),
                new TokenRule(OperationType.And, Symbol.TEXDP3TEX, "texdp3tex")
                , new TokenRule(OperationType.Or, Symbol.TEXDP3, "texdp3"),
                new TokenRule(OperationType.Or, Symbol.TEXM3X2PAD,
                              "texm3x2pad"),
                new TokenRule(OperationType.Or, Symbol.TEXM3X2TEX,
                              "texm3x2tex"),
                new TokenRule(OperationType.Or, Symbol.TEXM3X3PAD,
                              "texm3x3pad"),
                new TokenRule(OperationType.Or, Symbol.TEXM3X3TEX,
                              "texm3x3tex"),
                new TokenRule(OperationType.Or, Symbol.TEXM3X3SPEC,
                              "texm3x3spec"),
                new TokenRule(OperationType.Or, Symbol.TEXM3X3VSPEC,
                              "texm3x3vspec"),
                new TokenRule(OperationType.Or, Symbol.TEXREG2RGB,
                              "texreg2rgb"),
                new TokenRule(OperationType.Or, Symbol.TEXREG2AR, "texreg2ar")
                ,
                new TokenRule(OperationType.Or, Symbol.TEXREG2GB, "texreg2gb")
                , new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.TEXSWIZZLE,
                              "<TexSwizzle>"),
                ...
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.SEPERATOR,
                              "<Seperator>"),
                new TokenRule(OperationType.And, Symbol.COMMA, ","),
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.REG_PS1_4,
                              "<Reg_PS1_4>"),
                ...
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.TEX_PS1_4,
                              "<Tex_PS1_4>"),
                ...
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.REG_PS1_1_3,
                              "<Reg_PS1_1_3>"),
                new TokenRule(OperationType.And, Symbol.R0_1, "r0"),
                new TokenRule(OperationType.Or, Symbol.R1_1, "r1"),
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.TEX_PS1_1_3,
                              "<Tex_PS1_1_3>"),
                ...
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.DSTMODSAT,
                              "<DstModSat>"),
                ...
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.BINARYOP,
                              "<BinaryOP>"),
                ...
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.TERNARYOP,
                              "<TernaryOp>"),
                ...
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.PRESRCMOD,
                              "<PreSrcMod>"),
                ...
                new TokenRule(OperationType.End),
                new TokenRule(OperationType.Rule, Symbol.POSTSRCMOD,
                              "<PostSrcMod>"),
        ...
        private int texm3x3padCount;
                    // keep track of how many texm3x3pad instructions are used so know which mask to use
        ...
        private bool BuildMachineInst()
        {
            ...
            switch (this.opInst)
            {
                ...
                case Symbol.DP4:
                    ...
                    if ((((activeContexts & (uint) ContextKeyPattern.PS_1_1) > 0) && !this.macroOn) ||
                        this.phaseMarkerFound)
                    {
                    ...
                    {
                        this.opParams[0].MaskRep = Gl.GL_RED_BIT_ATI | Gl.GL_GREEN_BIT_ATI | Gl.GL_BLUE_BIT_ATI |
                                                   ALPHA_BIT;
                    }
		...
		*/
            ...
            if (this.opType != MachineInstruction.Nop)
            {
                ...
                switch (this.opType)
                {
                    ...
                    case MachineInstruction.SampleMap:
                        ...
                        AddMachineInst(this.instructionPhase, (int) this.opParams[1].MaskRep + Gl.GL_SWIZZLE_STR_ATI);
                            // swizzle
                        // record which registers were written to and in which phase
                        // opParams[0].Arg is always the destination register r0 -> r5
                        UpdateRegisterWriteState(this.instructionPhase);
                    ...
                    case MachineInstruction.Tex: // PS_1_1 emulation - turn CISC into RISC - phase 1
                        ...
                        AddMachineInst(this.instructionPhase,
                                       this.opParams[0].Arg - Gl.GL_REG_0_ATI + Gl.GL_TEXTURE0_ARB); // interp
        ...
        {
            return (this.phase1TEX_mi.Count + this.phase1ALU_mi.Count + this.phase2TEX_mi.Count +
                    this.phase2ALU_mi.Count);
        }
        ...
        private readonly Test1Result[] test1results = new[]
                                                          {
                                                              new Test1Result('c', 4), new Test1Result('-', 4),
                                                              new Test1Result(',', 5), new Test1Result('e', 5)
                                                          };
        ...
        public bool RunTests()
        {
            ...
            for (int i = 0; i < this.testFloatResults.Length; i++)
            {
                ...
                Console.WriteLine("     Char size is: {0}, should be {1}: {2}", charSize,
                                  this.testFloatResults[i].charSize,
            ...
            Symbol[] CompileTest4result =
                {
                    Symbol.PS_1_4, Symbol.DEF, Symbol.C0, Symbol.COMMA, Symbol.VALUE, Symbol.COMMA,
                    Symbol.VALUE, Symbol.COMMA, Symbol.VALUE, Symbol.COMMA, Symbol.VALUE, Symbol.DEF,
                    Symbol.C3, Symbol.COMMA, Symbol.VALUE, Symbol.COMMA, Symbol.VALUE, Symbol.COMMA,
                    Symbol.VALUE, Symbol.COMMA, Symbol.VALUE
                };
            ...
            Symbol[] CompileTest6result =
                {
                    Symbol.PS_1_4, Symbol.MOV, Symbol.R0, Symbol.RBA, Symbol.COMMA, Symbol.C1, Symbol.MUL,
                    Symbol.R3, Symbol.COMMA, Symbol.R2, Symbol.COMMA, Symbol.C3
                };
            ...
            Symbol[] CompileTest7result =
                {
                    Symbol.PS_1_4, Symbol.DEF, Symbol.C0, Symbol.COMMA, Symbol.VALUE, Symbol.COMMA,
                    Symbol.VALUE, Symbol.COMMA, Symbol.VALUE, Symbol.COMMA, Symbol.VALUE, Symbol.MOV,
                    Symbol.X8, Symbol.R1, Symbol.COMMA, Symbol.V0, Symbol.MOV, Symbol.R0, Symbol.COMMA,
                    Symbol.R1, Symbol.GGGG
                };

            int[] CompileTest7MachinInstResults =
                {
                    (int) MachineInstruction.SetConstants, Gl.GL_CON_0_ATI, 0,
                    (int) MachineInstruction.ColorOp1, Gl.GL_MOV_ATI, Gl.GL_REG_1_ATI, RGB_BITS,
                    Gl.GL_8X_BIT_ATI, Gl.GL_PRIMARY_COLOR_ARB, Gl.GL_NONE, Gl.GL_NONE,
                    (int) MachineInstruction.AlphaOp1, Gl.GL_MOV_ATI, Gl.GL_REG_1_ATI,
                    Gl.GL_8X_BIT_ATI, Gl.GL_PRIMARY_COLOR_ARB, Gl.GL_NONE, Gl.GL_NONE,
                    (int) MachineInstruction.ColorOp1, Gl.GL_MOV_ATI, Gl.GL_REG_0_ATI, RGB_BITS,
                    Gl.GL_NONE, Gl.GL_REG_1_ATI, Gl.GL_GREEN, Gl.GL_NONE,
                    (int) MachineInstruction.AlphaOp1, Gl.GL_MOV_ATI, Gl.GL_REG_0_ATI, Gl.GL_NONE,
                    Gl.GL_REG_1_ATI, Gl.GL_GREEN, Gl.GL_NONE,
                };
        ...
        private void TestCompile(string testName, string snippet, Symbol[] expectedResults, int[] machineInstResults)
        {
            ...
            Console.WriteLine("  Pass 1 Lines scanned: {0}, Tokens produced: {1} out of {2}: {3}", currentLine,
                              tokenInstructions.Count, expectedResults.Length,
            ...
            {
                Console.WriteLine("    Token[{0}] [{1}] {2}: [{3}] {4}: {5}", i,
                                  GetTypeDefText((tokenInstructions[i]).ID),
                                  (tokenInstructions[i]).ID, GetTypeDefText(expectedResults[i]),
                                  expectedResults[i],
                                  ((tokenInstructions[i]).ID == expectedResults[i]) ? passed : failed);
            }
            ...
            if (machineInstResults != null)
            {
                ...
                Console.WriteLine("  Pass 2 Machine Instructions generated: {0} out of {1}: {2}", MIcount,
                                  machineInstResults.Length, (MIcount == machineInstResults.Length) ? passed : failed);

                Console.WriteLine("    Validating Pass 2:");

                for (int i = 0; i < MIcount; i++)
                {
                    Console.WriteLine("    instruction[{0}] = {1} : {2} : {3}", i, GetMachineInst(i),
                ...
                for (int i = 0; i < 4; i++)
                {
                    Console.WriteLine("    Constants[{0}] = {1} : {2}", i, constants[i],
