    ...
    public partial class GLRenderSystem
    {
                                                        ...
                                                        NamedParameterList miscParams)
        {
            ...
            if (!this._glInitialised)
            {
                ...
                string _glSupportVersion = this._glSupport.Version.Split(new[]
                                                                             {
                                                                                 ' '
                                                                             })[0];
                string[] tokens = _glSupportVersion.Split(new[]
                                                              {
                                                                  '.'
                                                              });
            ...
            if (window.DepthBufferPool != PoolId.NoDepth)
            {
                ...
                GLContext windowContext = (GLContext) window["GLCONTEXT"];

                GLDepthBuffer depthBuffer = new GLDepthBuffer(PoolId.Default, this, windowContext, null, null,
