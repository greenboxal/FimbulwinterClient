...
//     <id value="$Id: GLTextureManager.cs 3322 2012-07-16 20:58:00Z borrillis $"/>
// </file>
    ...
    public class GLTextureManager : TextureManager
    {
        ...
        private void _createWarningTexture()
        {
            ...
            for (int y = 0; y < height; ++y)
            {
                ...
                {
                    data[y*width + x] = (((x + y)%8) < 4) ? 0x000000 : (uint) 0xFFFF00;
                }
            }
            ...
            Gl.glTexImage2D(Gl.GL_TEXTURE_2D, 0, Gl.GL_RGB8, width, height, 0, Gl.GL_BGRA,
                            Gl.GL_UNSIGNED_INT_8_8_8_8_REV, data);
        }
