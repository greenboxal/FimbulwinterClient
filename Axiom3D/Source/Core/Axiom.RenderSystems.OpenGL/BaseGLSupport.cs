...
//     <id value="$Id: BaseGLSupport.cs 3322 2012-07-16 20:58:00Z borrillis $"/>
// </file>
...
namespace Axiom.RenderSystems.OpenGL
{
    ...
    internal abstract class BaseGLSupport
    {
        ...
        {
            get { return CheckExtension("GL_ARB_pixel_buffer_object") || CheckExtension("GL_EXT_pixel_buffer_object"); }
        }
