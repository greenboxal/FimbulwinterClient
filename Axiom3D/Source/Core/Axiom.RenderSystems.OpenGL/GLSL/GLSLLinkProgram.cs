...
//     <id value="$Id: GLSLLinkProgram.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.RenderSystems.OpenGL.GLSL
{
    ...
    public class GLSLLinkProgram : IDisposable
    {
        ...
        private readonly CustomAttribute[] sCustomAttributes = new[]
                                                                   {
        ...
        ///  Default constructor.
        ///</summary>
        public GLSLLinkProgram(GLSLGpuProgram vertexProgram, GLSLGpuProgram geometryProgram,
        ...
        {
            foreach (CustomAttribute a in this.sCustomAttributes)
            {
                int attrib = Gl.glGetAttribLocationARB(this.glHandle, a.name);
        ...
        private void BuildUniformReferences()
        {
            ...
            {
                GpuProgramParameters.GpuConstantDefinitionMap vertParams =
                    GpuProgramParameters.GpuConstantDefinitionMap.Empty;
                GpuProgramParameters.GpuConstantDefinitionMap fragParams =
                    GpuProgramParameters.GpuConstantDefinitionMap.Empty;
                GpuProgramParameters.GpuConstantDefinitionMap geomParams =
                    GpuProgramParameters.GpuConstantDefinitionMap.Empty;
                if (this.vertexProgram != null)
                {
        ...
        {
            foreach (UniformReference currentUniform in this.uniformReferences)
            {
                ...
                {
                    GpuProgramParameters.GpuConstantDefinition def = currentUniform.ConstantDef;
                    ...
                    if ((def.Variability & mask) != 0)
                    {
                        ...
                        switch (def.ConstantType)
                        {
                            case GpuProgramParameters.GpuConstantType.Float1:
                                using (
                                    GpuProgramParameters.OffsetArray<float>.FixedPointer ptr =
                            ...
                            case GpuProgramParameters.GpuConstantType.Int1:
                                using (
                                    GpuProgramParameters.OffsetArray<int>.FixedPointer ptr =
                            ...
                            case GpuProgramParameters.GpuConstantType.SamplerCube:
                                int value = parameters.GetIntConstant(def.PhysicalIndex);
        ...
        private void CompileAndLink()
        {
            if (this.vertexProgram != null)
            {
                ...
                string vpSource = this.vertexProgram.GLSLProgram.Source;
                foreach (CustomAttribute a in this.sCustomAttributes)
                {
                    ...
                    if (pos != -1)
                    {
                        ...
                        {
                            // final check 
                            string expr = vpSource.Substring(startpos, pos + a.name.Length - startpos);
