...
namespace Axiom.RenderSystems.OpenGL
{
    ...
    internal class GLFBORTTManager : GLRTTManager
    {
        ...
        private readonly int[] _stencilFormats = new[]
                                                     {
                                                         ...
                                                         Gl.GL_STENCIL_INDEX1_EXT, Gl.GL_STENCIL_INDEX4_EXT,
        ...
        private readonly int[] _depthFormats = new[]
                                                   {
                                                       ...
                                                       // Prefer 24 bit depth
                                                       Gl.GL_DEPTH_COMPONENT32, GL_DEPTH24_STENCIL8_EXT
        ...
        public GLSurfaceDesc RequestRenderBuffer(int format, int width, int height)
        {
            ...
            LogManager.Instance.Write("Requested renderbuffer with format " + format.ToString() + " of " +
                                      width.ToString() +
                                      "x" + height.ToString() + ".");
            return retval;
        }
        ...
        public void RequestRenderBuffer(GLSurfaceDesc surface)
        {
            ...
            LogManager.Instance.Write("Requested renderbuffer with format " + surface.Buffer.GLFormat.ToString() +
                                      " of " +
        ...
        public void ReleaseRenderBuffer(GLSurfaceDesc surface)
        {
            ...
            if (this._renderBufferMap.TryGetValue(key, out value))
            {
                ...
                if (value.Refcount == 0)
                {
                    ...
                    LogManager.Instance.Write("Destroyed renderbuffer of format {0} of {1}x{2}", key.Format, key.Width,
                                              key.Height);
                }
            }
        }
        ...
        private void _detectFBOFormats()
        {
            ...
            for (int x = 0; x < (int) PixelFormat.Count; ++x)
            {
                ...
                if (fmt != Gl.GL_NONE)
                {
                    ...
                    Gl.glTexImage2D(target, 0, fmt, PROBE_SIZE, PROBE_SIZE, 0, Gl.GL_RGBA, Gl.GL_UNSIGNED_BYTE,
                                    IntPtr.Zero);
                ...
                if (disposeManagedResources)
                {
                    ...
                    if (this._renderBufferMap.Count != 0)
                    {
                        LogManager.Instance.Write(
                            "GL: Warning! GLFBORTTManager Disposed, but not all renderbuffers were released.");
                    }
                }
