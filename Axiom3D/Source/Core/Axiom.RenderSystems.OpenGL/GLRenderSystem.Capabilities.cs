...
namespace Axiom.RenderSystems.OpenGL
{
    public partial class GLRenderSystem
    {
        ...
        public override RenderSystemCapabilities CreateRenderSystemCapabilities()
        {
            ...
            string deviceName = Gl.glGetString(Gl.GL_RENDERER);
            string vendorName = Gl.glGetString(Gl.GL_VENDOR);
            ...
            if (this.GLEW_ARB_vertex_program)
            {
                ...
                Gl.glGetProgramivARB(Gl.GL_VERTEX_PROGRAM_ARB, Gl.GL_MAX_PROGRAM_LOCAL_PARAMETERS_ARB,
                                     out floatConstantCount);
            ...
            if (this.GLEW_ARB_fragment_program)
            {
                ...
                int floatConstantCount;
                Gl.glGetProgramivARB(Gl.GL_FRAGMENT_PROGRAM_ARB, Gl.GL_MAX_PROGRAM_LOCAL_PARAMETERS_ARB,
                                     out floatConstantCount);
            ...
            if (this.GLEW_VERSION_2_0 && this.GLEW_EXT_geometry_shader4)
            {
                ...
                int floatConstantCount;
                Gl.glGetProgramivARB(Gl.GL_GEOMETRY_PROGRAM_NV, Gl.GL_MAX_PROGRAM_LOCAL_PARAMETERS_ARB,
                                     out floatConstantCount);
