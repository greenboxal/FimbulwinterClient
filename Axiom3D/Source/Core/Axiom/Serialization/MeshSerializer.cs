...
//     <id value="$Id: MeshSerializer.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Serialization
{
    ...
    public sealed class MeshSerializer : Serializer
    {
        ...
        {
            // call implementation
            MeshSerializerImpl serializer = this.implementations[currentVersion];
        ...
        public void ImportMesh(Stream stream, Mesh mesh)
        {
            ...
            // call implementation
            MeshSerializerImpl serializer = this.implementations[fileVersion];
