...
//     <id value="$Id: StreamSerializer.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Serialization
{
    ...
    public class StreamSerializer : DisposableObject
    {
        ...
        /// </summary>
        /// <remarks>
        ///   If the result is Endian.Auto, this mode will change when the first piece of data is read / written.
        /// </remarks>
        public Endian Endian
        {
            get { return this.mEndian; }
        }
        ...
        /// </summary>
        /// <remarks>
        ///   The id of the current chunk being read / written (at the tightest
        ...
        /// <param name="stream"> The stream on which you will read / write data. </param>
        /// <param name="endianMode"> If true, the first write or read to this stream will automatically read / write the header too. This is required if you set endianMode to Endian.Auto, but if you manually set the endian mode, then you can skip writing / reading the header if you wish, if for example this stream is midway through a file which has already included header information. </param>
        /// <param name="autoHeader"> If true, the first write or read to this stream will automatically read / write the header too. This is required if you set endianMode to Endian.Auto, but if you manually set the endian mode, then you can skip writing / reading the header if you wish, if for example this stream is midway through a file which has already included header information. </param>
        ...
        /// <param name="endianMode"> If true, the first write or read to this stream will automatically read / write the header too. This is required if you set endianMode to Endian.Auto, but if you manually set the endian mode, then you can skip writing / reading the header if you wish, if for example this stream is midway through a file which has already included header information. </param>
        /// <param name="autoHeader"> If true, the first write or read to this stream will automatically read / write the header too. This is required if you set endianMode to Endian.Auto, but if you manually set the endian mode, then you can skip writing / reading the header if you wish, if for example this stream is midway through a file which has already included header information. </param>
        /// <param name="realFormat"> Set the format you want to write reals in. Only useful for files that you're writing (since when reading this is picked up from the file), and can only be changed if autoHeader is true, since real format is stored in the header. Defaults to float unless you're using AXIOM_DOUBLE_PRECISION. </param>
        [OgreVersion(1, 7, 2)]
        ...
        /// </summary>
        /// <returns> Returns how many levels of nested chunks are currently being processed, either writing or reading. In order to tidily finish, you must call read/writeChunkEnd this many times. </returns>
        ...
        ///   the next set of data is available directly afterwards.
        /// </remarks>
        /// <param name="id"> The ID you're expecting. If the next chunk isn't of this ID, then the chunk read is undone and the method returns null. </param>
        /// <param name="maxVersion"> The maximum version you're able to process. If the ID is correct but the version exceeds what is passed in here, the chunk is skipped over, the problem logged and null is returned. </param>
        ...
        /// </summary>
        /// <remarks>
        ///   The most common case of wanting to use this is if you'd called <see cref="ReadChunkBegin()" />, 
        ...
        /// </summary>
        /// <remarks>
        ///   You can call this method at any point after calling <see cref="ReadChunkBegin()" />, even
        ...
        /// </remarks>
        /// <param name="id"> The identifier of the new chunk. Any value that's unique in the file context is valid, except for the numbers 0x0001 and 0x1000 which are reserved for internal header identification use. </param>
    ...
    /// <see cref="StreamSerializer.WriteChunkBegin(uint, UInt16)"/>
        ...
        ///   End writing a chunk.
        /// </summary>
        /// <param name="id"> The identifier of the chunk - this is really just a safety check, since you can only end the chunk you most recently started. </param>
        [OgreVersion(1, 7, 2)]
        ...
        [OgreVersion(1, 7, 2)]
#if NET_40
        protected virtual void CheckStream(bool failOnEof = false, bool validateReadable = false,
