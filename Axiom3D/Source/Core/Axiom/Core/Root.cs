...
//     <id value="$Id: Root.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
    ...
    public sealed class Root : IDisposable
    {
        ...
        public Root(string logFilename)
        {
            if (instance == null)
            {
                ...
                info.AppendFormat("{1} Framework: {0}\n", Environment.Version, isMono ? "Mono" : ".Net");
                ...
                ResourceBackgroundQueue resBack = new ResourceBackgroundQueue();
        ...
        private float frameSmoothingTime;
        ...
        /// </summary>
        private float microsecondsPerFrame;
        ...
        {
            add { this._frameStartedEvent.EventSinks += value; }
            remove { this._frameStartedEvent.EventSinks -= value; }
        }
        ...
        {
            add { this._frameEndedEvent.EventSinks += value; }
            remove { this._frameEndedEvent.EventSinks -= value; }
        }
        ...
        {
            add { this._frameRenderingQueuedEvent.EventSinks += value; }
            remove { this._frameRenderingQueuedEvent.EventSinks -= value; }
        }
        ...
        {
            get { return this.sceneManagerEnumerator.SceneManagerList; }
        }
        ...
        {
            get { return this.sceneManagerEnumerator.MetaDataList; }
        }
        ...
        {
            get { return this.renderSystemList; }
        }
        ...
        public int MaxFramesPerSecond
        {
            ...
            set
            {
                if (value != 0)
                {
                    this.microsecondsPerTick = 1000000.0f/Stopwatch.Frequency;
                    this.microsecondsPerFrame = 1000000.0f/value;
                }
                else // Disable MaxFPS
                {
                    this.microsecondsPerFrame = 0;
        ...
        {
            get { return this.secondsBetweenFPSAverages; }
            set { this.secondsBetweenFPSAverages = value; }
        }
        ...
        {
            get { return this.currentFrameCount; }
        }
        ...
        /// </summary>
        /// <remarks>
        ///   This method allows you to tweak the smoothing period, and is expressed
        ///   in seconds. Setting it to 0 will result in completely unsmoothed frame times (the default)
        /// </remarks>
        public float FrameSmoothingTime
        {
            get { return this.frameSmoothingTime; }
            set { this.frameSmoothingTime = value; }
        }
        ...
        {
            string instanceName = (new NameGenerator<SceneManager>()).GetNextUniqueName(typeName);
        ...
        /// </remarks>
        /// <param name="autoCreateWindow"> If true, a rendering window will automatically be created. The window will be created based on the options currently set on the render system. </param>
                                               ...
                                               NamedParameterList miscParams)
        {
            ...
            RenderWindow window = this.activeRenderSystem.CreateRenderWindow(name, width, height, isFullscreen,
                                                                             miscParams);
        ...
        private float CalculateEventTime(long time, FrameEventType type)
        {
            ...
            else if (type == FrameEventType.End)
            {
                ...
                if ((time - this.lastCalculationTime) > this.secondsBetweenFPSAverages*1000f)
                {
                    ...
                    this.currentFPS = this.frameCount/(float) (time - this.lastCalculationTime)*1000f;
        ...
        /// </remarks>
        /// <param name="e"> Event object which includes all the timing information which must already be calculated. RequestShutdown should be checked after each call, because that means an event handler is requesting that shudown begin for one reason or another. </param>
        ...
        /// </summary>
        /// <param name="typeName"> The factory type to check for. </param>
        ...
        /// </summary>
        /// <param name="typeName"> The factory type to obtain. </param>
        /// <returns> A factory for the given type of MovableObject. </returns>
        ...
        ///  available.
        ///</remarks>
        ///<param name="fact"> The factory instance. </param>
        ...
        public void AddMovableObjectFactory(MovableObjectFactory fact, bool overrideExisting)
        {
            ...
            LogManager.Instance.Write("Factory " + fact.GetType().Name + " registered for MovableObjectType '" +
                                      fact.Type +
                                      "'.");
        }
        ...
        {
            get { return this.movableObjectFactoryMap; }
        }
        ...
        public Stream CreateFileStream(string fileName, string groupName, bool overwrite, string locationPattern)
        {
            ...
            if (string.IsNullOrEmpty(path))
            {
                try
                {
                    stream = ResourceGroupManager.Instance.CreateResource(fileName, groupName, overwrite,
                                                                          locationPattern);
                }
                catch
                {
