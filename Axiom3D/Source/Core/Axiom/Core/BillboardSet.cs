...
//     <id value="$Id: BillboardSet.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Core
{
    ...
    public class BillboardSet : MovableObject, IRenderable
    {
        ...
        /// <summary>
        ///   True if particles follow the object the
        ///   ParticleSystem is attached to.
        /// </summary>
        ...
        private readonly bool externalData;
			...
			*/
            ...
            if (!this.pointRendering)
            {
                    ...
                    !(this.accurateFacing && this.billboardType != BillboardType.PerpendicularCommon))
                {
					...
					*/
                    GenerateVertexOffsets(this.leftOff, this.rightOff, this.topOff, this.bottomOff,
        ...
        internal void InjectBillboard(Billboard bb)
        {
            ...
            else // not all default size and not point rendering
            {
                    ...
                    (this.accurateFacing && this.billboardType != BillboardType.PerpendicularCommon))
                {
                    ...
                    GenerateVertexOffsets(this.leftOff, this.rightOff, this.topOff, this.bottomOff, bb.Width, bb.Height,
                                          ref this.camX,
        ...
        protected void SetTextureStacksAndSlices(int stacks, int slices)
        {
            ...
            for (uint v = 0; v < stacks; ++v)
            {
                ...
                float top = v/(float) stacks;
                float bottom = ((float) v + 1)/stacks;
                for (uint u = 0; u < slices; ++u)
                {
                    RectangleF r = new RectangleF();
                    r.Left = u/(float) slices;
                    r.Top = top;
                    r.Width = ((float) u + 1)/slices - r.Left;
                    r.Height = bottom - top;
    ...
    // into node space to generate the axes
...
#endif
                {
                    float* posPtr = this.lockPtr.ToFloatPointer();
                    int* colPtr = this.lockPtr.ToIntPointer();
        ...
        private void CreateBuffers()
        {
			...
			*/
            ...
            this.mainBuffer = HardwareBufferManager.Instance.CreateVertexBuffer(decl.Clone(0),
            ...
            if (!this.pointRendering)
            {
				...
				*/
                ...
                BufferBase idxPtr = this.indexData.indexBuffer.Lock(BufferLocking.Discard);

#if !AXIOM_SAFE_ONLY
                unsafe
#endif
                {
                    ushort* pIdx = idxPtr.ToUShortPointer();
        ...
        {
            get { return this.autoExtendPool; }
            set { this.autoExtendPool = value; }
        }
    ...
    // 2d coords, 4 per billboard = 8
        ...
        {
            get { return this.billboardType; }
            set { this.billboardType = value; }
        }
        ...
        {
            get { return this.commonDirection; }
            set { this.commonDirection = value; }
        }
        ...
        {
            get { return this.commonUpVector; }
            set { this.commonUpVector = value; }
        }

        public bool UseAccurateFacing
        {
            get { return this.accurateFacing; }
            set { this.accurateFacing = value; }
        }
        ...
        {
            get { return this.activeBillboards; }
        }
