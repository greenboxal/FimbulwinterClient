...
*/
    ...
    //     <id value="$Id: BitConverterEx.cs 3355 2012-07-27 16:26:54Z romeoxbm $"/>
    // </file>
    ...
    public static class BitConverterEx
    {
        public static byte[] GetBytes<T>(T value)
        {
            ...
            else
            {
                ...
                using (dst = BufferBase.Wrap(buffer))
                {
                    using (BufferBase src = BufferBase.Wrap(value as Array))
        ...
        public static T SetBytes<T>(byte[] buffer)
        {
            ...
            T retStruct;
            using (BufferBase src = BufferBase.Wrap(buffer))
            {
        ...
        public static void SetBytes<T>(byte[] buffer, out T[] dest)
        {
            ...
            using (BufferBase src = BufferBase.Wrap(buffer))
            {
                using (BufferBase dst = BufferBase.Wrap(dest))
