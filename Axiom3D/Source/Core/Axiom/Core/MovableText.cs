...
//     <id value="$Id: MovableText.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Core
{
    public class MovableText : SimpleRenderable
    {
        ...
        {
            get { return this._characterHeight; }
            set
            {
        ...
        {
            get { return this._additionalHeight; }
            set
            {
        ...
        private void _setupGeometry()
        {
            ...
            HardwareVertexBuffer vbuf = HardwareBufferManager.Instance.CreateVertexBuffer(decl.Clone(POS_TEX_BINDING),
            ...
            HardwareVertexBuffer cbuf = HardwareBufferManager.Instance.CreateVertexBuffer(decl.Clone(COLOR_BINDING),
                                                                                          renderOperation.vertexData.
                                                                                              vertexCount,
                                                                                          BufferUsage.DynamicWriteOnly);
