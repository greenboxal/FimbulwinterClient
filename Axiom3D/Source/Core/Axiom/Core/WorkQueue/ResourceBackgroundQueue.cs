...
//     <id value="$Id: ResourceBackgroundQueue.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Core
{
    ...
    /// <see cref="ResourceBackgroundQueue.LoadResourceGroup( string, OnOperationCompleted )"/>
        ...
        [OgreVersion(1, 7, 2)]
#if NET_40
        public virtual RequestID Prepare(string resType, string name, string group, bool isManual = false,
    ...
    /// <see cref="ResourceBackgroundQueue.Prepare( string, string, string, bool, IManualResourceLoader, NameValuePairList, OnOperationCompleted )"/>
        ...
        [OgreVersion(1, 7, 2)]
#if NET_40
        public virtual RequestID Load(string resType, string name, string group, bool isManual = false,
                                      IManualResourceLoader loader = null,
                                      NameValuePairList loadParams = null, OnOperationCompleted listener = null)
#else
            ...
            try
            {
                switch (resreq.Type)
                {
                    ...
                    case RequestType.PrepareResource:
                        ...
                        resource = rm.Prepare(resreq.ResourceName, resreq.GroupName, resreq.IsManual, resreq.Loader,
                                              resreq.LoadParams,
                                              true);
                        break;
