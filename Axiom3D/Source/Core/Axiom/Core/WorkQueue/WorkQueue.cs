...
//     <id value="$Id: WorkQueue.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Core
{
    ...
    public abstract class WorkQueue : DisposableObject
    {
        ...
        public interface IRequestHandler
        {
            ...
            /// </summary>
            /// <param name="req"> The Request structure, which is effectively owned by the handler during this call. It must be attached to the returned Response regardless of success or failure. </param>
        ...
        public interface IResponseHandler
        {
            ...
            ///   The handler method every subclass must implement.
            /// </summary>
            /// <param name="res"> The Response structure. The caller is responsible for deleting this after the call is made, none of the data contained (except pointers to structures in user Any data) will persist after this call is returned. </param>
            /// <param name="srcq"> The work queue that this request originated from </param>
            [OgreVersion(1, 7, 2)]
        ...
        /// </summary>
        /// <param name="channel"> The channel this request will go into = 0; the channel is the top-level categorisation of the request </param>
        /// <param name="requestType"> An identifier that's unique within this queue which identifies the type of the request (user decides the actual value) </param>
        ...
        [OgreVersion(1, 7, 2)]
#if NET_40
        public abstract RequestID AddRequest(ushort channel, ushort requestType, object rData, byte retryCount = 0,
