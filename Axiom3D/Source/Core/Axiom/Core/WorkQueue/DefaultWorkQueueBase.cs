...
//     <id value="$Id: DefaultWorkQueueBase.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Core
{
    ...
    public abstract class DefaultWorkQueueBase : WorkQueue
    {
        ...
        {
            [OgreVersion(1, 7, 2)]
            get { return this.workerThreadCount; }
        ...
        {
            [OgreVersion(1, 7, 2)]
            get { return this.workerRenderSystemAccess; }

            [OgreVersion(1, 7, 2)]
            set { this.workerRenderSystemAccess = value; }
        }
        ...
        {
            [OgreVersion(1, 7, 2)]
            get { return this.acceptRequests; }
        ...
        {
            [OgreVersion(1, 7, 2)]
            get { return this.responseTimeLimitMS; }

            [OgreVersion(1, 7, 2)]
            set { this.responseTimeLimitMS = value; }
        }
        ...
        [OgreVersion(1, 7, 2)]
#if NET_40
        public override RequestID AddRequest(ushort channel, ushort requestType, object rData, byte retryCount = 0,
        ...
        /// </summary>
        [OgreVersion(1, 7, 2)]
        protected void AddRequestWithRID(RequestID rid, ushort channel, ushort requestType, object rData,
                                         byte retryCount)
        {
        ...
        protected Response ProcessRequest(Request r)
        {
            ...
            LogManager.Instance.Write(LogMessageLevel.Trivial, false,
                                      "DefaultWorkQueueBase('{0}') - PROCESS_REQUEST_START({1}",
        ...
        {
            StringBuilder dbgMsg = new StringBuilder();
            dbgMsg.AppendFormat("thread:{0}): ID={1} success={2} messages=[{3}] channel={4} requestType={5}",
                                GetThreadName(),
                                r.Request.ID, r.Succeeded, r.Messages, r.Request.Channel, r.Request.Type);

            LogManager.Instance.Write(LogMessageLevel.Trivial, false,
                                      "DefaultWorkQueueBase('{0}') - PROCESS_RESPONSE_START({1}",
                                      this.name, dbgMsg.ToString());
            ...
            LogManager.Instance.Write(LogMessageLevel.Trivial, false,
                                      "DefaultWorkQueueBase('{0}') - PROCESS_RESPONSE_END({1}",
                                      this.name, dbgMsg.ToString());
        }
    };
}