...
namespace Axiom.Core
{
    ...
    public interface ILodListener
    {
        ...
        /// <returns> True to indicate the event should be queued and PostqueueMovableObjectLodChanged called after rendering is complete. </returns>
        ...
        ///</remarks>
        ///<param name="evt"> </param>
        ///<returns> True to indicate the event should be queued and PostqueueEntityMeshLodChanged called after rendering is complete. </returns>
        ...
        ///  prevent the lod from changing, or to skip an
        ///  index).
        ///  <returns> True to indicate the event should be queued and PostqueueMaterialLodChanged called after rendering is complete. </returns>
        ///</remarks>
        ///<param name="evt"> </param>
