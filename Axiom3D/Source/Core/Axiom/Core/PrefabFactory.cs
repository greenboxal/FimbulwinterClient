...
//     <id value="$Id: PrefabFactory.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Core
{
    ...
    public class PrefabFactory
    {
        ...
        private static void _createPlane(Mesh mesh)
        {
            ...
            float[] vertices = new float[32]
                                   {
                                       ...
                                       0, 0, 1, // normal
                                       0, 1, // texcoord
                                       100, -100, 0, 0, 0, 1, 1, 1, 100, 100, 0, 0, 0, 1, 1, 0, -100, 100, 0, 0, 0, 1, 0
                                       , 0
                                   };
            ...
            HardwareVertexBuffer vbuf = HardwareBufferManager.Instance.CreateVertexBuffer(decl, 4,
            ...
            HardwareIndexBuffer ibuf = HardwareBufferManager.Instance.CreateIndexBuffer(IndexType.Size16, 6,
                                                                                        BufferUsage.StaticWriteOnly);
        ...
        private static void _createCube(Mesh mesh)
        {
            ...
            float[] vertices = new float[NUM_VERTEX_ENTRIES]
                                   {
                                       ...
                                       CUBE_HALF_SIZE,
                                       CUBE_HALF_SIZE, 0, 0, 1, 1, 0, -CUBE_HALF_SIZE, CUBE_HALF_SIZE, CUBE_HALF_SIZE, 0
                                       , 0, 1, 0, 0,
                                       // back side
                                       CUBE_HALF_SIZE, -CUBE_HALF_SIZE, -CUBE_HALF_SIZE, 0, 0, -1, 0, 1, -CUBE_HALF_SIZE
                                       , -CUBE_HALF_SIZE,
                                       -CUBE_HALF_SIZE, 0, 0, -1, 1, 1, -CUBE_HALF_SIZE, CUBE_HALF_SIZE, -CUBE_HALF_SIZE
                                       , 0, 0, -1, 1, 0,
                                       CUBE_HALF_SIZE, CUBE_HALF_SIZE, -CUBE_HALF_SIZE, 0, 0, -1, 0, 0, // left side
                                       -CUBE_HALF_SIZE, -CUBE_HALF_SIZE, -CUBE_HALF_SIZE, -1, 0, 0, 0, 1,
                                       -CUBE_HALF_SIZE, -CUBE_HALF_SIZE,
                                       CUBE_HALF_SIZE, -1, 0, 0, 1, 1, -CUBE_HALF_SIZE, CUBE_HALF_SIZE, CUBE_HALF_SIZE,
                                       -1, 0, 0, 1, 0,
                                       -CUBE_HALF_SIZE, CUBE_HALF_SIZE, -CUBE_HALF_SIZE, -1, 0, 0, 0, 0, // right side
                                       CUBE_HALF_SIZE, -CUBE_HALF_SIZE, CUBE_HALF_SIZE, 1, 0, 0, 0, 1, CUBE_HALF_SIZE,
                                       -CUBE_HALF_SIZE,
                                       -CUBE_HALF_SIZE, 1, 0, 0, 1, 1, CUBE_HALF_SIZE, CUBE_HALF_SIZE, -CUBE_HALF_SIZE,
                                       1, 0, 0, 1, 0,
                                       ...
                                       CUBE_HALF_SIZE,
                                       CUBE_HALF_SIZE, 0, 1, 0, 1, 1, CUBE_HALF_SIZE, CUBE_HALF_SIZE, -CUBE_HALF_SIZE, 0
                                       , 1, 0, 1, 0,
                                       -CUBE_HALF_SIZE, CUBE_HALF_SIZE, -CUBE_HALF_SIZE, 0, 1, 0, 0, 0, // down side
                                       -CUBE_HALF_SIZE, -CUBE_HALF_SIZE, -CUBE_HALF_SIZE, 0, -1, 0, 0, 1, CUBE_HALF_SIZE
                                       , -CUBE_HALF_SIZE,
                                       -CUBE_HALF_SIZE, 0, -1, 0, 1, 1, CUBE_HALF_SIZE, -CUBE_HALF_SIZE, CUBE_HALF_SIZE,
                                       0, -1, 0, 1, 0,
            ...
            HardwareVertexBuffer vbuf = HardwareBufferManager.Instance.CreateVertexBuffer(decl, NUM_VERTICES,
                                                                                          BufferUsage.StaticWriteOnly);
            ...
            sub.useSharedVertices = true;
            HardwareIndexBuffer ibuf = HardwareBufferManager.Instance.CreateIndexBuffer(IndexType.Size16, NUM_INDICES,
                                                                                        BufferUsage.StaticWriteOnly);
        ...
        private static void _createSphere(Mesh mesh)
        {
            ...
            HardwareVertexBuffer vBuf = HardwareBufferManager.Instance.CreateVertexBuffer(vertexDecl.Clone(0),
