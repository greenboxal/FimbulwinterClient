...
//     <id value="$Id: Rectangle.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Core
{
    public struct Rectangle
    {
        ...
        public long Width
        {
            ...
            set { this._left = value - this._right; }
        }
        ...
        {
            return string.Format("Rectangle<>(l:{0}, t:{1}, r:{2}, b:{3})", this._left, this._top, this._right,
                                 this._bottom);
        }
    }
