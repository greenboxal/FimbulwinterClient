...
//     <id value="$Id: Billboard.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Core
{
    ...
    public class Billboard
    {
        ...
        {
            get { return this.useTexcoordRect; }
            set { this.useTexcoordRect = value; }
        }

        public short TexcoordIndex
        {
            get { return this.texcoordIndex; }
            set
            {
