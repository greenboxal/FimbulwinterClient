...
namespace Axiom.Core
{
	...
	public class Entity : MovableObject
	{
		...
		{
			var c = ChooseVertexDataForBinding( this.mesh.SharedVertexDataAnimationType != VertexAnimationType.None );
			switch ( c )
			{
