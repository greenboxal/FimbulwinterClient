...
//     <id value="$Id: TextureManager.cs 3315 2012-05-31 20:37:22Z borrillis $"/>
// </file>
...
namespace Axiom.Core
{
    ...
    public abstract class TextureManager : ResourceManager
    {
        ...
        {
            get { return this._defaultMipmapCount; }
            set { this._defaultMipmapCount = value; }
        }
        ...
        {
            get { return this._preferredIntegerBitDepth; }
            set { SetPreferredIntegerBitDepth(value, false); }
        }
        ...
        {
            get { return this._preferredFloatBitDepth; }
            set { SetPreferredFloatBitDepth(value, false); }
        }
        ...
        {
            return CreateManual(name, group, type, width, height, 1, numMipmaps, format, usage, loader, false, 0,
                                String.Empty);
        }
        ...
        {
            return CreateManual(name, group, type, width, height, 1, numMipmaps, format, usage, null, false, 0,
                                String.Empty);
        }
        ...
        {
            return CreateManual(name, group, type, width, height, numMipmaps, format, usage, loader, hwGammaCorrection,
                                0,
                                string.Empty);
        }
        ...
        public Texture CreateManual(string name, string group, TextureType type, int width, int height, int depth,
                                    ...
                                    bool hwGammaCorrection)
        {
            return CreateManual(name, group, type, width, height, depth, numMipmaps, format, usage, loader,
                                hwGammaCorrection, 0, string.Empty);
        }
        ...
        {
            return CreateManual(name, group, type, width, height, depth, numMipmaps, format, usage, loader,
                                hwGammaCorrection, fsaa, string.Empty);
        }
        ...
        /// <summary>
        /// </summary>
        public virtual Texture Load(string name, string group, TextureType type, int numMipMaps, float gamma,
                                    bool isAlpha, PixelFormat desiredFormat)
        {
            // does this texture exist already?
            Math.Tuple<Resource, bool> result = CreateOrRetrieve(name, group);
        ...
        ///</summary>
        ///<returns> </returns>
        public Texture LoadImage(string name, string group, Image image, TextureType texType, int numMipMaps,
                                 float gamma,
                                 bool isAlpha, PixelFormat desiredFormat)
        {
