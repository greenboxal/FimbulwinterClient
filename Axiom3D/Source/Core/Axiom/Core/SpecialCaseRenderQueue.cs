...
namespace Axiom.Core
{
    ...
    public class SpecialCaseRenderQueue
    {
        ...
        /// </remarks>
        /// <param name="queueId"> The identifier of the queue which should be added to the special case list. Nothing happens if the queue is already in the list. </param>
        ...
        /// </summary>
        /// <param name="queueId"> The identifier of the queue which should be removed from the special case list. Nothing happens if the queue is not in the list. </param>
