...
//     <id value="$Id: SceneQuery.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Core
{
    ...
    public abstract class SceneQuery
    {
        ...
        {
            get { return this.queryMask; }
            set { this.queryMask = value; }
        }
        ...
        {
            get { return this.queryTypeMask; }
            set { this.queryTypeMask = value; }
        }
    ...
    public class SceneQueryResult
    {
        ...
        ///</summary>
        public List<Axiom.Core.SceneQuery.WorldFragment> worldFragments =
            new List<Axiom.Core.SceneQuery.WorldFragment>();
    }
    ...
    public abstract class RaySceneQuery : SceneQuery, IRaySceneQueryListener
    {
        ...
        {
            get { return this.sortByDistance; }
            set { this.sortByDistance = value; }
        }
    ...
    public abstract class IntersectionSceneQuery : SceneQuery, IIntersectionSceneQueryListener
    {
        ...
        bool Axiom.Core.IIntersectionSceneQueryListener.OnQueryResult(MovableObject obj,
    ...
    public class IntersectionSceneQueryResult
    {
        protected SceneQueryMovableObjectIntersectionList objects2Objects =
            new SceneQueryMovableObjectIntersectionList();
