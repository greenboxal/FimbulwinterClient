...
//     <id value="$Id: Node.cs 3303 2012-05-31 12:10:26Z borrillis $"/>
// </file>
        ...
        public class DebugRenderable : DisposableObject, IRenderable
        {
            ...
            public DebugRenderable(Node parent)
            {
                ...
                if (this._material == null)
                {
                    this._material =
                        (Material)
                        MaterialManager.Instance.Create(materialName, ResourceGroupManager.InternalResourceGroupName);
                    ...
                    Vector3[] basepos = new Vector3[7]
                                            {
                                                ...
                                                new Vector3(0.7f, 0.05f, 0f), // head
                                                new Vector3(0.7f, -0.15f, 0f), new Vector3(1f, 0f, 0f),
            ...
            {
                get { return this._emptyLightList; }
            }
            ...
            public void GetWorldTransforms(Matrix4[] matrices)
            {
                ...
                if (!Utility.RealEqual(this._scaling, 1.0))
                {
                    ...
                    Vector3 s = new Vector3(this._scaling, this._scaling, this._scaling);
                    m.Scale = s;
...
#pragma warning restore 67
        ...
        public void AddChild(Node child)
        {
            ...
            {
                throw new ArgumentException(string.Format("Node '{0}' already has a child node with the name '{1}'.",
                                                          this.name,
                                                          childName));
            }
        ...
        ///</remarks>
        ///<param name="axes"> 3x3 Matrix containg 3 column vectors each representing the X, Y and Z axes respectively. In this format the standard cartesian axes would be expressed as: 1 0 0 0 1 0 0 0 1 i.e. The Identity matrix. </param>
        ...
        /// </summary>
        /// <remarks>
        ///   This is autogenerated initially, so setting it is optional.
        /// </remarks>
        public string Name
        {
        ...
        {
            get { return this.inheritOrientation; }
            set
            {
        ...
        ///</remarks>
        protected void MakeInverseTransform(Vector3 position, Vector3 scale, Quaternion orientation,
                                            ref Matrix4 destMatrix)
        {
        ...
        public virtual Vector3 DerivedPosition
        {
            ...
            set
            {
                if (this.parent != null)
                {
                    this.position = this.parent.DerivedOrientation.Inverse()*(value - this.parent.DerivedPosition)/
                                    this.parent.DerivedScale;
                }
                else
                {
                    this.position = value;
