...
//     <id value="$Id: Frustum.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Core
{
    ...
    public class Frustum : MovableObject, IRenderable
    {
        ...
        ///  it.
        ///</remarks>
        ///<value> The distance to the far clipping plane from the frustum in world coordinates. If you specify 0, this means an infinite view distance which is useful especially when projecting shadows; but be careful not to use a near distance too close. </value>
        public virtual Real Far
        {
            get { return this._farDistance; }
            set
            {
        ...
        {
            get { return this._frustumOffset; }
            set
            {
        ...
        {
            get { return this._customViewMatrix; }
        }
        ...
        {
            get { return this._customProjectionMatrix; }
        }
        ...
        {
            get { return this._reflectionMatrix; }
            protected set { this._reflectionMatrix = value; }
        }
        ...
        {
            get { return this._reflectionPlane; }
            protected set { this._reflectionPlane = value; }
        }
        ...
        {
            get { return this._orthoHeight*this._aspectRatio; }
            set
            {
        ...
        private void Initialize()
        {
            ...
            this._vertexData.vertexBufferBinding.SetBinding(0,
                                                            HardwareBufferManager.Instance.CreateVertexBuffer(
                                                                this._vertexData.vertexDeclaration,
                                                                this._vertexData.vertexCount,
        ...
        ///</summary>
        ///<remarks>
        ///  <p>There are several applications for clipping a scene arbitrarily by
        ...
        ///  <p>This version of the method links to a plane, rather than requiring
        ///    a by-value plane definition, and therefore you can
        ///    make changes to the plane (e.g. by moving / rotating the node it is
        ///    attached to) and they will automatically affect this object.</p>
        ...
        ///<param name="culledBy"> Optional FrustrumPlane params which will be filled by the plane which culled the box if the result was false. </param>
        ...
        public virtual bool ProjectSphere(Sphere sphere, out float left, out float top, out float right,
                                          out float bottom)
        {
            // initialise
            left = bottom = -1.0f;
            ...
            Vector3 eyeSpacePos = ViewMatrix.TransformAffine(sphere.Center);
            ...
            if (eyeSpacePos.z < 0)
            {
                ...
                Vector3 screenSpacePos = ProjectionMatrix*eyeSpacePos;
        ...
        protected void CalculateProjectionParameters(out Real vpLeft, out Real vpRight, out Real vpBottom,
                                                     out Real vpTop)
        {
            if (this._customProjectionMatrix)
            {
                // Convert clipspace corners to camera space
                Matrix4 invProj = this._projectionMatrix.Inverse();
            ...
            else if (ProjectionType == Projection.Perspective)
            {
                ...
                Real tanThetaX = tanThetaY*this._aspectRatio;

                // Unknown how to apply frustum offset to orthographic camera, just ignore here
                Real nearFocal = this._nearDistance/this._focalLength;
                Real nearOffsetX = this._frustumOffset.x*nearFocal;
                Real nearOffsetY = this._frustumOffset.y*nearFocal;
                Real half_w = tanThetaX*this._nearDistance;
                Real half_h = tanThetaY*this._nearDistance;
        ...
        protected virtual void _updateFrustum()
        {
            ...
            if (!this._customProjectionMatrix)
            {
                ...
                if (this._projectionType == Projection.Perspective)
                {
                    ...
                    if (this.useObliqueDepthProjection)
                    {
                        ...
                        Plane plane = this._viewMatrix*this.obliqueProjPlane;
                        ...
                        q1.y = (System.Math.Sign(plane.Normal.y) + this._projectionMatrix.m12)/
                               this._projectionMatrix.m11;
                        q1.z = -1.0f;
            ...
            Real farDist = (this._farDistance == 0.0f) ? InfiniteFarPlaneDistance : this._farDistance;
        ...
        protected virtual void _updateFrustumPlanes()
        {
            ...
            // -------------------------
            Matrix4 combo = this._projectionMatrix*this._viewMatrix;
        ...
        {
            Matrix4 eyeToWorld = this._viewMatrix.InverseAffine();
            ...
            this._worldSpaceCorners[2] =
                eyeToWorld.TransformAffine(new Vector3(nearLeft, nearBottom, -this._nearDistance));
            this._worldSpaceCorners[3] =
                eyeToWorld.TransformAffine(new Vector3(nearRight, nearBottom, -this._nearDistance));
            // far
        ...
        protected virtual void UpdateVertexData()
        {
            if (this._recalculateVertexData)
            {
                ...
                HardwareVertexBuffer buffer = this._vertexData.vertexBufferBinding.GetBuffer(0);

                BufferBase posPtr = buffer.Lock(BufferLocking.Discard);
                ...
                {
                    int pos = 0;
                    float* pPos = posPtr.ToFloatPointer();
        ...
        {
            get { return (this._farDistance == 0) ? InfiniteFarPlaneDistance : this._farDistance; }
        }
        ...
        {
            get { return (uint) SceneQueryTypeMask.Frustum; }
        }
        ...
        {
            get { return this._material.GetBestTechnique(); }
        }
        ...
        {
            get { return this.dummyLightList; }
        }
