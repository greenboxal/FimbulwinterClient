...
//     <id value="$Id: Mesh.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Core
{
    ...
    public class Mesh : Resource
    {
        ...
        {
            get { return this._sharedVertexData; }
            set { this._sharedVertexData = value; }
        }
        ...
        {
            get { return this._subMeshList.Count; }
        }
        ...
        {
            get { return this._boundingSphereRadius; }
            set { this._boundingSphereRadius = value; }
        }
        ...
        /// <summary>
        ///   Reference to the skeleton bound to this mesh.
        /// </summary>
        ...
        public Skeleton Skeleton
        {
            ...
            protected set { this._skeleton = value; }
        }
        ...
        /// <summary>
        ///   Name of the skeleton bound to this mesh.
        /// </summary>
        ...
        {
            get { return (this._skeletonName.Length != 0); }
        }
        ...
        {
            get { return this._boneAssignmentList; }
        }
        ...
        /// <summary>
        ///   Number of blend weights that are assigned to each vertex.
        /// </summary>
        ...
        {
            get { return this._vertexBufferUsage; }
            protected set { this._vertexBufferUsage = value; }
        }
        ...
        {
            get { return this._indexBufferUsage; }
            protected set { this._indexBufferUsage = value; }
        }
        ...
        {
            get { return this._useVertexShadowBuffer; }
            protected set { this._useVertexShadowBuffer = value; }
        }
        ...
        {
            get { return this._useIndexShadowBuffer; }
            protected set { this._useIndexShadowBuffer = value; }
        }
        ...
        {
            get { return this._isPreparedForShadowVolumes; }
        }
        ...
        {
            get { return this._autoBuildEdgeLists; }
            set { this._autoBuildEdgeLists = value; }
        }
        ...
        {
            get { return this._edgeListsBuilt; }
            protected internal set { this._edgeListsBuilt = value; }
        }
        ...
        /// <summary>
        ///   Internal list of named transforms attached to this mesh.
        /// </summary>
        ...
        {
            get { return this._attachmentPoints; }
        }
        ...
        {
            get { return this._animationsList.Count; }
        }
        ...
        {
            get { return this._animationsList.Count > 0; }
        }
        ...
        {
            get { return this._animationTypesDirty; }
        }
        ...
        {
            get { return this._triangleIntersector; }
            set { this._triangleIntersector = value; }
        }
        ...
        public void BuildTangentVectors(short sourceTexCoordSet, short destTexCoordSet)
        {
...
#endif
            {
                ...
                for (int sm = 0; sm < numSubMeshes; sm++)
                {
                    ...
                    VertexElement srcElem = decl.FindElementBySemantic(VertexElementSemantic.TexCoords,
                                                                       sourceTexCoordSet);
                    ...
                    for (int n = 0; n < numFaces; n++)
                    {
                        ...
                        Vector3 tangent = Utility.CalculateTangentSpaceVector(vertPos[0], vertPos[1], vertPos[2], u[0],
                                                                              v[0],
                                                                              u[1], v[1], u[2], v[2]);
                                                       ...
                                                       int numBlendWeightsPerVertex, VertexData targetVertexData)
        {
            ...
            if (firstElem.Semantic == VertexElementSemantic.Position)
            {
                ...
                weightElem = decl.InsertElement(insertPoint + 1, bindIndex, Memory.SizeOf(typeof (byte))*4,
                                                VertexElement.MultiplyTypeCount(VertexElementType.Float1,
            ...
            HardwareVertexBuffer vbuf = HardwareBufferManager.Instance.CreateVertexBuffer(decl.Clone(bindIndex),
        ...
        protected void OrganizeTangentsBuffer(VertexData vertexData, short destCoordSet)
        {
            ...
            if (needsToBeCreated)
            {
                ...
                VertexElement prevTexCoordElem =
                    vertexData.vertexDeclaration.FindElementBySemantic(VertexElementSemantic.TexCoords,
                ...
                HardwareVertexBuffer newBuffer = HardwareBufferManager.Instance.CreateVertexBuffer(decl,
                                                                                                   vertexData.
                                                                                                       vertexCount,
                                                                                                   origBuffer.Usage,
                                                                                                   origBuffer.
        ...
        /// <summary>
        ///   Returns whether or not this mesh has the named vertex animation.
        /// </summary>
        ...
        /// <param name="assignments"> The bone assignment list to rationalize. This list will be modified and entries will be removed where the limits are exceeded. </param>
        ...
        ///<param name="useShadowBuffer"> If set to true, the vertex buffers will be created with a system memory shadow buffer. You should set this if you want to be able to read from the buffer, because reading from a hardware buffer is a no-no. </param>
        ...
        ///</remarks>
        ///<param name="usage"> The usage flags, which by default are <see cref="BufferUsage.StaticWriteOnly" /> </param>
        ///<param name="useShadowBuffer"> If set to true, the index buffers will be created with a system memory shadow buffer. You should set this if you want to be able to read from the buffer, because reading from a hardware buffer is a no-no. </param>
                ...
                foreach (VertexAnimationTrack track in anim.VertexTracks.Values)
                {
                    ...
                    else
                    {
                            ...
                            sm.CurrentVertexAnimationType != track.AnimationType)
                        {
                            // Mixing of morph and pose animation on same data is not allowed
                            throw new Exception(
                                string.Format("Animation tracks for dedicated vertex data {0}  on mesh {1}", handle - 1,
                                              Name) +
                                " try to mix vertex animation types, which is " +
                                "not allowed, in Mesh.DetermineAnimationTypes");
                        }
        ...
        /// <summary>
        ///   Retrieve an existing Pose index by name.
        /// </summary>
        ...
        {
            get { return this._isLodManual; }
            protected internal set { this._isLodManual = value; }
        }
        ...
        {
            get { return this.meshLodUsageList; }
        }
        ...
        {
            get { return this.meshLodUsageList.Count; }
        }
...
#warning Implement Mesh.edgeListsBuilt
        ...
        ///</remarks>
        ///<param name="sourceVertexData"> <see cref="VertexData" /> class containing positions, normals, blend indices and blend weights. </param>
        ///<param name="targetVertexData"> <see cref="VertexData" /> class containing target position and normal buffers which will be updated with the blended versions. Note that the layout of the source and target position / normal buffers must be identical, ie they must use the same buffer indexes. </param>
                                               ...
                                               bool blendNormals, bool blendTangents, bool blendBinorms)
        {
...
#endif
            {
                ...
                if (includeBinormals && srcBinormBuf != srcPosBuf && srcBinormBuf != srcNormBuf &&
                ...
                if (includeBinormals && destBinormBuf != destPosBuf && destBinormBuf != destNormBuf &&
