...
//     <id value="$Id: Resource.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Core
{
    ...
    public abstract class Resource : ScriptableObject
    {
        ...
        public ResourceManager Creator
        {
            ...
            protected set { this._creator = value; }
        }
        ...
        {
            [OgreVersion(1, 7, 2)]
            get { return this._loadingState.Value == LoadingState.Loading; }
        }
        ...
        {
            get { return this._isManuallyLoaded; }
            protected set { this._isManuallyLoaded = value; }
        }
        ...
        {
            get { return this._loadingState.Value; }
        }
        ...
        {
            get { return this._isBackgroundLoaded; }
            set { this._isBackgroundLoaded = value; }
        }
        ...
        {
            get { return this._isManuallyLoaded || (this._loader != null); }
        }
...
#endif
                {
                    ...
                    else
                    {
                        ...
                        if (Group == ResourceGroupManager.AutoDetectResourceGroupName)
                        {
                            ...
                            Math.Tuple<bool, string> result =
                                ResourceGroupManager.Instance.FindGroupContainingResource(Name);
                            if (result.First)
                            {
                                Group = result.Second;
                            }
                            else
                            {
                                LogManager.Instance.Write(
                                    string.Format(
                                        "Unable to derive resource group for {0} automatically since the resource was not found.",
                                        Name));
