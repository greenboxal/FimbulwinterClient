...
//     <id value="$Id: DistanceLodStrategy.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
    ...
    public class DistanceLodStrategy : LodStrategy, ISingleton<DistanceLodStrategy>
    {
        ...
        public bool ReferenceViewEnabled
        {
            set
            {
                ...
                if (value)
                {
                    Debug.Assert(this.ReferenceViewValue != float.NaN,
                                 "Reference view must be set before being enabled!");
                }

                this._referenceViewEnabled = value;
            }
            get { return this._referenceViewEnabled; }
        }
