...
//     <id value="$Id: SubMesh.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Core
{
    ...
    public class SubMesh : DisposableObject
    {
        ...
        {
            get { return this.isMaterialInitialized; }
        }
        ...
        {
            get { return this.boneAssignmentList; }
        }
        ...
        public VertexAnimationType VertexAnimationType
        {
            ...
            set { this.vertexAnimationType = value; }
        }

        public VertexAnimationType CurrentVertexAnimationType
        {
            get { return this.vertexAnimationType; }
        }

        public List<IndexData> LodFaceList
        {
            get { return this.lodFaceList; }
        }
