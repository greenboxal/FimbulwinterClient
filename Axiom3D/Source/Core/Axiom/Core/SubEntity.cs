...
//     <id value="$Id: SubEntity.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Core
{
    ...
    ///</summary>
    ///<remarks>
    ///  <para> Just as models are split into meshes, an Entity is made up of potentially multiple SubEntities. These are mainly here to provide the link between the Material which the SubEntity uses (which may be the default Material for the SubMesh or may have been changed for this object) and the SubMesh data. </para>
    ///  <para> SubEntity instances are never created manually. They are created at the same time as their parent Entity by the SceneManager method CreateEntity. </para>
    ///</remarks>
    public class SubEntity : DisposableObject, IRenderable
    {
        ...
        {
            get { return this.tempSkelAnimInfo; }
        }

        public TempBlendedBufferInfo TempVertexAnimInfo
        {
            get { return this.tempVertexAnimInfo; }
        }
        ...
        {
            get { return this.hardwarePoseCount; }
            set { this.hardwarePoseCount = value; }
        }
        ...
        {
            get { return this._materialLodIndex; }
            set { this._materialLodIndex = value; }
        }
        ...
        {
            get { return this.parent.CastShadows; }
        }
        ...
        {
            get { return this.material.GetBestTechnique(this._materialLodIndex, this); }
        }
        ...
        public VertexData GetVertexDataForBinding()
        {
            ...
            else
            {
                VertexDataBindChoice c =
                    this.parent.ChooseVertexDataForBinding(this.subMesh.VertexAnimationType != VertexAnimationType.None);
                switch (c)
                {
...
#warning SubMesh.ExtremityPoints implementation needed.
        ...
        {
            get { return this.parent.QueryLights(); }
        }
        ...
        {
            get { return this.useVertexProgram && this.hardwareSkinningEnabled; }
            set { this.hardwareSkinningEnabled = value; }
        }

        public bool VertexProgramInUse
        {
            get { return this.useVertexProgram; }
            set { this.useVertexProgram = value; }
        }
        ...
        public void RestoreBuffersForUnusedAnimation(bool hardwareAnimation)
        {
                ...
                (!hardwareAnimation || this.subMesh.VertexAnimationType == VertexAnimationType.Morph))
            {
                VertexElement srcPosElem =
                    this.subMesh.vertexData.vertexDeclaration.FindElementBySemantic(VertexElementSemantic.Position);
