...
//     <id value="$Id: Texture.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Core
{
    ...
    public abstract class Texture : Resource, ICopyable<Texture>
    {
        ...
        public int Width
        {
            ...
            [OgreVersion(1, 7, 2)]
            set { this.width = this.srcWidth = value; }
        }
        ...
        public int Height
        {
            ...
            [OgreVersion(1, 7, 2)]
            set { this.height = this.srcHeight = value; }
        }
        ...
        public int Depth
        {
            ...
            [OgreVersion(1, 7, 2)]
            set { this.depth = this.srcDepth = value; }
        }
        ...
        {
            [OgreVersion(1, 7, 2)]
            get { return PixelUtil.HasAlpha(this.format); }
        }
        ...
        /// </summary>
        /// <value> <c>true</c> if treat luminence as aplha; otherwise, <c>false</c> . </value>
        public bool TreatLuminanceAsAlpha
        {
            [OgreVersion(1, 7, 2)]
            get { return this.treatLuminanceAsAlpha; }

            [OgreVersion(1, 7, 2)]
            set { this.treatLuminanceAsAlpha = value; }
        }
        ...
        /// <summary>
        ///   Gamma setting for this texture.
        /// </summary>
        ...
        {
            [OgreVersion(1, 7, 2)]
            get { return this.mipmapCount; }

            [OgreVersion(1, 7, 2)]
            set { this.requestedMipmapCount = this.mipmapCount = value; }
        }
        ...
        /// <summary>
        ///   Are the mipmaps generated in hardware?
        /// </summary>
        ...
        /// </summary>
        /// <value> <c>true</c> if mipmaps are hardware generated; otherwise, <c>false</c> . </value>
        public virtual bool MipmapsHardwareGenerated
        {
            [OgreVersion(1, 7, 2)]
            get { return this.mipmapsHardwareGenerated; }
        }
        ...
        /// <summary>
        ///   Type of texture, i.e. 1D, 2D, Cube, Volume.
        /// </summary>
        ...
        /// <summary>
        ///   Specifies how this texture will be used.
        /// </summary>
        ...
        /// <summary>
        ///   Original source width if this texture had been modified.
        /// </summary>
        ...
        /// <summary>
        ///   Original source height if this texture had been modified.
        /// </summary>
        ...
        /// <summary>
        ///   Original source bits per pixel if this texture had been modified.
        /// </summary>
        ...
        /// <summary>
        ///   Original depth of the input texture (only applicable for 3D textures).
        /// </summary>
        ...
        /// <summary>
        ///   Original format of the input texture (only applicable for 3D textures).
        /// </summary>
        ...
        /// <summary>
        ///   Desired format of the input texture (only applicable for 3D textures).
        /// </summary>
        ...
        {
            [OgreVersion(1, 7, 2)]
            get { return this.desiredIntegerBitDepth; }

            [OgreVersion(1, 7, 2)]
            set { this.desiredIntegerBitDepth = value; }
        }
        ...
        {
            [OgreVersion(1, 7, 2)]
            get { return this.desiredFloatBitDepth; }

            [OgreVersion(1, 7, 2)]
            set { this.desiredFloatBitDepth = value; }
        }
        ...
        ///   usage options on this texture, or if the hardware does not support it.</note>
        ...
        {
            [OgreVersion(1, 7, 2)]
            get { return this.hwGamma; }

            [OgreVersion(1, 7, 2)]
            set { this.hwGamma = value; }
        }
        ...
        {
            get { return (TextureType == TextureType.CubeMap) ? 6 : 1; }
        }
        ...
        public Texture(ResourceManager parent, string name, ResourceHandle handle, string group, bool isManual,
                       IManualResourceLoader loader = null)
#else
		public Texture( ResourceManager parent, string name, ResourceHandle handle, string group, bool isManual,
        ...
        ///   performs locking and checks the load status before loading.</note>
        ...
        ///    not check or update resource loading status.</note>
        ///</summary>
        ///<param name="images"> Vector of pointers to Images. If there is only one image in this vector, the faces of that image will be used. If there are multiple images in the vector each image will be loaded as a face. </param>
        [OgreVersion(1, 7, 2)]
        public virtual void LoadImages(Image[] images)
        {
            ...
            if (TextureManager.Instance.Verbose)
            {
                ...
                msg.AppendFormat(" Internal format is {0} , {1}x{2}x{3}.", PixelUtil.GetFormatName(buf.Format),
                                 buf.Width,
            ...
            for (int mip = 0; mip <= imageMips; ++mip)
            {
                for (int i = 0; i < faces; ++i)
                {
                    ...
                    if (this.gamma != 1.0f)
                    {
                        ...
                        Image.ApplyGamma(corrected.Data, this.gamma, corrected.ConsecutiveSize,
        ...
        public virtual void CopyTo(Texture target)
        {
            ...
            int numMips = Axiom.Math.Utility.Min(MipmapCount, target.MipmapCount);
            if ((this.usage & TextureUsage.AutoMipMap) == TextureUsage.AutoMipMap ||
...
#endif
        {
            ...
            for (int face = 0; face < FaceCount; ++face)
            {
                for (int mip = 0; mip < numMips; ++mip)
                {
                    ...
                    PixelBox pixBox = new PixelBox(Width, Height, Depth, Format, currentPixData);
            ...
            destImage = (new Image()).FromDynamicImage(pixData, Width, Height, Depth, Format, true, FaceCount,
                                                       numMips - 1);
        }
