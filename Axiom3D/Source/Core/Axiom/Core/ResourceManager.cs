...
//     <id value="$Id: ResourceManager.cs 3362 2012-07-29 00:40:37Z romeoxbm $"/>
// </file>
...
namespace Axiom.Core
{
    ...
    public abstract class ResourceManager : DisposableObject, IScriptLoader
    {
        ...
        {
            get { return resourceHandleMap.Values; }
        }
        ...
        private readonly Dictionary<ResourceHandle, Resource> _resourceHandleMap =
            new Dictionary<ResourceHandle, Resource>();
        ...
        {
            get { return this._resourceHandleMap; }
        }
        ...
        public Resource this[ResourceHandle handle]
        {
            get
            {
                Debug.Assert(this._resourceHandleMap != null,
                             "A resource was being retrieved, but the list of Resources is null.",
                             "");
                                       ...
                                       NameValuePairList createParams)
        {
            ...
            Resource ret = _create(name, (ResourceHandle) name.ToLower().GetHashCode(), group, isManual, loader,
                                   createParams);
        ...
        public Axiom.Math.Tuple<Resource, bool> CreateOrRetrieve(string name, string group, bool isManual,
                                                                 ...
                                                                 NameValuePairList paramaters)
        {
            ulong hashCode = (ResourceHandle) name.ToLower().GetHashCode();
        ...
        /// <param name="isManual"> Is this resource manually loaded? If so, you should really populate the loader parameter in order that the load process can call the loader back when loading is required. </param>
        /// <param name="loader"> A ManualLoader implementation which will be called when the Resource wishes to load (should be supplied if you set isManual to true). You can in fact leave this parameter null if you wish, but the Resource will never be able to reload if anything ever causes it to unload. Therefore provision of a proper ManualLoader instance is strongly recommended. </param>
        /// <param name="createParams"> If any parameters are required to create an instance, they should be supplied here as name / value pairs. These do not need to be set on the instance (handled elsewhere), just used if required to differentiate which concrete class is created. </param>
        /// <returns> </returns>
        ...
        protected virtual void _add(Resource res)
        {
            ...
            {
                throw new AxiomException(String.Format("Resource '{0}' with the handle {1} already exists.", res.Name,
                                                       res.Handle));
            }
        }
        ...
        {
            get { return this._scriptPatterns; }
            protected set { this._scriptPatterns = value; }
        }
        ...
        {
            get { return this._loadingOrder; }
            protected set { this._loadingOrder = value; }
        }
