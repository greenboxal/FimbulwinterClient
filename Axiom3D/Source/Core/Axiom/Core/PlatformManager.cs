...
//     <id value="$Id: PlatformManager.cs 3366 2012-07-31 14:58:36Z borrillis $"/>
// </file>
        ...
        internal PlatformManager()
        {
            ...
            if (instance == null)
            {
                ...
                for (int index = 0; index < assemblies.Length && instance == null; index++)
                {
                    ...
                    try
                    {
                        DynamicLoader platformMgr = new DynamicLoader(assemblies[index]);
                        IList<ObjectCreator> platforms = platformMgr.Find(typeof (IPlatformManager));
                        if (platforms.Count != 0)
                        {
                            instance = platformMgr.Find(typeof (IPlatformManager))[0].CreateInstance<IPlatformManager>();
                    ...
                    {
                        System.Diagnostics.Debug.WriteLine(String.Format("Failed to load assembly: {0}.",
                                                                         assemblies[index].FullName));
                    }
                }
            }
            ...
            if (instance == null)
            {
                ...
                string[] files = Directory.GetFiles(cwd, "Axiom.Platforms.*.dll").ToArray();
                string file = "";
                ...
                else
                {
                    ...
                    string platform = IsWindowsOS ? "Windows" : "Linux";
                    ...
                    System.Diagnostics.Debug.WriteLine(String.Format("Selected the PlatformManager contained in {0}.",
                                                                     file));
                }
