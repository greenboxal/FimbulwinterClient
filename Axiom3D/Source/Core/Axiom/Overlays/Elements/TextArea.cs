...
//     <id value="$Id: TextArea.cs 3315 2012-05-31 20:37:22Z borrillis $"/>
// </file>
    ...
    public class TextArea : OverlayElement
    {
        ...
        protected void CheckMemoryAllocation(int numChars)
        {
            if (this.allocSize < numChars)
            {
                ...
                HardwareVertexBuffer buffer =
                    HardwareBufferManager.Instance.CreateVertexBuffer(decl.Clone(POSITION_TEXCOORD_BINDING),
        ...
        public override void Initialize()
        {
            if (!isInitialized)
            {
                ...
                // positions
                decl.AddElement(POSITION_TEXCOORD_BINDING, offset, VertexElementType.Float3,
                                VertexElementSemantic.Position);
                offset += VertexElement.GetTypeSize(VertexElementType.Float3);

                // texcoords
                decl.AddElement(POSITION_TEXCOORD_BINDING, offset, VertexElementType.Float2,
        ...
        protected void UpdateGeometry()
        {
            ...
            // get pos/tex buffer
            HardwareVertexBuffer buffer =
                renderOperation.vertexData.vertexBufferBinding.GetBuffer(POSITION_TEXCOORD_BINDING);
            BufferBase data = buffer.Lock(BufferLocking.Discard);
        ...
        {
            get { return this.font != null ? this.font.Name : null; }
            set
            {
        ...
        public class CharacterHeightAttributeCommand : IPropertyCommand
        {
            ...
            {
                TextArea element = target as TextArea;
                if (element != null)
                {
