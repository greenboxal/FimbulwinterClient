...
//     <id value="$Id: BorderPanel.cs 3361 2012-07-29 00:06:09Z romeoxbm $"/>
// </file>
    ...
    public class BorderPanel : Panel
    {
        ...
        protected override void UpdateTextureGeometry()
        {
			...
			*/
            ...
            HardwareVertexBuffer vbuf = this.renderOp2.vertexData.vertexBufferBinding.GetBuffer(BorderPanel.TEXCOORDS);
        ...
        public override void Initialize()
        {
            ...
            if (init)
            {
				...
				*/
                ...
                this.renderOp2.indexData.indexBuffer = HardwareBufferManager.Instance.CreateIndexBuffer(
                    IndexType.Size16,
        ...
        public void SetCellUV(BorderCell cell, float u1, float v1, float u2, float v2)
        {
            ...
            BufferBase data = buffer.Lock(cellIndex*8*Memory.SizeOf(typeof (float)), Memory.SizeOf(typeof (float))*8,
        ...
        {
            get { return this.borderMaterialName; }
            set
            {
        ...
        public class BorderSizeAttributeCommand : IPropertyCommand
        {
            ...
            {
                BorderPanel element = target as BorderPanel;
                if (element != null)
                {
                    return String.Format("{0} {1} {2} {3}", element.LeftBorderSize, element.RightBorderSize,
                                         element.TopBorderSize,
        ...
        public class BorderRenderable : IRenderable
        {
            ...
            {
                get { return this.parent.renderOp2; }
            }
            ...
            {
                get { return this.parent.PolygonModeOverrideable; }
            }

            public Material Material
            {
                get { return this.parent.borderMaterial; }
            }
