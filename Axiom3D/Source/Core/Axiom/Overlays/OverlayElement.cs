...
//     <id value="$Id: OverlayElement.cs 3361 2012-07-29 00:06:09Z romeoxbm $"/>
// </file>
...
namespace Axiom.Overlays
{
    ...
    public abstract class OverlayElement : ScriptableObject, IRenderable
    {
        ...
        {
            OverlayElement newElement = OverlayElementManager.Instance.CreateElement(GetType().Name,
        ...
        public virtual void UpdateFromParent()
        {
            ...
            if (this.parent != null)
            {
                ...
                Rectangle childRect = new Rectangle((long) this.derivedLeft, (long) this.derivedTop,
        ...
        {
            get { return this.sourceTemplate; }
        }
        ...
        {
            get { return this.isCloneable; }
            set { this.isCloneable = value; }
        }
        ...
        {
            get { return this.overlay.DerivedOrientation; }
        }
        ...
        {
            get { return this.overlay.DerivedPosition; }
        }

        public LightList Lights
        {
            get { return this.emptyLightList; }
        }
        ...
        public class MetricsModeAttributeCommand : IPropertyCommand
        {
            ...
            {
                OverlayElement element = target as OverlayElement;
                if (element != null)
                {
        ...
        [ScriptableProperty("horz_align", "The horizontal alignment, 'left', 'right' or 'center'.",
            typeof (OverlayElement)
            )]
        public class HorizontalAlignmentAttributeCommand : IPropertyCommand
        {
            ...
            public string Get(object target)
            {
                ...
                if (element != null)
                {
                    return ScriptEnumAttribute.GetScriptAttribute((int) element.HorizontalAlignment,
        ...
        [ScriptableProperty("vert_align", "The vertical alignment, 'top', 'bottom' or 'center'.",
            typeof (OverlayElement))
        ]
        public class VerticalAlignmentAttributeCommand : IPropertyCommand
        {
            ...
            public string Get(object target)
            {
                ...
                if (element != null)
                {
                    return ScriptEnumAttribute.GetScriptAttribute((int) element.VerticalAlignment,
            ...
            public void Set(object target, string val)
            {
                ...
                if (element != null)
                {
                    element.VerticalAlignment =
                        (VerticalAlignment) ScriptEnumAttribute.Lookup(val, typeof (VerticalAlignment));
                }
            }
