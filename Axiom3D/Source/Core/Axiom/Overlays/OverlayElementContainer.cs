...
//     <id value="$Id: OverlayElementContainer.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Overlays
{
    ...
    public abstract class OverlayElementContainer : OverlayElement
    {
        ...
        {
            get { return true; }
            set { this.childrenProcessEvents = value; }
        }
                ...
                foreach (OverlayElement oldChildElement in ((OverlayElementContainer) templateOverlay).Children.Values)
                {
                    if (oldChildElement.IsCloneable)
                    {
                        OverlayElement newChildElement =
                            OverlayManager.Instance.Elements.CreateElement(oldChildElement.GetType().Name,
