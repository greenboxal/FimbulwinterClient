...
//     <id value="$Id: OverlayManager.cs 3361 2012-07-29 00:06:09Z romeoxbm $"/>
// </file>
...
namespace Axiom.Overlays
{
    ...
    public sealed class OverlayManager : Singleton<OverlayManager>, IScriptLoader
    {
        ...
        {
            get { return this._overlays.Values.GetEnumerator(); }
        }
        ...
        {
            get { return this._viewportDimensionsChanged; }
        }
        ...
        {
            get { return this._lastViewportHeight; }
        }
        ...
        {
            get { return this._lastViewportWidth; }
        }
        ...
        {
            get { return this._lastViewportHeight/(Real) this._lastViewportWidth; }
        }
        ...
        {
            foreach (Overlay entry in this._overlays.Values)
                entry.SafeDispose();
        ...
        {
            get { return OverlayElementManager.Instance; }
        }
                                   ...
                                   OverlayElementContainer parent)
        {
                ...
                (parms[0 + skipParam] == "element" && (isTemplate || parent != null)))
            {
                ...
                if (parms.Length > 3 + skipParam)
                {
                    if (parms.Length != 5 + skipParam)
                    {
                        LogManager.Instance.Write(
                            "Bad element/container line: {0} in {1} - {2}, expecting ':' templateName", line,
                ...
                {
                    LogManager.Instance.Write(
                        "Bad element/container line: {0} in {1} - {2}, expecting 'element type(name)'.", line,
                        parent.GetType().Name, parent.Name);
                    ParseHelper.SkipToNextCloseBrace(script);
                    return ret;
                }
        ...
        {
            string line;
            OverlayElement element = OverlayElementManager.Instance.CreateElementFromTemplate(templateName, type, name,
                                                                                              isTemplate);
