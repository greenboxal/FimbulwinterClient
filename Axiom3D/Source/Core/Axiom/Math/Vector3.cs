...
//     <id value="$Id: Vector3.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Math
{
    ...
    public struct Vector3
    {
        ...
        private static readonly Vector3 positiveInfinityVector = new Vector3(Real.PositiveInfinity,
        ...
        private static readonly Vector3 negativeInfinityVector = new Vector3(Real.NegativeInfinity,
        ...
        public Vector3(Real[] coordinates)
        {
            if (coordinates.Length != 3)
            {
                throw new ArgumentException(
                    "The coordinates array must be of length 3 to specify the x, y, and z coordinates.");
            }
        ...
        /// </remarks>
        /// <param name="vec"> vec Vector with which to calculate the absolute dot product (together with this one). </param>
        ...
        {
            return new Vector3((xMult == 0) ? 0 : xMult*Utility.SymmetricRandom(),
        ...
        {
            Vector3 newUp = (up == Vector3.Zero) ? Perpendicular() : up;
        ...
        ///<overloads>
        ///  <summary>
        ///    Returns wether this vector is within a positional tolerance of another vector
        ///  </summary>
        ///  <param name="right"> The vector to compare with </param>
        ///</overloads>
        ///<remarks>
        ///  Uses a defalut tolerance of 1E-03
        ///</remarks>
        ...
        public bool IsZero
        {
            get { return this.x == 0f && this.y == 0f && this.z == 0f; }
        }
        ...
        public Real Length
        {
            get { return Utility.Sqrt(this.x*this.x + this.y*this.y + this.z*this.z); }
        }
        ...
        ///</summary>
        ///<param name="vector"> A string representation of a Vector3 as it's returned from Vector3.ToString() </param>
