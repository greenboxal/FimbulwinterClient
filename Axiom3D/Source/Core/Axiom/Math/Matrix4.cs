...
namespace Axiom.Math
{
    ...
    public struct Matrix4
    {
        ...
        ///</summary>
        public Matrix4(Real m00, Real m01, Real m02, Real m03, Real m10, Real m11, Real m12, Real m13, Real m20,
                       Real m21,
        ...
        {
            get { return clipSpace2dToImageSpace; }
        }
        ...
        {
            get { return this.m30 == 0 && this.m31 == 0 && this.m32 == 0 && this.m33 == 1; }
        }
        ...
        private Matrix4 Adjoint()
        {
            ...
            Real val0 = this.m11*(this.m22*this.m33 - this.m32*this.m23) -
                        this.m12*(this.m21*this.m33 - this.m31*this.m23) +
                        this.m13*(this.m21*this.m32 - this.m31*this.m22);
            Real val1 =
            ...
            Real val2 = this.m01*(this.m12*this.m33 - this.m32*this.m13) -
            ...
            Real val4 =
                -(this.m10*(this.m22*this.m33 - this.m32*this.m23) - this.m12*(this.m20*this.m33 - this.m30*this.m23) +
                  this.m13*(this.m20*this.m32 - this.m30*this.m22));
            Real val5 = this.m00*(this.m22*this.m33 - this.m32*this.m23) -
            ...
            Real val7 = this.m00*(this.m12*this.m23 - this.m22*this.m13) -
                        this.m02*(this.m10*this.m23 - this.m20*this.m13) +
                        this.m03*(this.m10*this.m22 - this.m20*this.m12);
            Real val8 = this.m10*(this.m21*this.m33 - this.m31*this.m23) -
                        this.m11*(this.m20*this.m33 - this.m30*this.m23) +
                        this.m13*(this.m20*this.m31 - this.m30*this.m21);
            Real val9 =
            ...
            Real val10 = this.m00*(this.m11*this.m33 - this.m31*this.m13) -
            ...
            Real val12 =
                -(this.m10*(this.m21*this.m32 - this.m31*this.m22) - this.m11*(this.m20*this.m32 - this.m30*this.m22) +
                  this.m12*(this.m20*this.m31 - this.m30*this.m21));
            Real val13 = this.m00*(this.m21*this.m32 - this.m31*this.m22) -
            ...
            Real val15 = this.m00*(this.m11*this.m22 - this.m21*this.m12) -
                         this.m01*(this.m10*this.m22 - this.m20*this.m12) +
                         this.m02*(this.m10*this.m21 - this.m20*this.m11);

            return new Matrix4(val0, val1, val2, val3, val4, val5, val6, val7, val8, val9, val10, val11, val12, val13,
                               val14,
                               val15);
        }
