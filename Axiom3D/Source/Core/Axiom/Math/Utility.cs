...
//     <id value="$Id: Utility.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
    ...
    public sealed class Utility
    {
        ...
        public static Matrix4 BuildReflectionMatrix(Plane plane)
        {
            ...
            return new Matrix4(-2.0f*normal.x*normal.x + 1.0f, -2.0f*normal.x*normal.y, -2.0f*normal.x*normal.z,
                               ...
                               -2.0f*normal.y*normal.z, -2.0f*normal.y*plane.D, -2.0f*normal.z*normal.x,
        ...
        /// <param name="v3"> </param>
        /// <returns> </returns>
        public static Vector3 CalculateTangentSpaceVector(Vector3 position1, Vector3 position2, Vector3 position3,
                                                          Real u1,
        ...
        ///<param name="ax"> The X-coordinate of the triangle's first vertex. </param>
        ///<param name="ay"> The Y-coordinate of the triangle's first vertex. </param>
        ///<param name="bx"> The X-coordinate of the triangle's second vertex. </param>
        ///<param name="by"> The Y-coordinate of the triangle's second vertex. </param>
        ///<param name="cx"> The X-coordinate of the triangle's third vertex. </param>
        ///<param name="cy"> The Y-coordinate of the triangle's third vertex. </param>
        ///<returns> <list type="bullet">
        ///            <item>
        ///              <description>
        ///                <b>true</b>
        ///                - the point resides in the triangle.</description>
        ///            </item>
        ///            <item>
        ///              <description>
        ///                <b>false</b>
        ///                - the point is outside the triangle</description>
        ///            </item>
        ///          </list> </returns>
        ...
        public static IntersectResult Intersects(Ray ray, Vector3 a, Vector3 b, Vector3 c, Vector3 normal,
                                                 bool positiveSide,
                                                 bool negativeSide)
        {
        ...
        /// </summary>
        /// <param name="boxA"> The primary box. </param>
        /// <param name="boxB"> The box to test intersection with boxA. </param>
        /// <returns> <list type="bullet">
        ///             <item>
