...
//     <id value="$Id: QuaternionCollection.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Math.Collections
{
    ...
    public class QuaternionCollection : ICollection, IList, IEnumerable, ICloneable
    {
        ...
        ///</summary>
        ///<returns> An <c>QuaternionCollection</c> wrapper that is synchronized (thread-safe). </returns>
        ...
        ///  <c>QuaternionCollection</c> instance.
        ///</summary>
        ///<returns> An <c>QuaternionCollection</c> wrapper that is read-only. </returns>
        ...
        ///</summary>
        ///<param name="capacity"> The number of elements that the new <c>QuaternionCollection</c> is initially capable of storing. </param>
        ...
        {
            QuaternionCollection newColl = new QuaternionCollection(this.m_count);
        ...
        ///<returns> The zero-based index of the first occurrence of <paramref name="item" /> in the entire <c>QuaternionCollection</c> , if found; otherwise, -1. </returns>
        ...
        private class SyncQuaternionCollection : QuaternionCollection
        {
            ...
            {
                get { return this.m_collection.IsFixedSize; }
            }
