...
//     <id value="$Id: ShadowVolumeExtrudeProgram.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Graphics
{
    ...
    ///		 
    ///  <code>// Point light shadow volume extrude
    ...
    public sealed class ShadowVolumeExtrudeProgram
    {
        ...
        public static string[] programNames = new[]
                                                  {
        ...
        public static void Initialize()
        {
            ...
            if (!isInitialized)
            {
                ...
                bool[] vertexProgramFinite = new[]
                                                 {
                                                     false, false, false, false, true, true, true, true
                                                 };

                // flags for which of the programs use debug rendering
                bool[] vertexProgramDebug = new[]
                                                {
                                                    false, true, false, true, false, true, false, true
                                                };

                // types of lights that each of the programs target
                LightType[] vertexProgramLightTypes = new[]
                                                          {
                                                              LightType.Point, LightType.Point, LightType.Directional,
                ...
                for (int i = 0; i < programNames.Length; i++)
                {
                    ...
                    {
                        string source = ShadowVolumeExtrudeProgram.GetProgramSource(vertexProgramLightTypes[i], syntax,
                                                                                    vertexProgramFinite[i],
                                                                                    vertexProgramDebug[i]);

                        // create the program from the static source
                        GpuProgram program = GpuProgramManager.Instance.CreateProgramFromString(programNames[i],
                                                                                                ResourceGroupManager.
                                                                                                    InternalResourceGroupName,
                                                                                                source,
