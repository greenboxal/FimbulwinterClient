...
//     <id value="$Id: GpuProgramParameters.AutoConstants.Update.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
            ...
            foreach (AutoConstantEntry entry in this.autoConstants)
            {
                ...
                switch (entry.Type)
                {
                    ...
                    case AutoConstantType.InverseTransposeProjectionMatrix:
                        WriteRawConstant(entry.PhysicalIndex, source.InverseTransposeProjectionMatrix,
                                         entry.ElementCount);
                        break;
                    ...
                    case AutoConstantType.Time_0_2PI_Packed:
                        WriteRawConstant(entry.PhysicalIndex, source.GetTime_0_2Pi_Packed(entry.FData),
                                         entry.ElementCount);
                        break;
                    ...
                    case AutoConstantType.ViewportSize:
                        {
                            WriteRawConstant(entry.PhysicalIndex,
                                             new Vector4(source.ViewportWidth, source.ViewportHeight,
                    ...
                    case AutoConstantType.InverseTextureSize:
                        WriteRawConstant(entry.PhysicalIndex, source.GetInverseTextureSize(entry.Data),
                                         entry.ElementCount);
                        break;

                    case AutoConstantType.PackedTextureSize:
                        WriteRawConstant(entry.PhysicalIndex, source.GetPackedTextureSize(entry.Data),
                                         entry.ElementCount);
                        break;
                    ...
                    case AutoConstantType.TextureMatrix:
                        WriteRawConstant(entry.PhysicalIndex, source.GetTextureTransformMatrix(entry.Data),
                                         entry.ElementCount);
                        break;
                    ...
                    case AutoConstantType.TextureWorldViewProjMatrix:
                        ...
                        WriteRawConstant(entry.PhysicalIndex, source.GetTextureWorldViewProjMatrix(entry.Data),
                                         entry.ElementCount);
                        break;
                    ...
                    case AutoConstantType.SpotLightWorldViewProjMatrix:
                        WriteRawConstant(entry.PhysicalIndex, source.GetSpotlightWorldViewProjMatrix(entry.Data),
                                         entry.ElementCount);
                        break;
                    ...
                    case AutoConstantType.LightPositionObjectSpace:
                        {
                            ...
                            WriteRawConstant(entry.PhysicalIndex, new Vector4(vec3.x, vec3.y, vec3.z, vec4.w),
                                             entry.ElementCount);
                        }
                        break;
                    ...
                    case AutoConstantType.LightDirectionObjectSpace:
                        {
                            ...
                            WriteRawConstant(entry.PhysicalIndex, new Vector4(vec3.x, vec3.y, vec3.z, 0.0f),
                                             entry.ElementCount);
                        }
                        break;
                    ...
                    case AutoConstantType.LightDirectionObjectSpaceArray:
                        {
                            ...
                            for (int l = 0; l < entry.Data; ++l)
                            {
                                ...
                                vec3.Normalize();
                                WriteRawConstant(entry.PhysicalIndex + l*entry.ElementCount,
                                                 new Vector4(vec3.x, vec3.y, vec3.z, 0.0f),
                                                 entry.ElementCount);
                            }
                        }
                        break;
                    ...
                    case AutoConstantType.InverseTransposeWorldViewProjMatrix:
                        WriteRawConstant(entry.PhysicalIndex, source.InverseTransposeWorldViewProjMatrix,
                                         entry.ElementCount);
                        break;
                    ...
                    case AutoConstantType.LightPosition:
                        {
                            ...
                            WriteRawConstant(entry.PhysicalIndex, source.GetLightAs4DVector(entry.Data),
                                             entry.ElementCount);
                        }
                        break;
                    ...
                    case AutoConstantType.LightPositionViewSpace:
                        {
                            vec4 = source.GetLightAs4DVector(entry.Data);
                            WriteRawConstant(entry.PhysicalIndex, source.ViewMatrix.TransformAffine(vec4),
                                             entry.ElementCount);
                        }
                        break;
                    ...
                    case AutoConstantType.ShadowExtrusionDistance:
                        {
                            ...
                            WriteRawConstant(entry.PhysicalIndex,
                                             ...
                                             Utility.Sqrt(
                                                 Utility.Max(
                                                     Utility.Max(m3.GetColumn(0).LengthSquared,
                                                                 m3.GetColumn(1).LengthSquared),
                    ...
                    case AutoConstantType.LightDiffuseColorArray:
                        for (int l = 0; l < entry.Data; ++l)
                        {
                            WriteRawConstant(entry.PhysicalIndex + l*entry.ElementCount, source.GetLightDiffuse(l),
                                             entry.ElementCount);
                        }
                        break;
                    ...
                    case AutoConstantType.LightSpecularColorArray:
                        {
                            for (int l = 0; l < entry.Data; ++l)
                            {
                                WriteRawConstant(entry.PhysicalIndex + l*entry.ElementCount, source.GetLightSpecular(l),
                                                 entry.ElementCount);
                            }
                        }
                        break;
                    ...
                    case AutoConstantType.LightPositionViewSpaceArray:
                        for (int l = 0; l < entry.Data; ++l)
                        {
                            vec4 = source.GetLightAs4DVector(l);
                            WriteRawConstant(entry.PhysicalIndex + l*entry.ElementCount,
                                             source.ViewMatrix.TransformAffine(vec4),
                                             entry.ElementCount);
                        }
                        break;
                    ...
                    case AutoConstantType.LightAttenuationArray:
                        for (int l = 0; l < entry.Data; ++l)
                        {
                            WriteRawConstant(entry.PhysicalIndex + l*entry.ElementCount, source.GetLightAttenuation(l),
                                             entry.ElementCount);
                        }
                        break;
                    ...
                    case AutoConstantType.SpotLightParamsArray:
                        for (int l = 0; l < entry.Data; ++l)
                        {
                            WriteRawConstant(entry.PhysicalIndex + l*entry.ElementCount, source.GetSpotlightParams(l),
                                             entry.ElementCount);
                        }
                        break;
                    ...
                    case AutoConstantType.TextureViewProjMatrix:
                        // can also be updated in lights
                        WriteRawConstant(entry.PhysicalIndex, source.GetTextureViewProjectionMatrix(entry.Data),
                                         entry.ElementCount);
                        break;
                    ...
                    case AutoConstantType.TextureViewProjMatrixArray:
                        for (int l = 0; l < entry.Data; ++l)
                        {
                            // can also be updated in lights
                            WriteRawConstant(entry.PhysicalIndex + l*entry.ElementCount,
                                             source.GetTextureViewProjectionMatrix(l),
                                             entry.ElementCount);
                        }
                        break;
