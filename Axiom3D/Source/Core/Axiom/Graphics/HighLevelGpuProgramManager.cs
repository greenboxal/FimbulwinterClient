...
//     <id value="$Id: HighLevelGpuProgramManager.cs 3363 2012-07-29 00:49:26Z romeoxbm $"/>
// </file>
...
namespace Axiom.Graphics
{
    ...
    public class HighLevelGpuProgramManager : ResourceManager
    {
        ...
        /// </summary>
        protected AxiomCollection<HighLevelGpuProgramFactory> factories =
            new AxiomCollection<HighLevelGpuProgramFactory>();
        ...
        public HighLevelGpuProgram CreateProgram(string name, string group, string language, GpuProgramType type)
        {
            ...
            if (factory == null)
            {
                throw new AxiomException(
                    "Could not find HighLevelGpuProgramManager that can compile programs of type '{0}'",
                    language);
            }

            // create the high level program using the factory
            HighLevelGpuProgram program = factory.CreateInstance(this, name,
                                                                 (ResourceHandle) name.ToLower().GetHashCode(), group,
                                                                 false, null);
            program.Type = type;
        ...
        {
            get { return (HighLevelGpuProgram) base[name]; }
        }
        ...
        {
            get { return (HighLevelGpuProgram) base[handle]; }
        }
        ...
        protected override void dispose(bool disposeManagedResources)
        {
            if (!IsDisposed)
            {
                ...
                {
                    foreach (HighLevelGpuProgramFactory currentFactory in factories)
