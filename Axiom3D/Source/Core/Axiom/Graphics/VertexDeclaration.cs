...
//     <id value="$Id: VertexDeclaration.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Graphics
{
    ...
    public class VertexDeclaration : DisposableObject, ICloneable
    {
        ...
        ///   vertex declaration. <b>Please read the information in
        ///                         <see cref="VertexDeclaration" />
        ///                         about
        ...
        {
            VertexDeclaration newDecl = (VertexDeclaration) Clone();
        ...
        /// <remarks>
        ///   all elements in the cloned <see cref="VertexDeclaration" /> will have a source of 0.
        /// </remarks>
        public VertexDeclaration Clone(short source)
        {
            ...
            {
                VertexElement element = sourceElements[i];
