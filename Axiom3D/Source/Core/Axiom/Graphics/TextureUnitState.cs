...
//     <id value="$Id: TextureUnitState.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Graphics
{
    ...
    public class TextureUnitState
    {
        ...
        {
            get { return this.parent.IsLoaded; }
        }
        ...
        {
            get { return this.texAddressingMode; }
        }
        ...
        {
            get { return this.texBorderColor; }
            set { this.texBorderColor = value; }
        }
        ...
        {
            get { return this.colorBlendMode; }
        }
        ...
        {
            get { return this.alphaBlendMode; }
        }
        ...
        {
            get { return this.colorBlendFallbackSrc; }
        }
        ...
        {
            get { return this.colorBlendFallbackDest; }
        }
        ...
        {
            get { return this.colorOp; }
            set { SetColorOperation(value); }
        }
        ...
        {
            get { return this.textureNameAlias; }
            set { this.textureNameAlias = value; }
        }
        ...
        {
            [OgreVersion(1, 7, 2)]
            get { return GetTexture(this.currentFrame); }

            [OgreVersion(1, 7, 2)]
            set { SetTexture(value, this.currentFrame); }
        }
        ...
        public float TextureAnimU
        {
            ...
            set { SetScrollAnimation(value, this.scrollV); }
        }
        ...
        public float TextureAnimV
        {
            ...
            set { SetScrollAnimation(this.scrollU, value); }
        }
        ...
        {
            get { return this.effectList.Count; }
        }
        ...
        {
            get { return this.desiredFormat; }
            set { this.desiredFormat = value; }
        }
        ...
        {
            get { return this.textureSrcMipmaps; }
            set { this.textureSrcMipmaps = value; }
        }
        ...
        public bool IsAlpha
        {
            get { return this.isAlpha; }
            set { this.isAlpha = value; }
        }
        ...
        {
            get { return this.isDefaultAniso ? MaterialManager.Instance.DefaultAnisotropy : this.maxAnisotropy; }
            set
            {
        ...
        public bool Is3D
        {
            get { return this.textureType == TextureType.CubeMap; }
        }
        ...
        ///    as this TextureUnitState does.</p>
        ///  <p>This effect cannot be combined with other texture generation effects, 
        ...
        public void SetColorOperation(LayerBlendOperation operation)
        {
            ...
            switch (operation)
            {
                case LayerBlendOperation.Replace:
                    SetColorOperationEx(LayerBlendOperationEx.Source1, LayerBlendSource.Texture,
                ...
                case LayerBlendOperation.Modulate:
                    SetColorOperationEx(LayerBlendOperationEx.Modulate, LayerBlendSource.Texture,
                                        LayerBlendSource.Current);
                    SetColorOpMultipassFallback(SceneBlendFactor.DestColor, SceneBlendFactor.Zero);
                    break;

                case LayerBlendOperation.AlphaBlend:
                    SetColorOperationEx(LayerBlendOperationEx.BlendTextureAlpha, LayerBlendSource.Texture,
                                        LayerBlendSource.Current);
        ...
        public void SetColorOperationEx(LayerBlendOperationEx operation, LayerBlendSource source1,
        ...
        {
            SetColorOperationEx(operation, LayerBlendSource.Texture, LayerBlendSource.Current, ColorEx.White,
                                ColorEx.White,
                                0.0f);
        }
        ...
        /// <param name="blendFactor"> Manually supplied 'blend' value - only required for operations which require manual blend e.g. LayerBlendOperationEx.BlendManual. </param>
        public void SetAlphaOperation(LayerBlendOperationEx operation, LayerBlendSource source1,
                                      LayerBlendSource source2,
        ...
        public void SetTransformAnimation(TextureTransform transType, WaveformType waveType, float baseVal,
                                          float frequency,
        ...
        private void CreateEffectController(TextureEffect effect)
        {
            ...
            switch (effect.type)
            {
                ...
                case TextureEffectType.Transform:
                    effect.controller = cMgr.CreateTextureWaveTransformer(this, (TextureTransform) effect.subtype,
                                                                          effect.waveType,
            ...
            for (int i = 0; i < this.numFrames; i++)
            {
                if (this.frames[i].Length > 0)
                {
                    try
                    {
                        ...
                        TextureManager.Instance.Load(this.frames[i], ResourceGroupManager.DefaultResourceGroupName,
                                                     this.textureType,
                                                     this.textureSrcMipmaps, 1.0f, this.isAlpha, this.desiredFormat
                            /*, hwGamma */);
                    ...
                    {
                        LogManager.Instance.Write("Error loading texture {0}.  Layer will be left blank.",
                                                  this.frames[i]);
            ...
            if (!string.IsNullOrEmpty(this.textureNameAlias))
            {
                if (aliasList.ContainsKey(this.textureNameAlias))
                {
                    ...
                    if (apply)
                    {
                        ...
                        if (this.isCubic)
                        {
                            SetCubicTextureName(aliasList[this.textureNameAlias],
                        ...
                        else
                        {
                            ...
                            if (this.numFrames > 1)
                            {
                                SetAnimatedTextureName(aliasList[this.textureNameAlias], this.numFrames,
                                                       this.animDuration);
                            }
                            else
                            {
                                SetTextureName(aliasList[this.textureNameAlias], this.textureType,
                                               this.textureSrcMipmaps);
                            }
                        }
                    }
                }
    ...
    public class LayerBlendModeEx
    {
        ...
        public static bool operator ==(LayerBlendModeEx left, LayerBlendModeEx right)
        {
            ...
            if (left.colorArg1 != right.colorArg1 || left.colorArg2 != right.colorArg2 ||
        ...
        public static bool operator !=(LayerBlendModeEx left, LayerBlendModeEx right)
        {
            ...
            {
                if (left.alphaArg1 != right.alphaArg1 || left.alphaArg2 != right.alphaArg2 ||
                    left.blendFactor != right.blendFactor ||
                    left.source1 != right.source1 || left.source2 != right.source2 || left.operation != right.operation)
                {
                    return true;
        ...
        public override string ToString()
        {
            return
                (new System.Text.StringBuilder()).AppendFormat(
                    ...
                    this.blendType, this.operation, this.source1, this.source2, this.colorArg1, this.colorArg2,
                    this.alphaArg1,
