...
//     <id value="$Id: EdgeData.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
    ...
    public class EdgeData
    {
...
#endif
            {
                Debug.Assert(positionBuffer.VertexSize == sizeof (float)*3,
        ...
        public void DebugLog(Log log)
        {
            ...
            for (int i = 0; i < this.triangles.Count; i++)
            {
                ...
                log.Write("Triangle {0} = [indexSet={1}, vertexSet={2}, v0={3}, v1={4}, v2={5}]", i, t.indexSet,
                          t.vertexSet,
            ...
            public override string ToString()
            {
                return
                    string.Format(
                        ...
                        this.sharedVertIndex[2], this.normal.x, this.normal.y, this.normal.z, this.normal.w,
                        this.lightFacing);
            }
