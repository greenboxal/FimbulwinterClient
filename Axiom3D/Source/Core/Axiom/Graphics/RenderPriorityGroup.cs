    ...
    public class RenderPriorityGroup
    {
        ...
        public void AddRenderable(IRenderable renderable, Technique technique)
        {
            ...
            if (technique.IsTransparent &&
                (!technique.DepthWrite || !technique.DepthCheck || technique.ColorWriteEnabled))
            {
        ...
        {
            get { return this.solidPasses.Count; }
        }
        ...
        {
            get { return this.transparentPasses.Count; }
        }
        ...
        public bool SplitPassesByLightingType
        {
            ...
            set { this.splitPassesByLightingType = value; }
        }
        ...
        public bool SplitNoShadowPasses
        {
            ...
            set { this.splitNoShadowPasses = value; }
        }
        ...
        public bool ShadowCastersCannotBeReceivers
        {
            ...
            set { this.shadowCastersCannotBeReceivers = value; }
        }
