...
//     <id value="$Id: CompositionTechnique.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Graphics
{
    ...
    public class CompositionTechnique : DisposableObject
    {
        ...
        {
            get { return this.textureDefinitions; }
        }
        ...
        {
            get { return this.compositorLogicName; }
            set { this.compositorLogicName = value; }
        }
        ...
        {
            Debug.Assert(index < this.textureDefinitions.Count,
                         "Index out of bounds, CompositionTechnqiuq.GetTextureDefinition");
            ...
            foreach (TextureDefinition td in this.textureDefinitions)
            {
                ...
                foreach (PixelFormat pf in td.PixelFormats)
                {
                    ...
                    if (allowTextureDegradation)
                    {
                        ...
                        if (texMgr.GetNativeFormat(TextureType.TwoD, pf, TextureUsage.RenderTarget) ==
                            PixelFormat.Unknown)
                        {
                            return false;
                        }
