...
//     <id value="$Id: HardwarePixelBuffer.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Graphics
{
    ...
    public abstract class HardwarePixelBuffer : HardwareBuffer
    {
        ...
        protected override BufferBase LockImpl(int offset, int length, BufferLocking options)
        {
            ...
            Debug.Assert(offset == 0 && length == sizeInBytes,
                         "Cannot lock memory region, must lock box or entire buffer");
