...
//     <id value="$Id: TempBlendedBufferInfo.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Graphics
{
    ...
    public class TempBlendedBufferInfo : IHardwareBufferLicensee
    {
        ...
        public void CheckoutTempCopies(bool positions, bool normals, bool tangents, bool binormals)
        {
            ...
            {
                this.destPositionBuffer = HardwareBufferManager.Instance.AllocateVertexBufferCopy(
                    this.srcPositionBuffer,
                    BufferLicenseRelease.Automatic,
                    this);
            }

            if (this.bindNormals && !this.posNormalShareBuffer && this.srcNormalBuffer != null &&
            ...
            if (this.bindTangents && this.srcTangentBuffer != null)
            {
                ...
                {
                    this.destTangentBuffer =
                        HardwareBufferManager.Instance.AllocateVertexBufferCopy(this.srcTangentBuffer,
                                                                                BufferLicenseRelease.Automatic,
                                                                                this);
                }
            }
            ...
            if (this.bindNormals && this.srcBinormalBuffer != null)
            {
                ...
                {
                    this.destBinormalBuffer =
                        HardwareBufferManager.Instance.AllocateVertexBufferCopy(this.srcBinormalBuffer,
                                                                                BufferLicenseRelease.Automatic,
                                                                                this);
                }
            }
