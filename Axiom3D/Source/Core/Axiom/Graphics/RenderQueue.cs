...
//     <id value="$Id: RenderQueue.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Graphics
{
    ...
    public class RenderQueue
    {
        ...
        {
            get { return this.defaultRenderablePriority; }
            set { this.defaultRenderablePriority = value; }
        }
        ...
        {
            get { return this.renderGroups.Count; }
        }
        ...
        {
            get { return this.splitPassesByLightingType; }
            set
            {
                this.splitPassesByLightingType = value;

                // set the value for all render groups as well
                for (int i = 0; i < this.renderGroups.Count; i++)
                {
        ...
        {
            get { return this.splitNoShadowPasses; }
            set
            {
        ...
        {
            get { return this.shadowCastersCannotBeReceivers; }
            set
            {
        ...
        public void Clear(bool dispose)
        {
            ...
            for (int i = 0; i < this.renderGroups.Count; i++)
            {
                RenderQueueGroup group = (RenderQueueGroup) this.renderGroups.GetByIndex(i);
        ...
        {
            RenderQueueGroup group = this.renderGroups[queueID] as RenderQueueGroup;
