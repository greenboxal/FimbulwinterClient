...
//     <id value="$Id: VertexIndexData.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Graphics
{
    ...
    public class HardwareAnimationData
    {
        ...
        {
            get { return this.targetVertexElement; }
            set { this.targetVertexElement = value; }
        }

        public float Parametric
        {
            get { return this.parametric; }
            set { this.parametric = value; }
        }
    }
        ...
        public VertexData Clone(bool copyData)
        {
            ...
            foreach (short source in bindings.Keys)
            {
                ...
                if (copyData)
                {
                    ...
                    dstBuf = HardwareBufferManager.Instance.CreateVertexBuffer(srcbuf.VertexDeclaration,
                                                                               srcbuf.VertexCount,
            ...
            for (int i = 0; i < this.vertexDeclaration.ElementCount; i++)
            {
                ...
                dest.vertexDeclaration.AddElement(element.Source, element.Offset, element.Type, element.Semantic,
                                                  element.Index);
            }
            ...
            if (this.hardwareShadowVolWBuffer != null)
            {
                ...
                // copy data
                dest.hardwareShadowVolWBuffer.CopyTo(this.hardwareShadowVolWBuffer, 0, 0,
                                                     this.hardwareShadowVolWBuffer.Size, true);
            }
        ...
        public void PrepareForShadowVolume()
        {
			...
			*/
            ...
            if (posElem != null)
            {
                ...
                VertexDeclaration newRemainderDeclaration = (VertexDeclaration) this.vertexDeclaration.Clone();
                ...
                if (wasSharedBuffer)
                {
                    ...
                    newRemainderBuffer = HardwareBufferManager.Instance.CreateVertexBuffer(newRemainderDeclaration,
                                                                                           vbuf.VertexCount,
                                                                                           vbuf.Usage,
                ...
                if (wasSharedBuffer)
                {
...
#endif
                    {
                        ...
                        for (int v = 0; v < oldVertexCount; v++)
                        {
                            ...
                            {
                                Memory.Copy(baseSrcPtr, baseDestRemPtr, baseSrcOffset, baseDestRemOffset,
                                            prePosVertexSize);
                            }
                ...
                if (useVertexPrograms)
                {
...
#endif
                    {
                        ...
                        this.hardwareShadowVolWBuffer = HardwareBufferManager.Instance.CreateVertexBuffer(decl,
                                                                                                          newVertexCount,
                                                                                                          BufferUsage.
                                                                                                              StaticWriteOnly,
                                                                                                          false);
                ...
                for (int i = 0; i < this.vertexDeclaration.ElementCount; i++)
                {
                    ...
                    if (element.Semantic == VertexElementSemantic.Position)
                    {
                        ...
                        this.vertexDeclaration.ModifyElement(i, newPosBufferSource /* new source buffer */, 0
                                                             /* no offset now */,
                    ...
                    else if (wasSharedBuffer && element.Source == posOldSource && element.Offset > prePosVertexSize)
                    {
                        ...
                        this.vertexDeclaration.ModifyElement(i, posOldSource /* same old source */,
                                                             element.Offset - posElem.Size
                                                             /* less offset now */, element.Type, element.Semantic,
                                                             element.Index);
                    }
                }
            } // if posElem != null
