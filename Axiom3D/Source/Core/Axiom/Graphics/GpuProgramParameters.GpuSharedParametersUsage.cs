...
namespace Axiom.Graphics
{
    public partial class GpuProgramParameters
    {
        ...
        public class GpuSharedParametersUsage
        {
            ...
            public string Name
            {
                get { return SharedParameters.Name; }
            }
            ...
            public void CopySharedParamsToTargetParams()
            {
                ...
                foreach (CopyDataEntry e in this.CopyDataList)
                {
                    if (e.DstDefinition.IsFloat)
                    {
                        ...
                        if (this._parameters.TransposeMatrices &&
                        ...
                        else
                        {
                            ...
                            {
                                // simple copy
                                Array.Copy(src.Data, pSrc, dst.Data, pDst,
                                           e.DstDefinition.ElementSize*e.DstDefinition.ArraySize);
                            }
                            else
                            {
