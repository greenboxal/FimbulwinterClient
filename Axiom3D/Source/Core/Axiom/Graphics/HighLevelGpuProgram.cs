...
//     <id value="$Id: HighLevelGpuProgram.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Graphics
{
    ...
    public abstract class HighLevelGpuProgram : GpuProgram
    {
        ...
        {
            get { return this.assemblerProgram; }
        }
        ...
        ///   Default constructor.
        /// </summary>
        protected HighLevelGpuProgram(ResourceManager parent, string name, ResourceHandle handle, string group,
                                      bool isManual,
        ...
        protected virtual void LoadHighLevelImpl()
        {
            if (LoadFromFile)
            {
                ...
                {
                    using (StreamReader t = new StreamReader(stream))
                    {
                        source = t.ReadToEnd();
                    }
                }
        ...
        {
            get { return ConstantDefinitions; }
        }
