...
//     <id value="$Id: RibbonTrail.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Graphics
{
    public class RibbonTrail : BillboardChain
    {
        ...
        public virtual void AddNode(Node node)
        {
            ...
            Element e = new Element(node.DerivedPosition, this.initialWidth[segmentIndex], 0.0f,
            ...
            node.NodeUpdated += NodeUpdated;
            node.NodeDestroyed += NodeDestroyed;
        }
        ...
        protected virtual void UpdateTrail(int index, Node node)
        {
            ...
            while (!done)
            {
                ...
                if (ParentNode != null)
                {
                    ...
                    newPos = ParentNode.DerivedOrientation.UnitInverse*(newPos - ParentNode.DerivedPosition)/
