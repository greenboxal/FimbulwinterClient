...
#endif
        {
            using (BufferBase dataPtr = BufferBase.Wrap(data, length))
    ...
    /// <see cref="HardwareBuffer.CopyTo(HardwareBuffer, int, int, int, bool)"/>
        ...
        protected virtual void UpdateFromShadow()
        {
            if (this.useShadowBuffer && this.shadowUpdated && !this.suppressHardwareUpdate)
            {
                ...
                BufferLocking locking = (this.lockStart == 0 && this.lockSize == this.sizeInBytes)
        ...
        {
            get { return this.isLocked || (this.useShadowBuffer && this.shadowBuffer.IsLocked); }
        }
        ...
        {
            get { return this.useSystemMemory; }
        }
        ...
        {
            get { return this.useShadowBuffer; }
        }
