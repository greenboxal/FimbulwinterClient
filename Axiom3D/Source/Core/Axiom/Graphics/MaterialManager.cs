...
//     <id value="$Id: MaterialManager.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Graphics
{
    ...
    ///   <p />
    ///   For a definition of the material script format, see <a
    ...
    public class MaterialManager : ResourceManager, ISingleton<MaterialManager>
    {
        ...
        public class SchemeNotFoundEventArgs : EventArgs
        {
            ...
            public SchemeNotFoundEventArgs(ushort schemeIndex, string schemeName, Material originalMaterial,
                                           int lodIndex,
        ...
        public void Initialize()
        {
            ...
            Material.defaultSettings =
                (Material) Create("DefaultSettings", ResourceGroupManager.DefaultResourceGroupName);
        ...
        public virtual void SetDefaultTextureFiltering(TextureFiltering filtering)
        {
            ...
            switch (filtering)
            {
                ...
                case TextureFiltering.Anisotropic:
                    SetDefaultTextureFiltering(FilterOptions.Anisotropic, FilterOptions.Anisotropic,
        ...
        public String GetSchemeName(ushort index)
        {
            ...
            {
                foreach (KeyValuePair<string, ushort> item in this._schemes)
                {
                    if (item.Value == index)
                    {
                        return item.Key;
        ...
        {
            get { return this._activeSchemeName; }
            set
            {
        ...
        private readonly MultiMap<string, SchemeNotFoundHandler> _listenerMap =
            new MultiMap<string, SchemeNotFoundHandler>();
        ...
        {
            SchemeNotFoundEventArgs args = new SchemeNotFoundEventArgs(this._activeSchemeIndex, this._activeSchemeName,
                                                                       mat, lodIndex, rend);
