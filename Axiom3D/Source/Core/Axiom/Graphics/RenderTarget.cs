...
//     <id value="$Id: RenderTarget.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Graphics
{
    ...
    public abstract class RenderTarget : DisposableObject
    {
        ...
        [AxiomHelper(0, 8, "Cached timer used for statistic queries")] private readonly ITimer _timer =
            Root.Instance.Timer;
        ...
        {
            get { return this.depthBufferPoolId; }
            set
            {
        ...
        {
            get { return this.active && !IsDisposed; }
        ...
        {
            get { return this._isDepthBuffered; }
            set { this._isDepthBuffered = value; }
        }
        ...
        {
            get { return this.ViewportList.Count; }
        }
        ...
        [OgreVersion(1, 7, 2790)]
#if NET_40
        public virtual Viewport AddViewport(Camera camera, float left = 0, float top = 0, float nwidth = 1.0f,
                                            float nheight = 1.0f, int zOrder = 0)
#else
...
#endif
        {
            ...
            Viewport viewport = new Viewport(camera, this, left, top, nwidth, nheight, zOrder);
        ...
        /// </summary>
        /// <param name="zOrder"> The <see cref="Viewport.ZOrder" /> of the viewport to be removed. </param>
        [OgreVersion(1, 7, 2790)]
        ...
        /// <param name="avgFPS"> The FPS rating based on an average of all the frames rendered since rendering began (the call to Root.StartRendering). </param>
        ...
        {
            get { return this.stats.AverageFPS; }
        }
        ...
        {
            get { return this.stats.WorstFPS; }
        }
        ...
        {
            get { return this.stats.BestFrameTime; }
        }
        ...
        {
            get { return this.stats.WorstFrameTime; }
        }
        ...
        {
            get { return this.stats.TriangleCount; }
        }
        ...
        {
            get { return this.stats.BatchCount; }
        }
        ...
        protected void UpdateStatistics()
        {
            ...
            {
                this.stats.AverageFPS = (this.stats.AverageFPS + this.stats.LastFPS)/2;
        ...
        {
            get { throw new Exception(String.Format("Attribute [{0}] not found.", attribute)); }
        }
    ...
    /// <see cref="Axiom.Graphics.RenderTarget.Update(bool)"/>
        ...
        ///     renderTarget.SwapBuffers(true);</pre>
...
#endif
        {
            ...
            foreach (KeyValuePair<int, Viewport> it in this.ViewportList)
            {
    ...
    /// <see cref="Axiom.Graphics.RenderTarget.UpdateAutoUpdatedViewports(bool)"/>
        ...
        public void WriteContentsToFile(string fileName)
        {
            ...
            PixelBox pb = new PixelBox(Width, Height, 1, pf, buf);
        ...
        {
            string filename = string.Format("{2}{0:MMddyyyyHHmmss}{1:D3}{3}", DateTime.Now,
                                            this._timer.Milliseconds%1000,
        ...
        protected override void dispose(bool disposeManagedResources)
        {
            if (!IsDisposed)
            {
                ...
                {
                    // Delete viewports
                    foreach (KeyValuePair<int, Viewport> i in this.ViewportList)
                    {
                    ...
                    {
                        LogManager.Instance.Write("Final Stats [{0}]: FPS <A,B,W> : {1:#.00} {2:#.00} {3:#.00}",
                                                  this.name,
