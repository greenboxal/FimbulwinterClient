...
//     <id value="$Id: Material.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Graphics
{
    ...
    public class Material : Resource, IComparable, ICopyable<Material>
    {
        ...
        {
            get { return this._techniques; }
            set { this._techniques = value; }
        }
        ...
        {
            get { return this._supportedTechniques; }
        }
        ...
        {
            get { return this._compilationRequired; }
            set { this._compilationRequired = value; }
        }
        ...
        public ColorEx SelfIllumination
        {
            set
            {
                for (int i = 0; i < techniques.Count; i++)
                {
                    (techniques[i]).SelfIllumination = value;
                }
            }
        }
        ...
        public CompareFunction DepthFunction
        {
            set
            {
                for (int i = 0; i < techniques.Count; i++)
                {
                    (techniques[i]).DepthFunction = value;
                }
            }
        }
        ...
        public bool ColorWriteEnabled
        {
            set
            {
                for (int i = 0; i < techniques.Count; i++)
                {
                    (techniques[i]).ColorWriteEnabled = value;
                }
            }
        }
        ...
        public CullingMode CullingMode
        {
            set
            {
                for (int i = 0; i < techniques.Count; i++)
                {
                    (techniques[i]).CullingMode = value;
                }
            }
        }
        ...
        public ManualCullingMode ManualCullingMode
        {
            set
            {
                for (int i = 0; i < techniques.Count; i++)
                {
                    (techniques[i]).ManualCullingMode = value;
                }
            }
        }
        ...
        public bool Lighting
        {
            set
            {
                for (int i = 0; i < techniques.Count; i++)
                {
                    (techniques[i]).LightingEnabled = value;
                }
            }
        }
        ...
        public TextureFiltering TextureFiltering
        {
            set
            {
                for (int i = 0; i < techniques.Count; i++)
                {
                    (techniques[i]).TextureFiltering = value;
                }
            }
        }
        ...
        public int TextureAnisotropy
        {
            set
            {
                for (int i = 0; i < techniques.Count; i++)
                {
                    (techniques[i]).TextureAnisotropy = value;
                }
            }
        }
        ...
        public Shading ShadingMode
        {
            set
            {
                ...
                for (int i = 0; i < techniques.Count; i++)
                {
                    (techniques[i]).ShadingMode = value;
                }
            }
        }
                           ...
                           Single linearEnd)
        {
            ...
            for (int i = 0; i < techniques.Count; i++)
            {
                (techniques[i]).SetFog(overrideScene, mode, color, expDensity, linearStart, linearEnd);
            }
        }
        ...
        public Technique GetBestTechnique(int lodIndex, IRenderable renderable)
        {
            ...
            if (SupportedTechniques.Count > 0)
            {
                ...
                {
                    technique = MaterialManager.Instance.ArbitrateMissingTechniqueForActiveScheme(this, lodIndex,
                                                                                                  renderable);
                    if (technique != null)
                    {
                        return technique;
                    ...
                    Dictionary<ushort, Dictionary<int, Technique>>.Enumerator iter =
                        this.bestTechniquesByScheme.GetEnumerator();
        ...
        {
            get { return this.bestTechniquesByScheme.Count; }
        }
        ...
        ///</remarks>
        ///<param name="lodDistanceList"> A list of floats which indicate the distance at which to switch to lower details. They are listed in LOD index order, starting at index 1 (ie the first level down from the highest level 0, which automatically applies from a distance of 0). </param>
