...
//     <id value="$Id: AutoParamDataSource.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
    ...
    public class AutoParamDataSource : DisposableObject
    {
            ...
            if (index < Config.MaxSimultaneousLights)
            {
                if (this.textureViewProjMatrixDirty[index] && this.currentTextureProjector[index] != null)
                {
                    if (this.cameraRelativeRendering)
                    {
                        ...
                        Matrix4 view;
                        this.currentTextureProjector[index].CalcViewMatrixRelative(this.currentCamera.DerivedPosition,
                                                                                   out view);
                        this.textureViewProjMatrix[index] = this.ProjectionClipSpace2DToImageSpacePerspective*
                                                            this.currentTextureProjector[index].ProjectionMatrixRSDepth*
                                                            view;
                    }
                    else
                    {
                        this.textureViewProjMatrix[index] = this.ProjectionClipSpace2DToImageSpacePerspective*
                                                            this.currentTextureProjector[index].ProjectionMatrixRSDepth*
                                                            this.currentTextureProjector[index].ViewMatrix;
                    }
        ...
        public virtual Matrix4 GetSpotlightWorldViewProjMatrix(int index)
        {
            if (index < Config.MaxSimultaneousLights)
            {
                ...
                if (l != this.blankLight && l.Type == LightType.Spotlight &&
                    this.spotlightWorldViewProjMatrixDirty[index])
                {
        ...
        {
            [OgreVersion(1, 7, 2)]
            get { return this.currentRenderable; }
        ...
        public virtual RenderTarget CurrentRenderTarget
        {
            ...
            [OgreVersion(1, 7, 2)]
            set { this.currentRenderTarget = value; }
        }
        ...
        {
            [OgreVersion(1, 7, 2)]
            get { return this.currentLightList.Count; }
        }
        ...
        {
            [OgreVersion(1, 7, 2)]
            get { return this.currentPass; }

            [OgreVersion(1, 7, 2)]
            set { this.currentPass = value; }
        }

        public virtual ColorEx SurfaceAmbient
        {
            [OgreVersion(1, 7, 2)]
            get { return this.currentPass.Ambient; }
        }

        public virtual ColorEx SurfaceDiffuse
        {
            [OgreVersion(1, 7, 2)]
            get { return this.currentPass.Diffuse; }
        }

        public virtual ColorEx SurfaceSpecular
        {
            [OgreVersion(1, 7, 2)]
            get { return this.currentPass.Specular; }
        }

        public virtual ColorEx SurfaceEmissive
        {
            [OgreVersion(1, 7, 2)]
            get { return this.currentPass.Emissive; }
        }

        public virtual Real SurfaceShininess
        {
            [OgreVersion(1, 7, 2)]
            get { return this.currentPass.Shininess; }
        }

        public virtual ColorEx DerivedAmbient
        {
            [OgreVersion(1, 7, 2)]
            get { return AmbientLight*SurfaceAmbient; }
        }
            ...
            get
            {
                if (this.worldMatrixDirty)
                {
                    ...
                    if (this.cameraRelativeRendering)
                    {
                        ...
                        {
                            this.worldMatrix[i].Translation = this.worldMatrix[i].Translation -
            ...
            get
            {
                if (this.projMatrixDirty)
                {
                    ...
                    if (this.currentRenderable != null && this.currentRenderable.UseIdentityProjection)
                    {
                        ...
                        Root.Instance.RenderSystem.ConvertProjectionMatrix(Matrix4.Identity, out this.projectionMatrix,
                                                                           true);
                    }
                    else
                    {
        ...
        {
            [OgreVersion(1, 7, 2)]
            get { return ViewProjectionMatrix.Inverse(); }
        }

        public virtual Matrix4 InverseTransposeViewProjMatrix
        {
            [OgreVersion(1, 7, 2)]
            get { return InverseViewProjMatrix.Transpose(); }
        }

        public virtual Matrix4 TransposeViewProjMatrix
        {
            [OgreVersion(1, 7, 2)]
            get { return ViewProjectionMatrix.Transpose(); }
        }

        public virtual Matrix4 TransposeViewMatrix
        {
            [OgreVersion(1, 7, 2)]
            get { return ViewMatrix.Transpose(); }
        }

        public virtual Matrix4 InverseTransposeViewMatrix
        {
            [OgreVersion(1, 7, 2)]
            get { return InverseViewMatrix.Transpose(); }
        }

        public virtual Matrix4 TransposeProjectionMatrix
        {
            [OgreVersion(1, 7, 2)]
            get { return ProjectionMatrix.Transpose(); }
        }

        public virtual Matrix4 InverseProjectionMatrix
        {
            [OgreVersion(1, 7, 2)]
            get { return ProjectionMatrix.Inverse(); }
        }

        public virtual Matrix4 InverseTransposeProjectionMatrix
        {
            [OgreVersion(1, 7, 2)]
            get { return InverseProjectionMatrix.Transpose(); }
        }

        public virtual Matrix4 TransposeWorldViewProjMatrix
        {
            [OgreVersion(1, 7, 2)]
            get { return WorldViewProjMatrix.Transpose(); }
        }

        public virtual Matrix4 InverseWorldViewProjMatrix
        {
            [OgreVersion(1, 7, 2)]
            get { return WorldViewProjMatrix.Inverse(); }
        }

        public virtual Matrix4 InverseTransposeWorldViewProjMatrix
        {
            [OgreVersion(1, 7, 2)]
            get { return InverseWorldViewProjMatrix.Transpose(); }
        }

        public virtual Matrix4 TransposeWorldViewMatrix
        {
            [OgreVersion(1, 7, 2)]
            get { return WorldViewMatrix.Transpose(); }
        }

        public virtual Matrix4 TransposeWorldMatrix
        {
            [OgreVersion(1, 7, 2)]
            get { return WorldMatrix.Transpose(); }
        }

        public virtual Real Time
        {
            [OgreVersion(1, 7, 2)]
            get { return ControllerManager.Instance.GetElapsedTime(); }
        }

        public virtual Real FrameTime
        {
            [OgreVersion(1, 7, 2)]
            get { return ControllerManager.Instance.FrameTimeSource.Value; }
        }

        public virtual Real FPS
        {
            [OgreVersion(1, 7, 2)]
            get { return this.currentRenderTarget.LastFPS; }
        }

        public virtual Real ViewportWidth
        {
            [OgreVersion(1, 7, 2)]
            get { return this.currentViewport.ActualWidth; }
        }

        public virtual Real ViewportHeight
        {
            [OgreVersion(1, 7, 2)]
            get { return this.currentViewport.ActualHeight; }
        }

        public virtual Real InverseViewportWidth
        {
            [OgreVersion(1, 7, 2)]
            get { return 1.0f/this.currentViewport.ActualWidth; }
        }

        public virtual Real InverseViewportHeight
        {
            [OgreVersion(1, 7, 2)]
            get { return 1.0f/this.currentViewport.ActualHeight; }
        }

        public virtual Real FOV
        {
            [OgreVersion(1, 7, 2)]
            get { return this.currentCamera.FieldOfView; }
        }
        ...
        public virtual Vector4 CameraPositionObjectSpace
        {
            ...
            get
            {
                if (this.cameraPositionObjectSpaceDirty)
                {
                    ...
                    {
                        this.cameraPositionObjectSpace =
                            InverseWorldMatrix.TransformAffine(this.currentCamera.DerivedPosition);
                    }
        ...
        {
            [OgreVersion(1, 7, 2)]
            get { return this.currentCamera.DerivedDirection; }
        }
        ...
        {
            [OgreVersion(1, 7, 2)]
            get { return this.currentCamera.DerivedRight; }
        }
        ...
        {
            [OgreVersion(1, 7, 2)]
            get { return this.currentCamera.DerivedUp; }
        }

        public virtual Real NearClipDistance
        {
            [OgreVersion(1, 7, 2)]
            get { return this.currentCamera.Near; }
        }

        public virtual Real FarClipDistance
        {
            [OgreVersion(1, 7, 2)]
            get { return this.currentCamera.Far; }
        }
        ...
        {
            [OgreVersion(1, 7, 2)]
            get { return this.passNumber; }

            [OgreVersion(1, 7, 2)]
            set { this.passNumber = value; }
        }
        ...
        {
            [OgreVersion(1, 7, 2)]
            get { return CurrentSceneManager.ShadowColor; }
        }
        ...
        public virtual Real ShadowExtrusionDistance
        {
            ...
            [OgreVersion(1, 7, 2)]
            set { this.dirLightExtrusionDistance = value; }
        }
