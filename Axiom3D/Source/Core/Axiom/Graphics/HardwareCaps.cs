...
//     <id value="$Id: HardwareCaps.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Graphics
{
    ...
    public class RenderSystemCapabilities
    {
        ...
        {
            get { return this._stencilBufferBitCount; }
            set { this._stencilBufferBitCount = value; }
        }
        ...
        public void Log(Log logMgr)
        {
            ...
            logMgr.Write("\t-Hardware generation of mip-maps: {0}",
                         ConvertBool(HasCapability(Capabilities.HardwareMipMaps)));
            ...
            if (HasCapability(Capabilities.StencilBuffer))
            {
                ...
                logMgr.Write("\t\t-Two sided stencil support: {0}",
                             ConvertBool(HasCapability(Capabilities.TwoSidedStencil)));
            ...
            logMgr.Write("\t-Infinite far plane projection: {0}",
                         ConvertBool(HasCapability(Capabilities.InfiniteFarPlane)));
