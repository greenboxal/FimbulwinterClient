...
//     <id value="$Id: GpuProgram.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Graphics
{
    ...
    public abstract class GpuProgram : Resource
    {
        ...
        {
            get { return this.syntaxCode; }
            set { this.syntaxCode = value; }
        }
        ...
        {
            get { return this.isSkeletalAnimationIncluded; }
            set { this.isSkeletalAnimationIncluded = value; }
        }
        ...
        {
            get { return this.morphAnimation; }
            set { this.morphAnimation = value; }
        }
        ...
        {
            get { return this.vertexTextureFetchRequired; }
            set { this.vertexTextureFetchRequired = value; }
        }
        ...
        {
            get { return this.needsAdjacencyInfo; }
            set { this.needsAdjacencyInfo = value; }
        }
        ...
        {
            get { return this.poseAnimation; }
            set { this.poseAnimation = value; }
        }
        ...
        {
            get { return this.poseAnimation > 0; }
        }
        ...
        {
            get { return this.defaultParams ?? (this.defaultParams = CreateParameters()); }
        }
        ...
        {
            get { return this.defaultParams != null; }
        }
        ...
        /// </summary>
        /// <note>Only available if this parameters object has named parameters, which means either
        ...
        public virtual GpuProgramParameters.GpuNamedConstants ManualNamedConstants
        {
            set
            {
                ...
                foreach (KeyValuePair<string, GpuProgramParameters.GpuConstantDefinition> pair in this.constantDefs.Map)
                {
                    ...
                    GpuProgramParameters.GpuLogicalIndexUse val =
                        new GpuProgramParameters.GpuLogicalIndexUse(def.PhysicalIndex, def.ArraySize*def.ElementSize,
                                                                    def.Variability);
                    if (def.IsFloat)
                    {
        ...
        {
            get { return this.manualNamedConstantsFile; }
            set
            {
        ...
        public virtual GpuProgramParameters CreateParameters()
        {
            ...
            if (!String.IsNullOrEmpty(this.manualNamedConstantsFile) && !this._loadedManualNamedConstants)
            {
                try
                {
                    ...
                    Stream stream = ResourceGroupManager.Instance.OpenResource(this.manualNamedConstantsFile, Group,
                                                                               true, this);
        ...
        protected override void load()
        {
            ...
            catch (Exception ex)
            {
                LogManager.Instance.Write(
                    "Gpu program {0} encountered an error during loading and is thus not supported. Details: {1}", Name,
                    ex.Message);
