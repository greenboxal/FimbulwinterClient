...
//     <id value="$Id: VertexBufferBinding.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Graphics
{
    ...
    public class VertexBufferBinding : DisposableObject
    {
        ...
        {
            get { return this.bindingMap.Count; }
        }
        ...
        {
            get { return this.bindingMap.Any(i => i.Value.IsInstanceData); }
        }
