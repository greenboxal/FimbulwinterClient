...
//     <id value="$Id: CompositorManager.cs 3362 2012-07-29 00:40:37Z romeoxbm $"/>
// </file>
...
namespace Axiom.Graphics
{
    ...
    public class CompositorManager : ResourceManager, ISingleton<CompositorManager>
    {
        ...
        {
            get { return Singleton<CompositorManager>.Instance; }
        }
        ...
        /// </summary>
        private readonly Dictionary<string, ICompositorLogic> compositorLogics =
            new Dictionary<string, ICompositorLogic>();
        ...
        {
            get { return this.compositorLogicIndex; }
        }
        ...
        {
            get { return this.customCompositionPassesIndex; }
        }
                                        ...
                                        CompositorInstance instance, CompositionTechnique.TextureScope scope)
        {
            ...
            if (scope == CompositionTechnique.TextureScope.Chain)
            {
                ...
                Texture newTex = TextureManager.Instance.CreateManual(name,
            ...
            {
                // ok, we need to create a new one
                ret = TextureManager.Instance.CreateManual(name, ResourceGroupManager.InternalResourceGroupName,
                                                           TextureType.TwoD,
                                                           width, height, 0, format, TextureUsage.RenderTarget, null,
                                                           srgb, aa,
                                                           aaHint);
                i.Add(ret);
        ...
        public void FreePooledTextures(bool onlyIfUnreferenced)
        {
            ...
            {
                foreach (KeyValuePair<TextureDefinition, List<Texture>> i in this.texturesByDef)
                {
                ...
                foreach (KeyValuePair<Pair<string>, SortedList<TextureDefinition, Texture>> i in this.chainTexturesByRef
                    )
                {
        ...
        protected override void dispose(bool disposeManagedResources)
        {
            if (!IsDisposed)
            {
                ...
                {
                    foreach (KeyValuePair<Viewport, CompositorChain> item in this.chains)
                    {
        ...
        public void ReconstructAllCompositorResources()
        {
            ...
            foreach (KeyValuePair<Viewport, CompositorChain> i in this.chains)
            {
                CompositorChain chain = i.Value;
