...
//     <id value="$Id: GpuProgramManager.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Graphics
{
    ...
    public abstract class GpuProgramManager : ResourceManager
    {
        ...
        [OgreVersion(1, 7, 2)]
#if NET_40
        public virtual GpuProgram Create(string name, string group, GpuProgramType type, string syntaxCode,
                                         bool isManual = false, IManualResourceLoader loader = null)
#else
...
#endif
        {
            ...
            GpuProgram ret =
                (GpuProgram)
                _create(name, (ResourceHandle) name.ToLower().GetHashCode(), group, isManual, loader, type, syntaxCode);
    ...
    /// <see cref="Create(string, string, GpuProgramType, string, bool, IManualResourceLoader)"/>
        ...
        /// <param name="syntaxCode"> Name of the syntax to use for the program, i.e. vs_1_1, arbvp1, etc. </param>
        ...
        /// <param name="name"> The name of the program. </param>
        /// <param name="group"> </param>
        /// <param name="source"> The asm source of the program to create. </param>
        /// <param name="type"> </param>
        /// <param name="syntaxCode"> Name of the syntax to use for the program, i.e. vs_1_1, arbvp1, etc. </param>
        /// <returns> An unloaded GpuProgram instance. </returns>
        [OgreVersion(1, 7, 2)]
        ...
        /// </remarks>
        /// <param name="name"> Identifying name of the program to load. </param>
        /// <param name="group"> </param>
        /// <param name="fileName"> The file to load. </param>
        /// <param name="type"> Type of program to create. </param>
        /// <param name="syntaxCode"> Syntax code of the program, i.e. vs_1_1, arbvp1, etc. </param>
        [OgreVersion(1, 7, 2)]
        public virtual GpuProgram Load(string name, string group, string fileName, GpuProgramType type,
                                       string syntaxCode)
        {
            lock (_autoMutex)
            {
        ...
        /// <param name="group"> </param>
        /// <param name="source"> Source code of the program to load. </param>
        /// <param name="type"> Type of program to create. </param>
        /// <param name="syntaxCode"> Syntax code of the program, i.e. vs_1_1, arbvp1, etc. </param>
        [OgreVersion(1, 7, 2)]
...
#endif
        {
            ...
            {
                GpuProgram ret = (GpuProgram) HighLevelGpuProgramManager.Instance.GetByName(name);
                if (ret != null)
                {
                    return ret;
                }
    ...
    /// <see cref="GetByName(string, bool)"/>
        ...
        public virtual GpuProgramParameters.GpuSharedParameters CreateSharedParameters(string name)
        {
            ...
            GpuProgramParameters.GpuSharedParameters ret = new GpuProgramParameters.GpuSharedParameters(name);
