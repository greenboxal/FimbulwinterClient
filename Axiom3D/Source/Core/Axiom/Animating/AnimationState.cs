...
//     <id value="$Id: AnimationState.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Animating
{
    ...
    public class AnimationState : IControllerValue<float>, IComparable
    {
        ...
        public float Value
        {
            get { return this.time*this.inverseLength; }
            set { this.time = value*this.length; }
        }
        ...
        public static bool operator ==(AnimationState left, AnimationState right)
        {
            ...
            if (left.animationName == right.animationName && left.isEnabled == right.isEnabled &&
        ...
        public int CompareTo(object obj)
        {
            ...
            if (this.animationName == other.animationName && this.isEnabled == other.isEnabled &&
