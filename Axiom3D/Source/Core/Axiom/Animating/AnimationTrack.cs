...
//     <id value="$Id: AnimationTrack.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Animating
{
    ...
    public abstract class AnimationTrack
    {
        ...
        public float GetKeyFramesAtTime(float time, out KeyFrame keyFrame1, out KeyFrame keyFrame2,
                                        out short firstKeyIndex)
        {
            short firstIndex = -1;
            float totalLength = this.parent.Length;
    ...
    public class NumericAnimationTrack : AnimationTrack
    {
        ...
        {
            get { return this.targetAnimable; }
            set { this.targetAnimable = value; }
        }
        ...
        public override KeyFrame GetInterpolatedKeyFrame(float timeIndex, KeyFrame kf)
        {
            ...
            {
                // Interpolate by t
                kret.NumericValue = AnimableValue.InterpolateValues(t, this.targetAnimable.Type, k1.NumericValue,
                                                                    k2.NumericValue);
            }
            return kf;
        }
    ...
    public class VertexAnimationTrack : AnimationTrack
    {
        ...
        {
            get { return this.targetVertexData; }
            set { this.targetVertexData = value; }
        }
        ...
        {
            get { return this.targetMode; }
            set { this.targetMode = value; }
        }
        ...
        public void ApplyToVertexData(VertexData data, float time, float weight, List<Pose> poseList)
        {
            ...
            if (this.animationType == VertexAnimationType.Morph)
            {
                ...
                if (this.targetMode == VertexAnimationTargetMode.Hardware)
                {
                    ...
                    VertexElement posElem = data.vertexDeclaration.FindElementBySemantic(VertexElementSemantic.Position);
