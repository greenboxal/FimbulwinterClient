...
//     <id value="$Id: Animation.cs 3316 2012-05-31 20:50:21Z borrillis $"/>
// </file>
...
namespace Axiom.Animating
{
    ...
    public class Animation
    {
        ...
        {
            get { return this.rotationInterpolationMode; }
            set { this.rotationInterpolationMode = value; }
        }
        ...
        {
            get { return this.numericTrackList; }
        }
        ...
        {
            get { return this.vertexTrackList; }
        }
        ...
        {
            // loop through tracks and update them all with current time
            foreach (KeyValuePair<ushort, NodeAnimationTrack> pair in this.nodeTrackList)
            {
        ...
        {
            foreach (KeyValuePair<ushort, VertexAnimationTrack> pair in this.vertexTrackList)
            {
                int handle = pair.Key;
