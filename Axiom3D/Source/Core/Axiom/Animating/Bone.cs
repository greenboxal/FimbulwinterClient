...
//     <id value="$Id: Bone.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Animating
{
    ...
    public class Bone : Node
    {
        ...
        public void SetBindingPose()
        {
            ...
            MakeInverseTransform(DerivedPosition, Vector3.UnitScale, DerivedOrientation,
                                 ref this.bindDerivedInverseTransform);
        }
        ...
        {
            get { return this.isManuallyControlled; }
            set { this.isManuallyControlled = value; }
        }
        ...
        {
            get { return this.bindDerivedInverseTransform; }
        }
