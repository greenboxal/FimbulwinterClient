...
//     <id value="$Id: Font.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Fonts
{
    ...
    public class Font : Resource, IManualResourceLoader
    {
        ...
        {
            get { return this._fontType; }
            set { this._fontType = value; }
        }
        ...
        {
            get { return this._ttfSize; }
            set { this._ttfSize = value; }
        }
        ...
        {
            get { return this._ttfResolution; }
            set { this._ttfResolution = value; }
        }
        ...
        /// <remarks>
        ///   You only need to call this if you're setting up a font loaded from a texture manually.
        ///   <para> Also sets the aspect ratio (width / height) of this character. textureAspect is the width/height of the texture (may be non-square) </para>
        /// </remarks>
        [Obsolete("Use Glyphs property")]
        ...
        public void LoadResource(Resource res)
        {
            ...
            byte[] ttfchunk = new byte[fileStream.Length];
            ...
            int glyphCount = 0;
            foreach (KeyValuePair<int, int> r in this.codePointRange)
            {
                ...
                for (int cp = range.Key; cp <= range.Value; ++cp, ++glyphCount)
                {
                    ...
                    FT_FaceRec rec = face.PtrToStructure<FT_FaceRec>();
                    FT_GlyphSlotRec glyp = rec.glyph.PtrToStructure<FT_GlyphSlotRec>();
