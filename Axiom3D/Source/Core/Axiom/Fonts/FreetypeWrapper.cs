...
namespace Axiom.Fonts
{
    ...
    /// </summary>
    /// <remarks>
    ///   <para> Binds functions and definitions in freetype6.dll (Windows) /usr/lib/libfreetype.so.6 (Linux - specifically Fedora Core freetype install location) /Library/Frameworks/Mono.framework/Libraries/libfreetype.6.dylib (MacOSX) </para>
    ///   <para> The FreeType library includes the base data types and function calls to FreeType 2 to allow access to TrueType and OpenType fonts across platforms. </para>
    ///   <para> This is not a rendering utility and will not render fonts to the screen. It is an interface to the various font formats, and can provide either outline or bitmapped versions of font glyphs. </para>
    /// </remarks>
    ...
    public enum FT_Encoding
    {
        ...
        /// <summary>
        /// </summary>
        FT_ENCODING_MS_SJIS = (FT_Encoding.FT_ENCODING_SJIS),

        /// <summary>
        /// </summary>
        FT_ENCODING_MS_GB2312 = (FT_Encoding.FT_ENCODING_GB2312),

        /// <summary>
        /// </summary>
        FT_ENCODING_MS_BIG5 = (FT_Encoding.FT_ENCODING_BIG5),

        /// <summary>
        /// </summary>
        FT_ENCODING_MS_WANSUNG = (FT_Encoding.FT_ENCODING_WANSUNG),

        /// <summary>
        /// </summary>
        FT_ENCODING_MS_JOHAB = (FT_Encoding.FT_ENCODING_JOHAB),
    ...
    public class FT
    {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        public static extern int FT_Get_Kerning(IntPtr /*FaceRec*/ face, uint left_glyph, uint right_glyph,
                                                uint kern_mode,
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        public static extern int FT_Get_Glyph_Name(IntPtr /*FaceRec*/ face, uint glyph_index, IntPtr buffer,
                                                   uint buffer_max);
