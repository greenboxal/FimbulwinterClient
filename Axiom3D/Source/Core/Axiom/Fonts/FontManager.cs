...
//     <id value="$Id: FontManager.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Fonts
{
    ...
    public class FontManager : ResourceManager, ISingleton<FontManager>
    {
        ...
        {
            get { return Singleton<FontManager>.Instance; }
        }
        ...
        protected void parseAttribute(string line, Font font)
        {
            ...
            switch (attrib)
            {
                ...
                case "glyph":
                    ...
                    font.SetGlyphTexCoords(glyph, StringConverter.ParseFloat(parms[2]),
