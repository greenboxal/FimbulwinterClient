...
//     <id value="$Id: OptimizedPixelConversion.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Media
{
    ...
    public static class OptimizedPixelConversion
    {
        ...
        private class PixelConverterAttribute : Attribute
        {
            ...
            public int Id
            {
                get { return ((int) this._srcFormat << 8) + (int) this._dstFormat; }
            }
        ...
        private static class PixelBoxConverter
        {
            ...
            {
                {
                    BufferBase srcptr = (BufferBase) src.Data.Clone();
                    BufferBase dstptr = (BufferBase) dst.Data.Clone();
