...
//     <id value="$Id: PixelConverter.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
    ...
    public class PixelConverter
    {
        ...
        public class PixelFormatDescription
        {
            ...
            public PixelFormatDescription(string name, PixelFormat format, byte elemBytes, PixelFormatFlags flags,
                                          ...
                                          byte bbits, byte abits, uint rmask, uint gmask, uint bmask, uint amask,
                                          byte rshift,
        ...
        ///</summary>
        protected static PixelFormatDescription[] UnindexedPixelFormats = new[]
                                                                              {
                                                                                  ...
                                                                                  ,
                                                                                  //-----------------------------------------------------------------------
                                                                                  new PixelFormatDescription("PF_L8",
                                                                                                             PixelFormat
                                                                                                                 .L8,
                                                                                                             /* Bytes per element */ 
                                                                                                             1,
                                                                                  ...
                                                                                  new PixelFormatDescription("PF_L16",
                                                                                                             ...
                                                                                                             0, 0),
                                                                                  //-----------------------------------------------------------------------
                                                                                  new PixelFormatDescription("PF_A8",
                                                                                                             PixelFormat
                                                                                                                 .A8,
                                                                                                             /* Bytes per element */ 
                                                                                                             1,
            ...
            else
            {
                switch (format)
                {
                    case PixelFormat.FLOAT32_R:
                        ITypePointer<float> floatdest = (ITypePointer<float>) dest;
                        floatdest[0] = r;
                        break;
                    ...
                    case PixelFormat.FLOAT16_R:
                        ITypePointer<ushort> ushortdest = (ITypePointer<ushort>) dest;
                    ...
                    case PixelFormat.BYTE_LA:
                        ITypePointer<byte> bytedest = (ITypePointer<byte>) dest;
        ...
        public static void UnpackColor(ref byte r, ref byte g, ref byte b, ref byte a, PixelFormat pf, BufferBase src)
        {
            ...
            else
            {
                ...
                r = (byte) Bitwise.FloatToFixed(rr, 8);
                g = (byte) Bitwise.FloatToFixed(gg, 8);
                b = (byte) Bitwise.FloatToFixed(bb, 8);
                a = (byte) Bitwise.FloatToFixed(aa, 8);
            }
        }
        ...
        /// <param name="src"> Source memory location </param>
        [OgreVersion(1, 7, 2)]
        public static void UnpackColor(out float r, out float g, out float b, out float a, PixelFormat pf,
                                       BufferBase src)
        {
            PixelFormatDescription des = GetDescriptionFor(pf);
            if ((des.flags & PixelFormatFlags.NativeEndian) != 0)
            ...
            else
            {
                ...
                {
                    case PixelFormat.FLOAT32_R:
                        ITypePointer<float> floatsrc = (ITypePointer<float>) src;
                        r = g = b = floatsrc[0];
                        a = 1.0f;
                        break;
                    ...
                    case PixelFormat.FLOAT16_R:
                        ITypePointer<ushort> ushortsrc = (ITypePointer<ushort>) src;
                    ...
                    case PixelFormat.FLOAT16_GR:
                        ...
                        g = Bitwise.HalfToFloat(ushortsrc[0]);
                        r = b = Bitwise.HalfToFloat(ushortsrc[1]);
                        a = 1.0f;
                        break;
                    ...
                    case PixelFormat.BYTE_LA:
                        ITypePointer<byte> bytesrc = (ITypePointer<byte>) src;
                    ...
                    default:
                        // Not yet supported
                        throw new AxiomException("Unpack from {0} not implemented, in PixelUtil.UnpackColor", pf);
                }
            }
        }
        ...
        public static void BulkPixelConversion(PixelBox src, PixelBox dst)
        {
            ...
            if (PixelBox.Compressed(src.Format) || PixelBox.Compressed(dst.Format))
            {
                ...
                {
                    Memory.Copy(src.Data, dst.Data, src.ConsecutiveSize);
                    return;
                }
                else
                {
            ...
            if (src.Format == dst.Format)
            {
                ...
                BufferBase srcptr = src.Data + (src.Left + src.Top*src.RowPitch + src.Front*src.SlicePitch)*srcPixelSize;
                BufferBase dstptr = dst.Data + (dst.Left + dst.Top*dst.RowPitch + dst.Front*dst.SlicePitch)*dstPixelSize;
