...
//     <id value="$Id: PixelBox.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Media
{
    ...
    public class BasicBox
    {
        ...
        public int Depth
        {
            get { return this.back - this.front; }
        }
    ...
    ///</summary>
    public class PixelBox : BasicBox, ICloneable
    {
        #region Fields
        ...
        public int RowSkip
        {
            get { return this.rowPitch - Width; }
        }
        ...
        {
            get { return this.slicePitch - (Height*this.rowPitch); }
        }
        ...
        {
            get { return this.rowPitch == Width && this.slicePitch == Width*Height; }
        }
        ...
        {
            get { return PixelUtil.GetMemorySize(Width, Height, Depth, this.format); }
        }
        ...
        public PixelBox GetSubVolume(BasicBox def)
        {
            ...
            {
                if (def.Left == left && def.Top == top && def.Front == front && def.Right == right &&
                    def.Bottom == bottom &&
                    def.Back == back)
                {
            ...
            int elemSize = PixelUtil.GetNumElemBytes(this.format);
            // Calculate new data origin
            PixelBox rval = new PixelBox(def, this.format, this.data);
        ...
        public PixelBox Clone()
        {
            BufferBase buffer = (BufferBase) this.Data.Clone();
            return new PixelBox(this.Width, this.Height, this.Depth, this.Format, buffer);
        }
