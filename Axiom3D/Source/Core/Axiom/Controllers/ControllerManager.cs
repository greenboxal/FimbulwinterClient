...
//     <id value="$Id: ControllerManager.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Controllers
{
    ...
    public sealed class ControllerManager : DisposableObject
    {
        ...
        {
            [OgreVersion(1, 7, 2)]
            get { return this.frameTimeController; }
        }
                                                 ...
                                                 IControllerFunction<Real> function)
        {
            ...
            Controller<Real> controller = new Controller<Real>(source, destination, function);
        ...
        public Controller<Real> CreateTextureWaveTransformer(TextureUnitState layer, TextureTransform type,
                                                             WaveformType waveType, Real baseVal, Real frequency,
                                                             Real phase,
                                                             Real amplitude)
        {
            IControllerValue<Real> val = null;
        ...
        public void UpdateAll()
        {
            ...
            if (thisFrameNumber != this.lastFrameNumber)
            {
                ...
                foreach (Controller<Real> controller in this.controllers)
                {
                    controller.Update();
                }
