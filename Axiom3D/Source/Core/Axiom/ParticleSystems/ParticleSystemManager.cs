...
//     <id value="$Id: ParticleSystemManager.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
    ...
    public sealed class ParticleSystemManager : DisposableObject, IScriptLoader
    {
        ...
        private void ParseAttrib(string line, ParticleSystem system)
        {
            ...
            if (!system.SetParameter(values[0], values[1]))
            {
                ...
                {
                    // BAD command. BAD!
                    LogManager.Instance.Write("Bad particle system attribute line: '{0}' in {1} (no renderer)", line,
                                              system.Name);
                }
            }
        }
        ...
        {
            get { return this.affectorFactoryList; }
        }
        ...
        {
            get { return this.emitterFactoryList; }
        }
            ...
            while ((line = ParseHelper.ReadLine(script)) != null)
            {
                ...
                if (!(line.Length == 0 || line.StartsWith("//")))
                {
                    ...
                    else if (line.StartsWith("emitter"))
                    {
                        ...
                        {
                            // Oops, bad emitter
                            LogManager.Instance.Write("Bad particle system emitter line: '" + line + "' in " +
                                                      system.Name);
                            script.ReadLine();
                        }
                    ...
                    else if (line.StartsWith("affector"))
                    {
                        ...
                        {
                            // Oops, bad affector
                            LogManager.Instance.Write("Bad particle system affector line: '" + line + "' in " +
                                                      system.Name);
                            script.ReadLine();
                        }
