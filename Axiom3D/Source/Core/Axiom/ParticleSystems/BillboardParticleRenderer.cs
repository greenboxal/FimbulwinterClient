...
namespace Axiom.ParticleSystems
{
    public class BillboardParticleRenderer : ParticleSystemRenderer
    {
        ...
        {
            get { return this.billboardSet.BillboardType; }
            set { this.billboardSet.BillboardType = value; }
        }

        public BillboardOrigin BillboardOrigin
        {
            get { return this.billboardSet.BillboardOrigin; }
            set { this.billboardSet.BillboardOrigin = value; }
        }

        public bool UseAccurateFacing
        {
            get { return this.billboardSet.UseAccurateFacing; }
            set { this.billboardSet.UseAccurateFacing = value; }
        }

        public BillboardRotationType BillboardRotationType
        {
            get { return this.billboardSet.BillboardRotationType; }
            set { this.billboardSet.BillboardRotationType = value; }
        }

        public Vector3 CommonDirection
        {
            get { return this.billboardSet.CommonDirection; }
            set { this.billboardSet.CommonDirection = value; }
        }

        public Vector3 CommonUpVector
        {
            get { return this.billboardSet.CommonUpVector; }
            set { this.billboardSet.CommonUpVector = value; }
        }
        ...
        {
            get { return this.billboardSet.PointRenderingEnabled; }
            set { this.billboardSet.PointRenderingEnabled = value; }
        }
        ...
        {
            set { this.billboardSet.MaterialName = value.Name; }
        }
        ...
        {
            set { this.billboardSet.RenderQueueGroup = value; }
        }
