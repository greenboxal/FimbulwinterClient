...
//     <id value="$Id: ParticleEmitter.cs 3315 2012-05-31 20:37:22Z borrillis $"/>
// </file>
...
namespace Axiom.ParticleSystems
{
    ...
    public abstract class ParticleEmitter : Particle
    {
        ...
        {
            get { return Utility.RadiansToDegrees((Real) this.angle); }
            set { this.angle = Utility.DegreesToRadians(value); }
        }
        ...
        {
            get { return float.IsNaN(this.minSpeed) ? this.fixedSpeed : float.NaN; }
            set { this.fixedSpeed = value; }
        }
        ...
        {
            get { return this.emissionRate; }
            set { this.emissionRate = value; }
        }
        ...
        {
            get { return this.emittedEmitter; }
            set { this.emittedEmitter = value; }
        }
        ...
        {
            get { return this.emitted; }
            set { this.emitted = value; }
        }
        ...
        {
            get { return float.IsNaN(this.minTTL) ? this.fixedTTL : float.NaN; }
            set { this.fixedTTL = value; }
        }
        ...
        {
            get { return this.maxTTL; }
            set { this.maxTTL = value; }
        }
        ...
        {
            get { return this.colorRangeStart; }
            set { this.colorFixed = value; }
        }
        ...
        {
            get { return this.colorRangeStart; }
            set { this.colorRangeStart = value; }
        }
        ...
        {
            get { return this.colorRangeEnd; }
            set { this.colorRangeEnd = value; }
        }
        ...
        {
            get { return float.IsNaN(this.durationMin) ? this.durationFixed : float.NaN; }
            set
            {
        ...
        {
            get { return this.repeatDelayMax; }
            set
            {
        ...
        {
            get { return this.repeatDelayMin; }
            set
            {
        ...
        {
            get { return float.IsNaN(this.repeatDelayMin) ? this.repeatDelayFixed : float.NaN; }
            set
            {
