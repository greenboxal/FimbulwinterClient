...
//     <id value="$Id: Archive.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.FileSystem
{
    ...
    public abstract class Archive : DisposableObject
    {
        ...
        /// <returns> A reference to a Stream which can be used to read / write the file. If the file is not present, returns null. </returns>
        ...
        /// </remarks>
        /// <param name="filename"> The fully qualified name of the file </param>
        /// <returns> A reference to a Stream which can be used to read the file. If the file is not present, returns null. </returns>
