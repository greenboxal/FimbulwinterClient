...
//     <id value="$Id: FileSystemArchive.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.FileSystem
{
    ...
    public class FileSystemArchive : Archive
    {
        ...
        protected virtual void findFiles(string pattern, bool recursive, List<string> simpleList,
        ...
        {
            get { return !PlatformManager.IsWindowsOS; }
        }
            ...
            SafeDirectoryChange(this._basePath, () =>
                                                    {
                                                        if (File.Exists(this._basePath + filename))
                                                        {
                                                            System.IO.FileInfo fi =
                                                                new System.IO.FileInfo(this._basePath + filename);
                                                            strm =
