...
//     <id value="$Id: ScriptParser.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
                            ...
                            case Tokens.Word:
                                switch (token.lexeme)
                                {
                                    ...
                                    case "import":
                                        ...
                                        iter++;
                                        if (iter == end ||
                                            (tokens[iter].type != Tokens.Word && tokens[iter].type != Tokens.Quote))
                                        {
                                            throw new Exception(String.Format("Expected import target at line {0}",
                                                                              node.Line));
                                        }
                                        ...
                                        temp.Type = tokens[iter].type == Tokens.Word
                                                        ? ConcreteNodeType.Word
                                                        : ConcreteNodeType.Quote;
                                        ...
                                        if (iter == end ||
                                            (tokens[iter].type != Tokens.Word && tokens[iter].type != Tokens.Quote))
                                        {
                                            throw new Exception(String.Format("Expected import source at line {0}",
                                                                              node.Line));
                                        }
                                    ...
                                    case "set":
                                        ...
                                        {
                                            throw new Exception(string.Format("expected variable name at line {0}",
                                                                              node.Line));
                                        }
                                    ...
                                    default:
                                        ...
                                        node.File = token.file;
                                        node.Line = token.line;
                                        node.Type = token.type == Tokens.Word
                                                        ? ConcreteNodeType.Word
                                                        : ConcreteNodeType.Quote;
                    ...
                    case ParserState.Object:
                        switch (token.type)
                        {
                            ...
                            case Tokens.Colon:
                                ...
                                {
                                    throw new Exception(String.Format("Expected object identifier at line {0}",
                                                                      node.Line));
                                }
                                ...
                                while (j != end && (tokens[j].type == Tokens.Word || tokens[j].type == Tokens.Quote))
                                {
                                    ...
                                    tempNode.Type = tokens[j].type == Tokens.Word
                                                        ? ConcreteNodeType.Word
                                                        : ConcreteNodeType.Quote;
