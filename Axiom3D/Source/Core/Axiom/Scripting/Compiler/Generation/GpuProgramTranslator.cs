...
//     <id value="$Id: GpuProgramTranslator.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
    ...
    public partial class ScriptCompiler
    {
        public class GpuProgramTranslator : Translator
        {
                        ...
                        case Keywords.ID_PARAM_NAMED:
                            {
                                if (prop.Values.Count >= 3)
                                {
                                    ...
                                    AbstractNode k = getNodeAt(prop.Values, 2);
                                    ...
                                    AtomAbstractNode atom0 = (AtomAbstractNode) i0;
                                    AtomAbstractNode atom1 = (AtomAbstractNode) i1;
                                        ...
                                        if (isValid)
                                        {
                                            ...
                                            if (type == GpuProgramParameters.ElementType.Int)
                                            {
                                                ...
                                                if (getInts(prop.Values, 2, out vals, roundedCount))
                                                {
                                                    ...
                                                    {
                                                        compiler.AddError(CompileErrorCode.InvalidParameters, prop.File,
                                                                          prop.Line, "setting of constant failed");
                                                    }
                                                }
                                                else
                                                {
                                        ...
                                        switch (def.DataType)
                                        {
                                                    ...
                                                    if (i2 == null)
                                                    {
                                                                ...
                                                                SpotLightWorldViewProjMatrix)
                                                        {
                                                            try
                                                            {
                                                                if (named)
                                                                {
                                                                    parameters.SetNamedAutoConstant(name,
                                                                                                    def.AutoConstantType,
                                                                                                    0);
                                                                }
                                                                else
                                                                {
                                                                    parameters.SetAutoConstant(index,
                                                                                               def.AutoConstantType, 0);
                                                                }
                                                            }
                                                            catch
                                                            {
                                                        ...
                                                        else
                                                        {
                                                            compiler.AddError(CompileErrorCode.NumberExpected, prop.File,
                                                                              prop.Line,
                                                                              "extra parameters required by constant definition " +
                                                                              atom1.Value);
                                                        }
                                                    }
                                                    else
                                            ...
                                            case GpuProgramParameters.AutoConstantDataType.Real:
                                                if (def.AutoConstantType == GpuProgramParameters.AutoConstantType.Time ||
                                                    def.AutoConstantType ==
                                                    GpuProgramParameters.AutoConstantType.FrameTime)
                                                {
                                                    Real f = 1.0f;
                                                    if (i2 != null)
                                                    {
                                                    ...
                                                    try
                                                    {
                                                        if (named)
                                                        {
                                                            parameters.SetNamedAutoConstantReal(name,
                                                                                                def.AutoConstantType, f);
                                                        }
                                                        else
                                                        {
                                                            parameters.SetAutoConstantReal(index, def.AutoConstantType,
                                                                                           f);
                                                        }
                                                    }
                                                    catch
                                                    ...
                                                    if (i2 != null)
                                                    {
                                                        ...
                                                        if (getReal(i2, out extraInfo))
                                                        {
                                                            try
                                                            {
                                                                ...
                                                                {
                                                                    parameters.SetAutoConstantReal(index,
                                                                                                   def.AutoConstantType,
                                                                                                   extraInfo);
                                                                }
                                                            }
            ...
            protected void _translateGpuProgram(ScriptCompiler compiler, ObjectAbstractNode obj)
            {
                ...
                ScriptCompilerEvent evt = new CreateGpuProgramScriptCompilerEvent(obj.File, obj.Name,
