                                    ...
                                    if (i1 is AtomAbstractNode && ((AtomAbstractNode) i).IsNumber)
                                    {
                                        ...
                                        if (i0 is AtomAbstractNode)
                                        {
                                            ...
                                            if (getString(i0, out val0) && getInt(i1, out val1) && getReal(i2, out val2))
                                            {
                                                ScriptCompilerEvent evt =
                                                    new ProcessResourceNameScriptCompilerEvent(
                                                        ProcessResourceNameScriptCompilerEvent.ResourceType.Texture,
                                                        val0);
...
#warning check this if statement
                                                    ...
                                                    if (compiler.Listener != null)
                                                    {
                                                        ScriptCompilerEvent evt =
                                                            new ProcessResourceNameScriptCompilerEvent(
                                                                ProcessResourceNameScriptCompilerEvent.ResourceType.
                                                                    Texture,
                                                                name);
                            ...
                            case Keywords.ID_CUBIC_TEXTURE:
                                ...
                                else if (prop.Values.Count == 2)
                                {
                                    ...
                                    if (i0 is AtomAbstractNode && i1 is AtomAbstractNode)
                                    {
                                        ...
                                        this._textureunit.SetCubicTextureName(evtName,
                                                                              atom1.Id ==
                                                                              (uint) Keywords.ID_COMBINED_UVW);
                                    }
                                    else
                                    {
                                        compiler.AddError(CompileErrorCode.InvalidParameters, prop.File, prop.Line);
                                ...
                                else if (prop.Values.Count == 7)
                                {
                                        ...
                                        i4 is AtomAbstractNode && i5 is AtomAbstractNode && i6 is AtomAbstractNode)
                                    {
                                        ...
                                        this._textureunit.SetCubicTextureName(names,
                                                                              atom6.Id ==
                                                                              (uint) Keywords.ID_COMBINED_UVW);
                                    }
                                }
                            ...
                            case Keywords.ID_TEX_COORD_SET:
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        compiler.AddError(CompileErrorCode.InvalidParameters, prop.File, prop.Line,
                                                          prop.Values[0].Value +
                                                          " is not supported as an integer argument");
                                    }
                                }
                                break;
                            ...
                            case Keywords.ID_FILTERING:
                                ...
                                else if (prop.Values.Count == 3)
                                {
                                    ...
                                    if (i0 is AtomAbstractNode && i1 is AtomAbstractNode && i2 is AtomAbstractNode)
                                    {
                                        ...
                                        FilterOptions tmin = FilterOptions.None,
                            ...
                            case Keywords.ID_COLOR_OP_EX:
                                ...
                                else
                                {
                                    ...
                                    if (i0 is AtomAbstractNode && i1 is AtomAbstractNode && i2 is AtomAbstractNode)
                                    {
                                        ...
                                        LayerBlendSource source1 = LayerBlendSource.Current,
                                        ...
                                        this._textureunit.SetColorOperationEx(op, source1, source2, arg1, arg2,
                                                                              manualBlend);
                                    }
                                    else
                                    {
                            ...
                            case Keywords.ID_COLOR_OP_MULTIPASS_FALLBACK:
                                ...
                                else if (prop.Values.Count == 1)
                                {
                                    if (prop.Values[0] is AtomAbstractNode)
                                    {
                                        ...
                                        {
                                            case Keywords.ID_ADD:
                                                this._textureunit.SetColorOpMultipassFallback(SceneBlendFactor.One,
                                                                                              SceneBlendFactor.One);
                                                break;

                                            case Keywords.ID_MODULATE:
                                                this._textureunit.SetColorOpMultipassFallback(
                                                    SceneBlendFactor.DestColor, SceneBlendFactor.Zero);
                                                break;
                            ...
                            case Keywords.ID_ALPHA_OP_EX:
                                ...
                                else
                                {
                                    ...
                                    if (i0 is AtomAbstractNode && i1 is AtomAbstractNode && i2 is AtomAbstractNode)
                                    {
                                        ...
                                        this._textureunit.SetAlphaOperation(op, source1, source2, arg1, arg2,
                                                                            manualBlend);
                                    }
                                    else
                                    {
...
#warning check this statement
                            ...
                            case Keywords.ID_SCALE:
                                ...
                                else
                                {
                                    ...
                                    {
                                        compiler.AddError(CompileErrorCode.InvalidParameters, prop.File, prop.Line,
                                                          "first and second arguments must both be valid number values (received " +
                                                          i0.Value + ", " +
                                                          i1.Value + ")");
                                    }
                                }
                            ...
                            case Keywords.ID_WAVE_XFORM:
                                ...
                                else
                                {
                                        ...
                                        i4 is AtomAbstractNode && i5 is AtomAbstractNode)
                                    {
                                        ...
                                        if (!getReal(i2, out baseVal) || !getReal(i3, out freq) ||
                                            !getReal(i4, out phase) ||
                                            !getReal(i5, out amp))
                                        {
                                            compiler.AddError(CompileErrorCode.InvalidParameters, prop.File, prop.Line,
                                        ...
                                        switch ((Keywords) atom.Id)
                                        {
                                            ...
                                            default:
                                                compiler.AddError(CompileErrorCode.InvalidParameters, prop.File,
                                                                  prop.Line,
                                                                  atom.Value +
                                                                  " is not a valid binding type (must be \"vertex\" or \"fragment\")");
                                                break;
                                        }
                                    }
                                    else
