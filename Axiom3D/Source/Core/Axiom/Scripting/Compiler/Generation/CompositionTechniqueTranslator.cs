...
//     <id value="$Id: CompositionTechniqueTranslator.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
                            ...
                            case Keywords.ID_TEXTURE:
                                {
                                    ...
                                    CompositionTechnique.TextureDefinition def =
                                        this._Technique.CreateTextureDefinition(atom0.Value);
                                    def.Width = width;
                                    def.Height = height;
                            ...
                            case Keywords.ID_TEXTURE_REF:
                                ...
                                else
                                {
                                    ...
                                    CompositionTechnique.TextureDefinition refTexDef =
                                        this._Technique.CreateTextureDefinition(texName);
