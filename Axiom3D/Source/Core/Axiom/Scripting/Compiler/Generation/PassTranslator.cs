...
//     <id value="$Id: PassTranslator.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Axiom.Scripting.Compiler
{
    public partial class ScriptCompiler
    {
        public class PassTranslator : Translator
        {
                        ...
                        switch ((Keywords) prop.Id)
                        {
                            ...
                            case Keywords.ID_AMBIENT:
                                ...
                                else
                                {
                                    ...
                                    {
                                        this._pass.VertexColorTracking = this._pass.VertexColorTracking |
                                                                         TrackVertexColor.Ambient;
                                    }
                                    else
                                    {
                                ...
                                else
                                {
                                        ...
                                        if (prop.Values.Count >= 2)
                                        {
                                            ...
                                            else
                                            {
                                                compiler.AddError(CompileErrorCode.InvalidParameters, prop.File,
                                                                  ...
                                                                  prop.Values[prop.Values.Count - 1].Value +
                                    ...
                                    else
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if (getFloat(i0, out val.r) && getFloat(i1, out val.g) &&
                                                getFloat(i2, out val.b))
                                            {
                                                if (prop.Values.Count == 4)
                                                {
                            ...
                            case Keywords.ID_SCENE_BLEND:
                                ...
                                else if (prop.Values.Count == 1)
                                {
                                        ...
                                        switch ((Keywords) atom.Id)
                                        {
                                            ...
                                            default:
                                                compiler.AddError(CompileErrorCode.InvalidParameters, prop.File,
                                                                  ...
                                                                  prop.Values[0].Value + "\" for argument 1");
                                                break;
                                        }
                                    }
                                    else
                                    {
                                        compiler.AddError(CompileErrorCode.InvalidParameters, prop.File, prop.Line,
                                                          "scene_blend does not support \"" + prop.Values[0].Value +
                                                          "\" for argument 1");
                                    }
                                }
                                else
                                {
                                    ...
                                    if (getEnumeration(i0, compiler, out sbf0) &&
                                        getEnumeration(i1, compiler, out sbf1))
                                    {
                                    ...
                                    {
                                        compiler.AddError(CompileErrorCode.InvalidParameters, prop.File, prop.Line,
                                                          "scene_blend does not support \"" + i0.Value + "\" and \"" +
                                                          i1.Value + "\" as arguments");
                                    }
                                }
                                break;
                            ...
                            case Keywords.ID_SEPARATE_SCENE_BLEND:
                                ...
                                else if (prop.Values.Count == 2)
                                {
                                    ...
                                    {
                                        compiler.AddError(CompileErrorCode.InvalidParameters, prop.File, prop.Line,
                                                          "separate_scene_blend does not support \"" + i0.Value +
                                                          "\" as argument 1");
                                    }
                                }
                                else
                                {
                                    ...
                                    if (i0 is AtomAbstractNode && i1 is AtomAbstractNode && i2 is AtomAbstractNode &&
                                        i3 is AtomAbstractNode)
                                    {
                                        SceneBlendFactor sbf0, sbf1, sbf2, sbf3;
                                        if (getEnumeration(i0, compiler, out sbf0) &&
                                            getEnumeration(i1, compiler, out sbf1) &&
                                            getEnumeration(i2, compiler, out sbf2) &&
                                            getEnumeration(i3, compiler, out sbf3))
                                        {
                            ...
                            case Keywords.ID_DEPTH_BIAS:
                                ...
                                else
                                {
                                    ...
                                    {
                                        compiler.AddError(CompileErrorCode.InvalidParameters, prop.File, prop.Line,
                                                          "depth_bias does not support \"" + i0.Value +
                                                          "\" for argument 1");
                                    }
                                }
                                break;
                                        ...
                                        switch ((Keywords) atom.Id)
                                        {
                                            ...
                                            default:
                                                compiler.AddError(CompileErrorCode.InvalidParameters, prop.File,
                                                                  prop.Line,
                                                                  prop.Values[0].Value +
                                                                  " is not a valid polygon mode (solid, points, or wireframe)");
                                                break;
                                        }
                                    }
                                    else
                                                ...
                                                switch ((Keywords) atom.Id)
                                                {
                                                    ...
                                                    default:
                                                        compiler.AddError(CompileErrorCode.InvalidParameters, prop.File,
                                                                          prop.Line,
                                                                          prop.Values[0].Value +
                                                                          " is not a valid light type (point, directional, or spot)");
                                                        break;
                                                }
                                            }
                                            else
                                            ...
                                            if (i1 != null && i1 is AtomAbstractNode)
                                            {
                                                ...
                                                if (atom.Id == (uint) Keywords.ID_PER_LIGHT)
                                                {
                                                    ...
                                                    if (i2 != null && i2 is AtomAbstractNode)
                                                    {
                                                        ...
                                                        switch ((Keywords) atom.Id)
                                                        {
                                                            ...
                                                            default:
                                                                compiler.AddError(CompileErrorCode.InvalidParameters,
                                                                                  prop.File, prop.Line,
                                                                                  i2.Value +
                                                                                  " is not a valid light type (point, directional, or spot)");
                                                                break;
                                                ...
                                                else if (atom.Id == (uint) Keywords.ID_PER_N_LIGHTS)
                                                {
                                                    ...
                                                    if (i2 != null && i2 is AtomAbstractNode)
                                                    {
                                                        ...
                                                        if (atom.IsNumber)
                                                        {
                                                            ...
                                                            if (i3 != null && i3 is AtomAbstractNode)
                                                            {
                                                                ...
                                                                switch ((Keywords) atom.Id)
                                                                {
                                                                    ...
                                                                    default:
                                                                        compiler.AddError(
                                                                            CompileErrorCode.InvalidParameters,
                                                                            prop.File, prop.Line,
                                                                            i3.Value +
                                                                            " is not a valid light type (point, directional, or spot)");
                                                                        break;
                                                        ...
                                                        {
                                                            compiler.AddError(CompileErrorCode.NumberExpected, prop.File,
                                                                              prop.Line,
                                                                              i2.Value + " is not a valid number");
                                                        }
                                                    }
            ...
            [AxiomHelper(0, 9)]
            private Pass _commonProgramChecks(ScriptCompiler compiler, ObjectAbstractNode node,
                                              out string createdProgramName)
            {
                ...
                ScriptCompilerEvent evt =
                    new ProcessResourceNameScriptCompilerEvent(
                        ProcessResourceNameScriptCompilerEvent.ResourceType.GpuProgram,
                        node.Name);
