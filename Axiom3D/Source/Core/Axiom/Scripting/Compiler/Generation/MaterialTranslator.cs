...
//     <id value="$Id: MaterialTranslator.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
    ...
    public partial class ScriptCompiler
    {
        public class MaterialTranslator : Translator
        {
            ...
            public override void Translate(ScriptCompiler compiler, AbstractNode node)
            {
                ...
                object mat;
                ScriptCompilerEvent evt = new CreateMaterialScriptCompilerEvent(node.File, obj.Name,
                ...
                ScriptCompilerEvent locEvt = new PreApplyTextureAliasesScriptCompilerEvent(this._material,
                                                                                           ref this._textureAliases);
