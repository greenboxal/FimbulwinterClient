...
namespace Axiom.Framework.Graphics
{
    public static class SpriteManager
    {
        ...
        public static void EnqueueTexture(string textureName, float x1, float y1, float x2, float y2, float tx1,
                                          float ty1,
        ...
        private static void Render()
        {
            ...
            unsafe
            {
                ...
                while (node != null)
                {
                    ...
                    if (node == null || thisChunk.TexHandle != node.Value.TexHandle ||
                        thisChunk.Alpha != node.Value.Alpha)
                    {
        ...
        private static void RenderSystem_Setup()
        {
            ...
            rs.SetSeparateSceneBlending(SceneBlendFactor.SourceAlpha, SceneBlendFactor.OneMinusSourceAlpha,
