...
namespace Axiom.Framework.Configuration
{
    ...
    public class DefaultConfigurationManager : ConfigurationManagerBase
    {
        ...
        /// <param name="configurationFile"> </param>
        /// <param name="sectionName"> </param>
        public DefaultConfigurationManager(IConfigurationDialogFactory factory, string configurationFile,
                                           string sectionName)
        ...
        public override bool RestoreConfiguration(Root engine)
        {
            ...
            {
                ResourceGroupManager.Instance.AddResourceLocation(locationElement.Path, locationElement.Type,
                                                                  locationElement.Group,
