...
namespace Ionic.Zlib
{
    ...
    ///   cref="System.IO.Stream" /> . It adds DEFLATE compression or decompression to any stream. </para>
    ///  <para> Using this stream, applications can compress or decompress data via stream <c>Read</c> and <c>Write</c> operations. Either compresssion or decompression can occur through either reading or writing. The compression format used is DEFLATE, which is documented in <see
    ///   href="http://www.ietf.org/rfc/rfc1951.txt">IETF RFC 1951</see> , "DEFLATE Compressed Data Format Specification version 1.3.". </para>
    ///  <para> This class is similar to <see cref="ZlibStream" /> , except that <c>ZlibStream</c> adds the <see
    ///   href="http://www.ietf.org/rfc/rfc1950.txt">RFC
    ///                                                                                                       1950 - ZLIB</see> framing bytes to a compressed stream when compressing, or expects the RFC1950 framing bytes when decompressing. The <c>DeflateStream</c> does not. </para>
    ///</remarks>
    ...
    public class DeflateStream : System.IO.Stream
    {
        ...
        ///</summary>
        ///<remarks>
        ///  <para> When mode is <c>CompressionMode.Decompress</c> , the level parameter is ignored. The "captive" stream will be closed when the DeflateStream is closed. </para>
        ///</remarks>
        ///<example>
        ///  This example uses a DeflateStream to compress data from a file, and writes
        ///  the compressed data to another file.
        ...
        ///
        ///  <code>using (var output = System.IO.File.Create(fileToCompress + ".deflated"))
        ///    {
        ...
        ///    }</code>
        ///
        ///  <code lang="VB">Using output As FileStream = File.Create(fileToCompress &amp; ".deflated")
